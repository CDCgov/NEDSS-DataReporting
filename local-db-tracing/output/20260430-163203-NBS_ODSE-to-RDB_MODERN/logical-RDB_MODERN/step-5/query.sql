...
WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [dbo].INVESTIGATION WHERE INV_LOCAL_ID = 'CAS3300017GA01')
FOR JSON PATH;
...
WHERE [LAB_TEST_UID] IN (3300008, 3300011)
...
WHERE [CONDITION_KEY] = 217
  AND [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [dbo].INVESTIGATION WHERE INV_LOCAL_ID = 'CAS3300017GA01')
  AND [LDF_GROUP_KEY] = 1
  AND [MORB_RPT_KEY] = 1
