...
- Line 238: INSERT INTO nrt_notification_key(notification_uid) SELECT ... WHERE notification_key IS NULL
  keyed off the stale snapshot, with NO live NOT EXISTS, and idx_nrt_notification_key_uid is NOT UNIQUE,
...
## FIXED (2026-06-04, branch aw/fix-bug18-followup-obs-npe, then on aw/odse-test-seed), TDD
