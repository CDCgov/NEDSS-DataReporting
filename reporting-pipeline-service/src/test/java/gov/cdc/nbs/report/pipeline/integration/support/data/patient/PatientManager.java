package gov.cdc.nbs.report.pipeline.integration.support.data.patient;

import gov.cdc.nbs.report.pipeline.integration.support.data.patient.address.PatientAddress;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.address.PatientAddressManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.birth.PatientSexAndBirth;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.birth.PatientSexAndBirthManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.comment.PatientComment;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.comment.PatientCommentManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.ethnicity.PatientEthnicity;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.ethnicity.PatientEthnicityManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.general.PatientGeneralInfo;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.general.PatientGeneralInfoManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.identification.PatientIdentification;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.identification.PatientIdentificationManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.mortality.PatientMortality;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.mortality.PatientMortalityManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.name.PatientName;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.name.PatientNameManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.phone.PatientPhoneAndEmail;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.phone.PatientPhoneAndEmailManager;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.race.PatientRace;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.race.PatientRaceManager;
