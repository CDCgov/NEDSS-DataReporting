...
class DataExceptionTest {
  ...
  static Stream<Arguments> messageAndCauseProvider() {
    return Stream.of(
        Arguments.of(
            NoDataException.class, "No data found", new RuntimeException("Underlying cause")),
        Arguments.of(
  ...
  <T extends RuntimeException> void testConstructorWithMessage(
      Class<T> exceptionClass, String message) throws Exception {
  ...
  <T extends RuntimeException> void testConstructorWithMessageAndCause(
      Class<T> exceptionClass, String message, Throwable cause) throws Exception {
