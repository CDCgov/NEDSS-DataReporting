...
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.address.PatientAddress;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.birth.PatientSexAndBirth;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.birth.PatientSexAndBirth.MultipleBirth;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.birth.PatientSexAndBirth.Sex;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.ethnicity.PatientEthnicity;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.ethnicity.PatientEthnicity.Ethnicity;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.general.PatientGeneralInfo;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.general.PatientGeneralInfo.Education;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.general.PatientGeneralInfo.Language;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.general.PatientGeneralInfo.MaritalStatus;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.general.PatientGeneralInfo.Occupation;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.general.PatientGeneralInfo.SpeaksEnglish;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.identification.PatientIdentification;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.name.PatientName;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.name.PatientName.Degree;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.name.PatientName.Prefix;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.name.PatientName.Suffix;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.phone.PatientPhoneAndEmail;
import gov.cdc.nbs.report.pipeline.integration.support.data.patient.race.PatientRace;
...
import gov.cdc.nbs.report.pipeline.person.model.dto.persondetail.Address;
import gov.cdc.nbs.report.pipeline.person.model.dto.persondetail.EntityData;
import gov.cdc.nbs.report.pipeline.person.model.dto.persondetail.Name;
import gov.cdc.nbs.report.pipeline.person.model.dto.persondetail.Phone;
import gov.cdc.nbs.report.pipeline.person.model.dto.persondetail.Race;
...
class PatientEventTest extends UnitTest {
  ...
  void validatePatientEvent() throws JsonProcessingException {
    ...
    // Race validation
    List<gov.cdc.nbs.report.pipeline.person.model.dto.persondetail.Race> races =
