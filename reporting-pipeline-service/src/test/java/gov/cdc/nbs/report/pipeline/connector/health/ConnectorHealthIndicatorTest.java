...
class ConnectorHealthIndicatorTest {
  ...
  void up_when_all_enabled_connectors_running() {
    properties.getDebezium().setEnabled(true);
    properties.getDebezium().setUrl(BASE_URL);
    properties.getDebezium().setDefinitions(List.of("classpath:connectors/test-connector.json"));
  ...
  void down_when_connector_endpoint_unreachable() {
    properties.getKafkaConnect().setEnabled(true);
    properties.getKafkaConnect().setUrl(BASE_URL);
    properties
        .getKafkaConnect()
        .setDefinitions(List.of("classpath:connectors/test-connector.json"));
  ...
  private ConnectorHealthIndicator newIndicator() {
