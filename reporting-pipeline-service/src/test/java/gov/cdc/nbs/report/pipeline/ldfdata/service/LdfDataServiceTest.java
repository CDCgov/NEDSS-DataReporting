...
class LdfDataServiceTest {
  ...
  @InjectMocks private LdfDataService ldfDataService;

  @Mock private LdfDataRepository ldfDataRepository;
        ...
        .untilAsserted(
            () ->
                assertTrue(
                    logs.getFirst()
                        .getFormattedMessage()
                        .contains("Received null or empty message on topic: " + ldfTopic)));
  }
  ...
  private void validateData(
      String inputTopicName, String outputTopicName, String payload, LdfData ldfData) {
