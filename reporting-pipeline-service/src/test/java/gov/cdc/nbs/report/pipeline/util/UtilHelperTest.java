...
class UtilHelperTest {
  ...
  void testExtractUid_invalidField() {
    String inValidJson =
        """
          ...
          """;
    Exception exception =
        assertThrows(NoSuchElementException.class, () -> UtilHelper.extractUid(inValidJson, "uid"));
  ...
  void testErrorMessage_withIds() {
    String msg =
        UtilHelper.errorMessage("Person", "1,2,3", new RuntimeException("Something went wrong"));
