...
class PostProcessingServiceDmTest {
  ...
  void testProduceDatamartTopic() {
    ...
    when(investigationRepositoryMock.executeStoredProcForPublicHealthCaseIds("123"))
        .thenReturn(masterData);
    when(investigationRepositoryMock.executeStoredProcForNotificationIds("124"))
  ...
  void testProcessDmMessage(DatamartTestCase testCase) {
    ...
    assertEquals(
        logs.getLast().getFormattedMessage(),
  ...
  static Stream<DatamartTestCase> datamartTestData() {
    return Stream.of(
        ...
        new DatamartTestCase(
            ...
            STD_HIV_DATAMART.getEntityName(),
            STD_HIV_DATAMART.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            GENERIC_CASE.getEntityName(),
            GENERIC_CASE.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            "Generic_Case,LDF_GENERIC",
            LDF_GENERIC.getStoredProcedure(),
            5,
            repo -> {
        ...
        new DatamartTestCase(
            ...
            "Generic_Case,LDF_MUMPS",
            LDF_MUMPS.getStoredProcedure(),
            5,
            repo -> {
              verify(repo).executeStoredProcForGenericCaseDatamart("123");
        ...
        new DatamartTestCase(
            ...
            "Generic_Case,LDF_FOODBORNE",
            LDF_FOODBORNE.getStoredProcedure(),
            5,
            repo -> {
              verify(repo).executeStoredProcForGenericCaseDatamart("123");
        ...
        new DatamartTestCase(
            ...
            "Generic_Case,LDF_TETANUS",
            LDF_TETANUS.getStoredProcedure(),
            5,
            repo -> {
              verify(repo).executeStoredProcForGenericCaseDatamart("123");
        ...
        new DatamartTestCase(
            ...
            CRS_CASE.getEntityName(),
            CRS_CASE.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            "CRS_Case,LDF_VACCINE_PREVENT_DISEASES",
            LDF_VACCINE_PREVENT_DISEASES.getStoredProcedure(),
            5,
            repo -> {
        ...
        new DatamartTestCase(
            ...
            RUBELLA_CASE.getEntityName(),
            RUBELLA_CASE.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            "Rubella_Case,LDF_VACCINE_PREVENT_DISEASES",
            LDF_VACCINE_PREVENT_DISEASES.getStoredProcedure(),
            5,
            repo -> {
        ...
        new DatamartTestCase(
            ...
            MEASLES_CASE.getEntityName(),
            MEASLES_CASE.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            "Measles_Case,LDF_VACCINE_PREVENT_DISEASES",
            LDF_VACCINE_PREVENT_DISEASES.getStoredProcedure(),
            5,
            repo -> {
        ...
        new DatamartTestCase(
            ...
            "BMIRD_Case,LDF_BMIRD",
            LDF_BMIRD.getStoredProcedure(),
            7,
            repo -> {
              verify(repo).executeStoredProcForBmirdCaseDatamart("123");
              verify(repo).executeStoredProcForBmirdStrepPneumoDatamart("123");
        ...
        new DatamartTestCase(
            ...
            HEPATITIS_CASE.getEntityName(),
            HEP100.getStoredProcedure(),
            5,
            repo -> {
        ...
        new DatamartTestCase(
            ...
            "Hepatitis_Case,LDF_HEPATITIS",
            LDF_HEPATITIS.getStoredProcedure(),
            7,
            repo -> {
              verify(repo).executeStoredProcForHepatitisCaseDatamart("123");
              verify(repo).executeStoredProcForHep100("123");
        ...
        new DatamartTestCase(
            ...
            PERTUSSIS_CASE.getEntityName(),
            PERTUSSIS_CASE.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            "Pertussis_Case,LDF_VACCINE_PREVENT_DISEASES",
            LDF_VACCINE_PREVENT_DISEASES.getStoredProcedure(),
            5,
            repo -> {
        ...
        new DatamartTestCase(
            ...
            COVID_CASE_DATAMART.getEntityName(),
            COVID_CASE_DATAMART.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            COVID_CONTACT_DATAMART.getEntityName(),
            COVID_CONTACT_DATAMART.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            COVID_VACCINATION_DATAMART.getStoredProcedure(),
            3,
        ...
        new DatamartTestCase(
            ...
            COVID_LAB_DATAMART.getEntityName(),
            COVID_LAB_CELR_DATAMART.getStoredProcedure(),
            5,
            repo -> {
  ...
  void testPostProcessMorbidityReportDatamart() {
    ...
    verify(postProcRepositoryMock)
        .executeStoredProcForMorbidityReportDatamart("130", "127", "130", "123", "126,235");
  }
  ...
  void testPostProcessDynMarts() {
    ...
    when(postProcRepositoryMock.executeStoredProcForInvSummaryDatamart("126", "127", "130"))
        .thenReturn(masterData);
    ...
    Awaitility.await()
        ...
        .untilAsserted(
            () -> {
              verify(postProcRepositoryMock)
                  .executeStoredProcForInvSummaryDatamart("126", "127", "130");
  ...
  void testProcessDmMessageException() {
    ...
    assertThrows(
        ...
        () -> postProcessingServiceMock.processDmMessage(topic, invalidMsg));
  }
  ...
  void testProcessDatamartInvalidKey() {
    ...
    assertTrue(
        logs.getLast().getMessage().contains("No associated datamart processing logic found"));
  }
