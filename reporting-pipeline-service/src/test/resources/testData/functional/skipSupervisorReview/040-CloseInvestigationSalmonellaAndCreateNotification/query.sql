...
WHERE [CONDITION_KEY] = 211
  AND [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = 'CAS14243GA01')
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS14243GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN14217GA01'
;
...
WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = 'CAS14243GA01')
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS14243GA01'
  AND [NOTIFICATION_LOCAL_ID] = N'NOT14246GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN14217GA01'
;
...
WHERE [BUSINESS_OBJECT_UID] = 14243
;
...
WHERE [NOTIFICATION_LOCAL_ID] = N'NOT14246GA01'
;
...
WHERE [TREATMENT_LOCAL_ID] = N'TRT14245GA01'
;
