...
where INVESTIGATION_KEY=(SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID='CAS1000006026GA01')
;
...
where [CONDITION_CD] = (SELECT [CONDITION_CD] FROM [RDB_MODERN].[dbo].[CONDITION] WHERE [CONDITION_DESC] = 'Salmonellosis (excluding S. typhi/paratyphi)')
...
WHERE [CONDITION_CD] = (SELECT [CONDITION_CD] FROM [RDB_MODERN].[dbo].[CONDITION] WHERE [CONDITION_KEY] = 211)
;
