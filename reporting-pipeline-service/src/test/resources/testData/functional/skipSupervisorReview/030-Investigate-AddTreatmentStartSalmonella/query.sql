...
WHERE CONDITION_KEY = (SELECT CONDITION_KEY FROM [RDB_MODERN].[dbo].[CONDITION] WHERE CONDITION_DESC = N'Salmonellosis (excluding S. typhi/paratyphi)')
 AND [INVESTIGATION_KEY] = (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID = N'CAS1000006026GA01')
;
