...
-- dbo.GENERIC_CASE | operations: insert
-- Query: 8
-- Step: 3
...
where CONDITION_KEY=(select CONDITION_KEY from [RDB_MODERN].[dbo].[CONDITION] where CONDITION_DESC = 'Salmonellosis (excluding S. typhi/paratyphi)')
 AND [INVESTIGATION_KEY] = (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID='CAS1000006026GA01')
;
...
-- dbo.LDF_FOODBORNE | operations: insert
-- Query: 19
-- Step: 3
SELECT
    [DISEASE_CD],
