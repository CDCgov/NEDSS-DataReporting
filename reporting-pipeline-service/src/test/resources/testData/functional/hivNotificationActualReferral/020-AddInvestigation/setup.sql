...
-- dbo.case_management
-- step: 2
INSERT INTO [dbo].[case_management] ([public_health_case_uid], [epi_link_id], [field_record_number], [fld_foll_up_notification_plan], [fld_foll_up_expected_in], [init_foll_up], [init_foll_up_notifiable], [act_ref_type_cd], [initiating_agncy], [foll_up_assigned_date], [init_foll_up_assigned_date]) OUTPUT INSERTED.[case_management_uid] INTO @dbo_case_management_case_management_uid_output ([value]) VALUES (@dbo_Act_act_uid, N'1310000126', N'1310000126', N'6', N'Y', N'FF', N'88', N'7', N'13', N'2026-06-05T00:00:00', N'2026-06-05T00:00:00');
