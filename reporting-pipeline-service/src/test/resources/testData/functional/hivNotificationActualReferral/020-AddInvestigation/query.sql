...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS1000010004GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN1000010000GA01'
;
...
WHERE [D_INV_ADMINISTRATIVE_KEY] = 4.0
;

-- dbo.D_INV_CONTACT | operations: insert
-- Query: 5
-- Step: 2
-- Logical comparison marked this identity as not comparison-safe.
SELECT
    [CTT_CONTACT_TYPE],
    [CTT_CONTACT_TYPE_OTH],
    [CTT_ID_THRU_CONTACT_TRACE],
    [CTT_MOTHER_INFANT_LINK_ID_1],
    [CTT_MOTHER_INFANT_LINK_ID_2],
    [CTT_MOTHER_INFANT_LINK_ID_3],
    [CTT_NUM_CONTACTS_EXPOSED],
    [CTT_RPT_ELICIT_INTERNET_INFO],
    [CTT_RPT_FIRST_NDLSHARE_EXP_DT],
    [CTT_RPT_FIRST_SEX_EXP_DT],
    [CTT_RPT_LAST_NDLSHARE_EXP_DT],
    [CTT_RPT_LAST_SEX_EXP_DT],
    [CTT_RPT_MET_OP_INTERNET],
    [CTT_RPT_NDLSHARE_EXP_FREQ],
    [CTT_RPT_RELATIONSHIP_TO_OP],
    [CTT_RPT_SEX_EXP_FREQ],
    [CTT_RPT_SPOUSE_OF_OP],
    [CTT_SOURCE_CASE_ID],
    [D_INV_CONTACT_KEY],
    [nbs_case_answer_uid]
FROM [RDB_MODERN].[dbo].[D_INV_CONTACT]
WHERE [D_INV_CONTACT_KEY] = 4.0
;
...
WHERE [D_INV_ADMINISTRATIVE_KEY] = 4
;
...
WHERE [INV_LOCAL_ID] = N'CAS1000010004GA01'
;
