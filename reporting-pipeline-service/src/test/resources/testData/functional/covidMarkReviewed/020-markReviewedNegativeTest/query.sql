...
WHERE [PATIENT_LOCAL_ID] = N'PSN10002000GA01'
...
WHERE [LOCAL_ID] = N'OBS10002008GA01'
;
...
WHERE [PERSON_LOCAL_ID] = N'PSN10002000GA01'
;
...
WHERE [LAB_TEST_UID] IN (10002009, 10002012)
...
WHERE [LAB_RPT_LOCAL_ID] = N'OBS10002008GA01'
ORDER BY [LAB_TEST_UID]
;
...
WHERE [LAB_TEST_UID] IN (10002008, 10002009, 10002012)
ORDER BY [LAB_TEST_UID]
;
