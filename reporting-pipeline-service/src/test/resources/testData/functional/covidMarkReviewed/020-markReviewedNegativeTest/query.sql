...
WHERE [PATIENT_LOCAL_ID] = N'PSN1000002000GA01'
...
WHERE [LOCAL_ID] = N'OBS1000002008GA01'
;
...
WHERE [PERSON_LOCAL_ID] = N'PSN1000002000GA01'
;
...
WHERE [LAB_TEST_UID] IN (1000002009, 1000002012)
...
WHERE [LAB_RPT_LOCAL_ID] = N'OBS1000002008GA01'
ORDER BY [LAB_TEST_UID]
;
