...
DECLARE @dbo_Entity_entity_uid bigint = 10002000;
DECLARE @dbo_Postal_locator_postal_locator_uid bigint = 10002001;
DECLARE @dbo_Tele_locator_tele_locator_uid bigint = 10002002;
DECLARE @dbo_Tele_locator_tele_locator_uid_2 bigint = 10002003;
DECLARE @dbo_Entity_entity_uid_2 bigint = 10002004;
DECLARE @dbo_Postal_locator_postal_locator_uid_2 bigint = 10002005;
DECLARE @dbo_Tele_locator_tele_locator_uid_3 bigint = 10002006;
DECLARE @dbo_Tele_locator_tele_locator_uid_4 bigint = 10002007;
DECLARE @dbo_Act_act_uid bigint = 10002008;
DECLARE @dbo_Act_act_uid_2 bigint = 10002009;
DECLARE @dbo_Act_act_uid_3 bigint = 10002010;
DECLARE @dbo_Act_act_uid_4 bigint = 10002011;
DECLARE @dbo_Act_act_uid_5 bigint = 10002012;
DECLARE @dbo_Entity_entity_uid_3 bigint = 10002013;
