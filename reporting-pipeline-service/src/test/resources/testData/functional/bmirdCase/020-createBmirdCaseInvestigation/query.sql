...
WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM RDB_MODERN.dbo.INVESTIGATION WHERE CASE_UID = '10000030')
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS10000030GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN10000000GA01'
;
...
WHERE [PATIENT_LOCAL_ID] = N'PSN10000000GA01'
;
...
WHERE [INV_LOCAL_ID] = N'CAS10000030GA01'
;
