...
WHERE [CONFIRMATION_METHOD_KEY] = (SELECT [CONFIRMATION_METHOD_KEY] FROM [RDB_MODERN].[dbo].[CONFIRMATION_METHOD_GROUP] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS3410017GA01'))
;
...
WHERE [nbs_case_answer_uid] = (SELECT nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=3410017 AND nbs_question_uid=10001195 AND rdb_table_nm=N'D_INV_CLINICAL')
;
...
WHERE [nbs_case_answer_uid] = (SELECT nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=3410017 AND nbs_question_uid=10001192 AND rdb_table_nm=N'D_INV_TREATMENT')
;
