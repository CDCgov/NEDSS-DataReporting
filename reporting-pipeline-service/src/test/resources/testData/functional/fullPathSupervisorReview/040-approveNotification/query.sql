-- Query 0: Verify CASE_LAB_DATAMART was updated
SELECT
    [AGE_REPORTED],
    [AGE_REPORTED_UNIT],
    [CASE_STATUS],
...
-- Query 1: Verify EVENT_METRIC is updated
SELECT
    [ADD_TIME],
    [ADD_USER_ID],
    [ADD_USER_NAME],
...
-- Query 2: Verify EVENT_METRIC_INC is updated
SELECT
    [ADD_TIME],
    [ADD_USER_ID],
    [ADD_USER_NAME],
...
-- Query 3: Verify HEPATITIS_DATAMART is updated
SELECT
    [ALT_RESULT_DT],
    [ALT_SGPT_RESULT],
...
-- Query 4: Verify INV_SUMM_DATAMART is updated
SELECT
    [AGE_REPORTED],
    [AGE_REPORTED_UNIT],
    [CASE_STATUS],
