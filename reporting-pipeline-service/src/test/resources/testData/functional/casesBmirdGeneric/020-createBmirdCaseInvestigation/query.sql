...
WHERE [ANTIMICROBIAL_GRP_KEY] = (SELECT [ANTIMICROBIAL_GRP_KEY] FROM [RDB_MODERN].[dbo].[BMIRD_CASE] WHERE [INVESTIGATION_KEY] = (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE [CASE_UID] = '1000001030'))
  AND [ANTIMICROBIAL_AGENT_TESTED_IND] = 'AMOXICILLIN'
;
...
WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM RDB_MODERN.dbo.INVESTIGATION WHERE CASE_UID = '1000001030')
