...
WHERE INVESTIGATION_KEY=(SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE [INV_LOCAL_ID] = N'CAS14269GA01')
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS14269GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN14250GA01'
;
...
WHERE [ORGANIZATION_LOCAL_ID] = N'ORG14258GA01'
;
...
SELECT
    ...
    [ORGANIZATION_ZIP]
FROM [RDB_MODERN].[dbo].[D_ORGANIZATION]
WHERE [ORGANIZATION_LOCAL_ID] = N'ORG14259GA01'
;
...
WHERE [PATIENT_LOCAL_ID] = N'PSN14250GA01'
;
...
WHERE [PROVIDER_LOCAL_ID] = N'PSN14256GA01'
;
...
WHERE [INV_LOCAL_ID] = N'CAS14269GA01'
;
...
WHERE LAB_RPT_LOCAL_ID = 'OBS14293GA01'
...
WHERE [LAB_TEST_UID] IN (14263, 14273, 14281, 14287, 14288, 14294, 14296)
...
WHERE LAB_RPT_LOCAL_ID IN ('OBS14262GA01', 'OBS14280GA01', 'OBS14286GA01', 'OBS14293GA01')
...
SELECT
    ...
    [TRANSCRIPTIONIST_NAME]
FROM [RDB_MODERN].[dbo].[LAB_TEST]
WHERE [LAB_RPT_LOCAL_ID] = N'OBS14263GA01'
;
...
SELECT
    ...
    [TRANSCRIPTIONIST_NAME]
FROM [RDB_MODERN].[dbo].[LAB_TEST]
WHERE [LAB_RPT_LOCAL_ID] = N'OBS14280GA01'
;
...
SELECT
    ...
    [TRANSCRIPTIONIST_NAME]
FROM [RDB_MODERN].[dbo].[LAB_TEST]
WHERE [LAB_RPT_LOCAL_ID] = N'OBS14286GA01'
;
...
SELECT
    ...
    [TRANSCRIPTIONIST_NAME]
FROM [RDB_MODERN].[dbo].[LAB_TEST]
WHERE [LAB_RPT_LOCAL_ID] = N'OBS14293GA01'
...
SELECT
    ...
    [TRANSCRIPTIONIST_NAME]
FROM [RDB_MODERN].[dbo].[LAB_TEST]
WHERE [LAB_RPT_LOCAL_ID] = N'OBS14294GA01'
;
