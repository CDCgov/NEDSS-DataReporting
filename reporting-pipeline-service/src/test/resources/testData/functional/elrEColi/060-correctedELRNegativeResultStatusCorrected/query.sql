...
WHERE LAB_RPT_LOCAL_ID = 'OBS1000008043GA01'
	AND LAB_TEST_STATUS	= 'Corrected'
;
...
WHERE [LAB_TEST_UID] IN (1000008013, 1000008023, 1000008031, 1000008037, 1000008038, 1000008044, 1000008046)
ORDER BY CASE [LAB_TEST_UID]
    WHEN 1000008013 THEN 10
    WHEN 1000008023 THEN 20
    WHEN 1000008037 THEN 30
    WHEN 1000008044 THEN 35
    WHEN 1000008038 THEN 40
    WHEN 1000008046 THEN 45
...
WHERE LAB_RPT_LOCAL_ID IN ('OBS1000008012GA01', 'OBS1000008030GA01', 'OBS1000008036GA01', 'OBS1000008043GA01')
...
SELECT
    ...
    [TRANSCRIPTIONIST_NAME]
FROM [RDB_MODERN].[dbo].[LAB_TEST]
WHERE [LAB_RPT_LOCAL_ID] = N'OBS1000008043GA01'
...
SELECT
    ...
    [TRANSCRIPTIONIST_NAME]
FROM [RDB_MODERN].[dbo].[LAB_TEST]
WHERE [LAB_RPT_LOCAL_ID] = N'OBS1000008044GA01'
;
