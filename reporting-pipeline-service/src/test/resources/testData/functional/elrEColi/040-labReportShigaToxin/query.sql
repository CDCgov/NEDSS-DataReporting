...
WHERE LAB_RPT_LOCAL_ID = 'OBS14286GA01'
...
WHERE [LAB_TEST_UID] IN (14263, 14273, 14281, 14287, 14288)
...
WHERE LAB_RPT_LOCAL_ID IN ('OBS14262GA01', 'OBS14280GA01', 'OBS14286GA01')
