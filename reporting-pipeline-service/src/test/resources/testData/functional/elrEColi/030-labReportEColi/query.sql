...
WHERE PATIENT_KEY IN (SELECT PATIENT_KEY FROM RDB_MODERN..D_PATIENT WHERE PATIENT_LOCAL_ID='PSN14250GA01')
...
WHERE LAB_TEST_UID IN (14263, 14273, 14281)
;
...
where LAB_RPT_LOCAL_ID IN ('OBS14262GA01', 'OBS14280GA01')
