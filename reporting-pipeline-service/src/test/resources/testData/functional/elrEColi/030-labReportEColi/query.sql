...
WHERE PATIENT_KEY IN (SELECT PATIENT_KEY FROM [RDB_MODERN].[dbo].[D_PATIENT] WHERE PATIENT_LOCAL_ID='PSN1000008000GA01')
...
where LAB_RPT_LOCAL_ID IN ('OBS1000008012GA01', 'OBS1000008030GA01')
