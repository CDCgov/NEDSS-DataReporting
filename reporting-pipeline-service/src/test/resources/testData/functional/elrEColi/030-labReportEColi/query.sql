...
WHERE PATIENT_KEY IN (SELECT PATIENT_KEY FROM [RDB_MODERN].[dbo].[D_PATIENT] WHERE PATIENT_LOCAL_ID = N'PSN1000008000GA01')
ORDER BY LAB_TEST_DT DESC
;
...
WHERE LAB_TEST_UID IN (1000008013, 1000008023, 1000008031)
;
...
WHERE LAB_RPT_LOCAL_ID IN (N'OBS1000008012GA01', N'OBS1000008030GA01')
ORDER BY LAB_RPT_RECEIVED_BY_PH_DT, LAB_TEST_TYPE
;
...
ORDER BY CASE [LAB_TEST_UID]
    WHEN 1000008013 THEN 1
    WHEN 1000008023 THEN 2
    WHEN 1000008031 THEN 3
END
;
