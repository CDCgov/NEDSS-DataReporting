...
WHERE [PATIENT_LOCAL_ID] = N'PSN22010000GA01'
...
WHERE [LOCAL_ID] = N'OBS22010008GA01'
;
...
WHERE [PERSON_LOCAL_ID] = N'PSN22010000GA01'
;
...
WHERE [LAB_TEST_UID] IN (22010009, 22010012)
...
WHERE [LAB_RPT_LOCAL_ID] = N'OBS22010008GA01'
ORDER BY [LAB_TEST_UID]
;
...
WHERE [LAB_TEST_UID] IN (22010008, 22010009, 22010012)
ORDER BY [LAB_TEST_UID]
;
