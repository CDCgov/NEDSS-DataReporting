...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID = N'CAS1000007017GA01')
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS1000007017GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN1000007000GA01'
;
...
WHERE [CONFIRMATION_METHOD_KEY] = (SELECT [CONFIRMATION_METHOD_KEY] FROM [RDB_MODERN].[dbo].[CONFIRMATION_METHOD_GROUP] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01')
;
...
WHERE [LOCAL_ID] = N'INT1000007019GA01'
;
...
WHERE [D_INTERVIEW_KEY] = (SELECT D_INTERVIEW_KEY FROM [RDB_MODERN].[dbo].[D_INTERVIEW] WHERE [LOCAL_ID] = N'INT1000007019GA01')
;
...
WHERE [D_INV_ADMINISTRATIVE_KEY] = (SELECT D_INV_ADMINISTRATIVE_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [D_INV_CLINICAL_KEY] = (SELECT D_INV_CLINICAL_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [D_INV_HIV_KEY] = (SELECT D_INV_HIV_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [D_INV_MEDICAL_HISTORY_KEY] = (SELECT D_INV_MEDICAL_HISTORY_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [D_INV_PREGNANCY_BIRTH_KEY] = (SELECT D_INV_PREGNANCY_BIRTH_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [D_INV_RISK_FACTOR_KEY] = (SELECT D_INV_RISK_FACTOR_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [D_INV_SOCIAL_HISTORY_KEY] = (SELECT D_INV_SOCIAL_HISTORY_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [D_INV_TREATMENT_KEY] = (SELECT D_INV_TREATMENT_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000007017GA01'))
;
...
WHERE [PATIENT_LOCAL_ID] = N'PSN1000007000GA01'
;
...
WHERE [LOCAL_ID] = N'CAS1000007017GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'OBS1000007008GA01'
;
...
WHERE [INV_LOCAL_ID] = N'CAS1000007017GA01'
;
...
WHERE [PAGE_CASE_UID] = 1000007017.0
;
...
WHERE [PERSON_LOCAL_ID] = N'PSN1000007000GA01'
;
...
WHERE [LAB_RPT_LOCAL_ID] = N'OBS1000007008GA01'
;
...
WHERE [LAB_TEST_UID] IN (1000007008, 1000007011)
...
WHERE [TREATMENT_LOCAL_ID] = N'TRT1000007018GA01'
;
...
WHERE TREATMENT_KEY = (SELECT TREATMENT_KEY FROM [RDB_MODERN].[dbo].[TREATMENT] WHERE [TREATMENT_LOCAL_ID] = N'TRT1000007018GA01')
  AND [TREATMENT_PHYSICIAN_KEY] = 2
  AND [TREATMENT_PROVIDING_ORG_KEY] = 3
;

-- dbo.DM_INV_STD | operations: insert
-- Query: 42
-- Steps: 2, 3, 4, 5, 6
SELECT
    [INV_LOCAL_ID],
    ...
    [TRANSMISSION_MODE],
    [CURR_PROCESS_STATE],
    [ENROLL_PRTR_SRVCS_IND],
    [HIV_TEST_IND],
    [HIV_TEST_REFERRAL_DT],
    [PREVIOUS_HIV_TEST_IND],
    [REFER_FOR_HIV_TEST],
    [RFR_FOR_HIV_CARE_IND],
    [PRE_EXP_PROPHY_IND],
    [PRE_EXP_PROPHY_REFER],
    [PREV_STD_HIST],
    [NUM_SEX_PARTNER_12MO],
    [UNK_SEX_PARTNERS],
    [SEX_PRTR_ANSR_REFUSED],
    [SEX_PRTRS_NET_12M_IND],
    [MALE_PRTNRS_12MO_IND],
    [MALE_PRTRS_12M_TOTAL],
    [FEMALE_PRTRS_12M_IND],
    [FEMALE_PRTRS_12M_TTL],
    [TRANS_PRTRS_12M_IND],
    [PRTNRS_PRD_MALE_IND],
    [PRTNRS_PRD_MALE_TTL],
    [PRTNRS_PRD_FML_IND],
