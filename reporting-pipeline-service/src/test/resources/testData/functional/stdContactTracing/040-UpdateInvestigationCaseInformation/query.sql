...
WHERE [nbs_case_answer_uid] = (SELECT nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=1000007017 AND nbs_question_uid=10001195 AND rdb_table_nm=N'D_INV_CLINICAL')
;
...
WHERE [nbs_case_answer_uid] = (SELECT nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=1000007017 AND nbs_question_uid=10001192 AND rdb_table_nm=N'D_INV_TREATMENT')
;
