...
WHERE [CONFIRMATION_METHOD_KEY] = (SELECT [CONFIRMATION_METHOD_KEY] FROM [RDB_MODERN].[dbo].[CONFIRMATION_METHOD_GROUP] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
