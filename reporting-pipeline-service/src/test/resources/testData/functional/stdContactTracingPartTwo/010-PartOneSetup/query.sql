...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID=N'CAS3410017GA01')
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS3410017GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN3410000GA01'
;
...
WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS3410017GA01')
;
...
WHERE [LOCAL_ID] = N'INT3410019GA01'
;
...
WHERE [D_INTERVIEW_KEY] = (SELECT D_INTERVIEW_KEY FROM [RDB_MODERN].[dbo].[D_INTERVIEW] WHERE [LOCAL_ID] = N'INT3410019GA01')
;
...
WHERE [nbs_case_answer_uid] = (SELECT nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=3410017 AND nbs_question_uid=10001013 AND rdb_table_nm=N'D_INV_ADMINISTRATIVE')
;
...
WHERE [nbs_case_answer_uid] = (SELECT top 1 nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=3410017 AND rdb_table_nm=N'D_INV_CLINICAL')
;
...
WHERE [D_INV_HIV_KEY] = (SELECT D_INV_HIV_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS3410017GA01'))
;
...
WHERE [nbs_case_answer_uid] = (SELECT nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=3410017 AND rdb_table_nm=N'D_INV_MEDICAL_HISTORY')
;
...
WHERE [nbs_case_answer_uid] = (SELECT nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=3410017 AND nbs_question_uid=10001252 AND rdb_table_nm=N'D_INV_PREGNANCY_BIRTH')
;
...
WHERE [D_INV_RISK_FACTOR_KEY] = (SELECT D_INV_RISK_FACTOR_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS3410017GA01'))
;
...
WHERE [D_INV_SOCIAL_HISTORY_KEY] = (SELECT D_INV_SOCIAL_HISTORY_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS3410017GA01'))
;
...
WHERE [nbs_case_answer_uid] = (SELECT nbs_case_answer_uid FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=3410017 AND rdb_table_nm=N'D_INV_TREATMENT')
;
...
WHERE [PATIENT_LOCAL_ID] = N'PSN3410000GA01'
;
...
WHERE [LOCAL_ID] = N'CAS3410017GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'OBS3410008GA01'
;
...
WHERE [D_INV_ADMINISTRATIVE_KEY] = (SELECT D_INV_ADMINISTRATIVE_KEY FROM [RDB_MODERN].[dbo].[nrt_page_case_answer] WHERE act_uid=3410017 AND nbs_question_uid=10001013 AND rdb_table_nm=N'D_INV_ADMINISTRATIVE') AND [CONDITION_KEY] = (SELECT CONDITION_KEY from [RDB_MODERN].[dbo].[nrt_condition_key] WHERE condition_cd=N'10312')
;
...
WHERE [INV_LOCAL_ID] = N'CAS3410017GA01'
;
...
WHERE [PERSON_LOCAL_ID] = N'PSN3410000GA01'
;
...
WHERE [LAB_RPT_LOCAL_ID] = N'OBS3410008GA01'
;
...
WHERE [LAB_TEST_UID] IN (3410008, 3410011)
...
WHERE [TREATMENT_LOCAL_ID] = N'TRT3410018GA01'
;
...
WHERE TREATMENT_KEY=(SELECT TREATMENT_KEY FROM [RDB_MODERN].[dbo].[TREATMENT] WHERE [TREATMENT_LOCAL_ID] = N'TRT3410018GA01')
