...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID = N'CAS1000009024GA01')
;
...
-- Query: 43
-- Step: 8
-- Why not just query [L_INVESTIGATION_REPEAT].[PAGE_CASE_UID]? Because it's a float and causing me problems.
SELECT
    [L_INVESTIGATION_REPEAT].[PAGE_CASE_UID]
FROM [RDB_MODERN].[dbo].[L_INVESTIGATION_REPEAT]
join [RDB_MODERN].[dbo].[D_INVESTIGATION_REPEAT] on [RDB_MODERN].[dbo].[D_INVESTIGATION_REPEAT].[PAGE_CASE_UID] = [RDB_MODERN].[dbo].[L_INVESTIGATION_REPEAT].[PAGE_CASE_UID]
where [RDB_MODERN].[dbo].[D_INVESTIGATION_REPEAT].PAGE_CASE_UID=1000009024
GROUP BY [RDB_MODERN].[dbo].[L_INVESTIGATION_REPEAT].D_INVESTIGATION_REPEAT_KEY, [RDB_MODERN].[dbo].[L_INVESTIGATION_REPEAT].PAGE_CASE_UID
;
