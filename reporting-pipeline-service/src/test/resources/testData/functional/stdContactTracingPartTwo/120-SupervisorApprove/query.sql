...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID IN (N'CAS1000008017GA01', N'CAS1000008024GA01'))
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS1000008017GA01'
...
SELECT
    ...
    [REPORTING_SOURCE]
FROM [RDB_MODERN].[dbo].[CASE_LAB_DATAMART]
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS1000008024GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN1000008020GA01'
;
...
WHERE [LOCAL_ID] = N'CON1000008027GA01'
;
...
WHERE [LOCAL_ID] = N'INT1000008019GA01'
;
...
WHERE [D_INTERVIEW_KEY] = (SELECT D_INTERVIEW_KEY FROM [RDB_MODERN].[dbo].[D_INTERVIEW] WHERE [LOCAL_ID] = N'INT1000008019GA01')
;
...
WHERE [D_INV_ADMINISTRATIVE_KEY] = (SELECT D_INV_ADMINISTRATIVE_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
...
WHERE [D_INV_CLINICAL_KEY] = (SELECT D_INV_CLINICAL_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
...
WHERE [D_INV_HIV_KEY] = (SELECT D_INV_HIV_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
...
WHERE [D_INV_MEDICAL_HISTORY_KEY] = (SELECT D_INV_MEDICAL_HISTORY_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
...
WHERE [D_INV_PREGNANCY_BIRTH_KEY] = (SELECT D_INV_PREGNANCY_BIRTH_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
...
WHERE [D_INV_RISK_FACTOR_KEY] = (SELECT D_INV_RISK_FACTOR_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
...
WHERE [D_INV_SOCIAL_HISTORY_KEY] = (SELECT D_INV_SOCIAL_HISTORY_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
...
WHERE [D_INV_TREATMENT_KEY] = (SELECT D_INV_TREATMENT_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01'))
;
...
SELECT
    ...
    [PATIENT_ZIP]
FROM [RDB_MODERN].[dbo].[D_PATIENT]
WHERE [PATIENT_LOCAL_ID] = N'PSN1000008020GA01'
;
...
WHERE [LOCAL_ID] = N'CAS1000008017GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'CAS1000008024GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'NOT1000008028GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'OBS1000008008GA01'
;
...
WHERE [D_CONTACT_RECORD_KEY] = (SELECT D_CONTACT_RECORD_KEY FROM [RDB_MODERN].[dbo].[D_CONTACT_RECORD] WHERE [LOCAL_ID] = N'CON1000008027GA01')
;
...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID IN (N'CAS1000008017GA01', N'CAS1000008024GA01')) ORDER BY [CLOSED_BY_KEY]
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS1000008017GA01'
  AND [NOTIFICATION_LOCAL_ID] = N'NOT1000008028GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN1000008000GA01'
;
...
WHERE [INV_LOCAL_ID] = N'CAS1000008017GA01'
;
...
SELECT
    ...
    [TRANSMISSION_MODE]
FROM [RDB_MODERN].[dbo].[INVESTIGATION]
WHERE [INV_LOCAL_ID] = N'CAS1000008024GA01'
;
...
WHERE [PAGE_CASE_UID] = 1000008017.0
;
...
WHERE [PAGE_CASE_UID] IN (1000008024.0, 1000008017.0)
;
...
WHERE [PERSON_LOCAL_ID] = N'PSN1000008000GA01'
;
...
WHERE [LAB_RPT_LOCAL_ID] = N'OBS1000008008GA01'
;
...
WHERE [LAB_TEST_UID] IN (1000008008, 1000008011)
...
WHERE [NOTIFICATION_LOCAL_ID] = N'NOT1000008028GA01'
;
...
WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000008017GA01')
;
...
WHERE [TREATMENT_LOCAL_ID] = N'TRT1000008018GA01'
;
...
WHERE TREATMENT_KEY=(SELECT TREATMENT_KEY FROM [RDB_MODERN].[dbo].[TREATMENT] WHERE [TREATMENT_LOCAL_ID] = N'TRT1000008018GA01')
