...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID = N'CAS1000008017GA01')
;
...
WHERE [D_INVESTIGATION_REPEAT_KEY] = 2.0 AND [BLOCK_NM] = N'BLOCK_8' AND [ANSWER_GROUP_SEQ_NBR] = 2
;
