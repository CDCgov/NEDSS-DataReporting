...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID=N'CAS3400017GA01')
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS3400017GA01'
...
SELECT
    ...
    [REPORTING_SOURCE]
FROM [RDB_MODERN].[dbo].[CASE_LAB_DATAMART]
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS3400024GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN3400020GA01'
;
...
WHERE [INVESTIGATION_KEY] IN (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID IN (N'CAS3400017GA01', N'CAS3400024GA01'))
;
...
WHERE [LOCAL_ID] = N'CON3400027GA01'
;
...
WHERE [LOCAL_ID] = N'INT3400019GA01'
;
...
WHERE [D_INTERVIEW_KEY] = (SELECT D_INTERVIEW_KEY FROM [RDB_MODERN].[dbo].[D_INTERVIEW] WHERE [LOCAL_ID] = N'INT3400019GA01')
;
...
WHERE [D_INV_HIV_KEY] = (SELECT D_INV_HIV_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS3400017GA01'))
;
...
WHERE [D_INV_RISK_FACTOR_KEY] = (SELECT D_INV_RISK_FACTOR_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS3400017GA01'))
;
...
WHERE [D_INV_SOCIAL_HISTORY_KEY] = (SELECT D_INV_SOCIAL_HISTORY_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS3400017GA01'))
;
...
SELECT
    ...
    [PATIENT_ZIP]
FROM [RDB_MODERN].[dbo].[D_PATIENT]
WHERE [PATIENT_LOCAL_ID] = N'PSN3400020GA01'
;
...
WHERE [LOCAL_ID] = N'CAS3400017GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'CAS3400024GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'NOT3400028GA01'
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS3400017GA01'
  AND [NOTIFICATION_LOCAL_ID] = N'NOT3400028GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN3400000GA01'
;
...
WHERE [INV_LOCAL_ID] = N'CAS3400017GA01'
;
...
SELECT
    ...
    [TRANSMISSION_MODE]
FROM [RDB_MODERN].[dbo].[INVESTIGATION]
WHERE [INV_LOCAL_ID] = N'CAS3400024GA01'
;
...
WHERE [PERSON_LOCAL_ID] = N'PSN3400000GA01'
;
...
WHERE [NOTIFICATION_LOCAL_ID] = N'NOT3400028GA01'
;
...
WHERE TREATMENT_KEY=(SELECT TREATMENT_KEY FROM [RDB_MODERN].[dbo].[TREATMENT] WHERE [TREATMENT_LOCAL_ID] = N'TRT3400018GA01')
