...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID IN (N'CAS1000009017GA01', N'CAS1000009024GA01'))
;

-- dbo.CASE_LAB_DATAMART | operations: delete, insert
-- Query: 1
-- Steps: 2, 4, 5, 6, 9, 10, 11, 12
SELECT
    [AGE_REPORTED],
    [AGE_REPORTED_UNIT],
    [CASE_STATUS],
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS1000009017GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN1000009000GA01'
;
...
SELECT
    ...
    [REPORTING_SOURCE]
FROM [RDB_MODERN].[dbo].[CASE_LAB_DATAMART]
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS1000009024GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN1000009020GA01'
;
...
WHERE [CONFIRMATION_METHOD_KEY] = (SELECT [CONFIRMATION_METHOD_KEY] FROM [RDB_MODERN].[dbo].[CONFIRMATION_METHOD_GROUP] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;
...
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID = N'CAS1000009017GA01')
;

-- dbo.D_CONTACT_RECORD | operations: insert, update
-- Query: 6
-- Steps: 7, 8
SELECT
    [ADD_TIME],
    ...
    [CTT_DISPOSITION],
    [CTT_DISPO_DT],
    [CTT_ELICIT_INTERNET_INFO],
    [CTT_EVAL_COMPLETED],
    [CTT_EVAL_DT],
    [CTT_EVAL_NOTES],
    [CTT_EXPOSURE_SITE_TYPE],
    [CTT_EXPOSURE_TYPE],
    [CTT_FIRST_EXPOSURE_DT],
    [CTT_FIRST_NDLSHARE_EXP_DT],
    [CTT_FIRST_SEX_EXP_DT],
    [CTT_GROUP_LOT_ID],
    [CTT_HAIR],
    [CTT_HEALTH_STATUS],
    [CTT_HEIGHT],
    ...
    [CTT_INV_ASSIGNED_DT],
    [CTT_JURISDICTION_NM],
    [CTT_LAST_EXPOSURE_DT],
    [CTT_LAST_NDLSHARE_EXP_DT],
    [CTT_LAST_SEX_EXP_DT],
    [CTT_MET_OP_INTERNET],
    [CTT_NAMED_ON_DT],
    [CTT_NDLSHARE_EXP_FREQ],
    [CTT_NOTES],
    [CTT_OTHER_ID_INFO],
    [CTT_PRIORITY],
    ...
    [VERSION_CTRL_NBR]
FROM [RDB_MODERN].[dbo].[D_CONTACT_RECORD]
WHERE [LOCAL_ID] = N'CON1000009027GA01'
;

-- dbo.D_INTERVIEW | operations: insert
-- Query: 7
-- Step: 6
SELECT
    [ADD_TIME],
...
WHERE [LOCAL_ID] = N'INT1000009019GA01'
;

-- dbo.D_INTERVIEW_NOTE | operations: insert
-- Query: 8
-- Step: 6
-- Logical comparison marked this identity as not comparison-safe.
SELECT
...
WHERE [D_INTERVIEW_KEY] = (SELECT D_INTERVIEW_KEY FROM [RDB_MODERN].[dbo].[D_INTERVIEW] WHERE [LOCAL_ID] = N'INT1000009019GA01')
;
...
WHERE [D_INV_ADMINISTRATIVE_KEY] = (SELECT D_INV_ADMINISTRATIVE_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;

-- dbo.D_INV_CLINICAL | operations: insert
-- Query: 10
-- Steps: 4, 5, 6, 9, 10, 11, 12
-- Logical comparison marked this identity as not comparison-safe.
SELECT
    [CHEST_RAD_RESULT],
...
WHERE [D_INV_CLINICAL_KEY] = (SELECT D_INV_CLINICAL_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;
...
SELECT
    ...
    [HIV_EHARS_TRNSMSN_CTGRY],
    [HIV_ENROLL_PRTNR_SRVCS_IND],
    [HIV_HIV_STATUS_CD_MTH],
    [HIV_HIV_STAT_INV_IN_EHARS],
...
WHERE [D_INV_HIV_KEY] = (SELECT D_INV_HIV_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;
...
WHERE [D_INV_MEDICAL_HISTORY_KEY] = (SELECT D_INV_MEDICAL_HISTORY_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;
...
WHERE [D_INV_PREGNANCY_BIRTH_KEY] = (SELECT D_INV_PREGNANCY_BIRTH_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;
...
SELECT
    ...
    [RSK_ANIMAL_CONTACT_LOCATION],
    [RSK_ANS_REFUSED_SEX_PARTNER],
    [RSK_ATTEND_EVENTS],
    [RSK_BEEN_INCARCERATD_12MO_IND],
    [RSK_BLOOD_BANK_NOTIFIED],
    [RSK_BLOOD_DONOR],
    [RSK_BLOOD_TRANSFUSION],
    [RSK_BREAST_FED_INFANT],
    [RSK_BloodExpOther],
    ...
    [RSK_CHILD_CARE_FACILITY],
    [RSK_COCAINE_USE_12MO_IND],
    [RSK_CONGEST_HEART_FAIL],
    [RSK_CONSUMED_SUSPECT_MEAT],
    [RSK_COPD],
    [RSK_CORRECTIONAL_EXP],
    [RSK_CRACK_USE_12MO_IND],
    [RSK_ClottingPrior87],
    [RSK_ContaminatedStick],
    [RSK_DIABETES],
    [RSK_DONATED_PRODUCT],
    [RSK_DONATED_PRODUCT_OTH],
    [RSK_DT_OF_BLD_TRANSFUSION],
    [RSK_DentalOralSx],
    [RSK_EDUCATIONAL_EXP],
    [RSK_ED_MEDS_USE_12MO_IND],
    [RSK_EXPOSRE_EVENT_NOTES],
    [RSK_EXP_LOCATION_DETAILS],
    [RSK_HCW_WORK_EXPOSED],
    [RSK_HEMODIALYSIS_BEFORE_ONSET],
    [RSK_HEROIN_USE_12MO_IND],
    [RSK_HOSPITALIZATION_REASON],
    [RSK_HOSPITALIZATION_REASON_OTH],
    [RSK_HYPERTENSION],
    [RSK_HemodialysisLongTerm],
    [RSK_HepContactEver],
    [RSK_HomelessWithinPastYr],
    [RSK_HospitalizedPrior],
    [RSK_IDU],
    [RSK_IMMUNE_SUPPRESS_MED],
    ...
    [RSK_NUM_SEX_PARTNER_12MO],
    [RSK_NumSexPrtners],
    [RSK_OCCUPATIONAL_EXP],
    [RSK_ORGAN_DONOR],
    [RSK_ORGAN_TRANSPLANT],
    [RSK_OTHER_DRUG_SPEC],
    [RSK_OTHER_DRUG_USE_12MO_IND],
    [RSK_OtherBldExpSpec],
    [RSK_PATIENT_HEALTHCARE_WORKER],
    [RSK_PATIENT_HOMELESS],
    [RSK_PSWrkrBldCnctFreq],
    [RSK_Piercing],
    [RSK_PiercingOthLocSpec],
    [RSK_PiercingRcvdFrom],
    [RSK_PublicSafetyWorker],
    [RSK_RECEIVED_BLOOD_TRANSF],
    [RSK_RISK_FACTORS_ASSESS_IND],
    [RSK_SCHOOL_UNIVERSITY_EXP],
    [RSK_SEXUAL_CONTACT_IND],
    ...
    [RSK_TICK_BITE_IND],
    [RSK_TRANSFUSED_PRODUCT],
    [RSK_TRANSFUSED_PRODUCT_OTH],
    [RSK_TRANSFUSION_ASSOCIATE],
    [RSK_Tattoo],
    [RSK_TattooLocOthSpec],
    [RSK_TattooLocation],
    [RSK_TransfusionPrior92],
    [RSK_TransplantPrior92],
    [RSK_UNK_SEX_PARTNERS],
    [RSK_WKPLC_CRITICAL_INFRA],
    [RSK_WKPLC_SETTING],
    [RSK_WKPLC_SETTING_CODED],
    [RSK_WKPLC_SETTING_CODED_OTH],
    [RSK_WORKPLACE_EXP]
FROM [RDB_MODERN].[dbo].[D_INV_RISK_FACTOR]
WHERE [D_INV_RISK_FACTOR_KEY] = (SELECT D_INV_RISK_FACTOR_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;
...
WHERE [D_INV_SOCIAL_HISTORY_KEY] = (SELECT D_INV_SOCIAL_HISTORY_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;
...
WHERE [D_INV_TREATMENT_KEY] = (SELECT D_INV_TREATMENT_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01'))
;

-- dbo.D_INVESTIGATION_REPEAT | operations: insert
-- Query: 17
-- Steps: 9, 10, 11, 12
-- Logical comparison marked this identity as not comparison-safe.
SELECT
    [ADM_ADV_EVE_IND],
    [ADM_ADV_EVE_MNFSTN_DT],
    [ADM_LINKED_CASE_NBR],
    [ADM_PREV_STATE_CASE_NBR],
    [ANSWER_GROUP_SEQ_NBR],
    [BLOCK_NM],
    [CLN_ADMISSION_DATE],
    [CLN_ADMITTED_AS_INPATIENT],
    [CLN_ADVERSE_EVNT_ONSET],
    [CLN_ADVERSE_EVNT_ONSE_UNIT],
    [CLN_ADVERSE_EVNT_SEVERITY],
    [CLN_ADVERSE_EVT_RLTD_TRMT],
    [CLN_CHEST_STDY_TYPE],
    [CLN_CHEST_STDY_TYPE_OTH],
    [CLN_CHEST_STUDY_DT],
    [CLN_DIAGNOSIS_TYPE],
    [CLN_DISCHARGE_DATE],
    [CLN_EVIDENCE_CAVITY],
    [CLN_EVIDENCE_MILIARY_TB],
    [CLN_HOSPITAL_NAME],
    [CLN_HOSPITAL_RECORD_NBR],
    [CLN_HSPTL_DUR_DAYS],
    [CLN_MAL_PREVIOUS_SPECIES],
    [CLN_MAL_PREVIOUS_SPECI_OTH],
    [CLN_PREVIOUS_ILLNESS_DT],
    [CLN_RSLT_CHEST_STDY],
    [CMP_ADVERSE_EVENT],
    [CMP_ADVERSE_EVENT_OTH],
    [CMP_ADVERSE_EVNT_DESC],
    [CMP_COMPLICATION],
    [CMP_COMPLICATION_IND],
    [CMP_COMPLICATION_OTH],
    [D_INTERVIEW_NOTE_KEY],
    [ELECTRONIC_IND],
    [ELECTRONIC_IND2],
    [EPI_BLOOD_DONATION_DT],
    [EPI_BLOOD_TRANSFUSION_DT],
    [EPI_CITY_OF_EXP],
    [EPI_CNTRY_OF_EXP],
    [EPI_CNTY_OF_EXP],
    [EPI_CO_LEVEL_IN_AIR],
    [EPI_DATE_OF_READING],
    [EPI_MASK_WORN_FREQUENCY],
    [EPI_MASK_WORN_TRAVELING],
    [EPI_OTHER_MEAT_TYPE],
    [EPI_PSN_ORG_TKNG_CO_REDNG],
    [EPI_PSN_ORG_TKNG_CO_RE_OTH],
    [EPI_SOURCE_VACC_DOSE_NBR],
    [EPI_ST_OR_PROV_OF_EXP],
    [EPI_SUSPCTD_SRC_COUGH_ONSET_DT],
    [EPI_SUSPECTED_SOURCE_AGE],
    [EPI_SUSPECTED_SOURCE_RELATION],
    [EPI_SUSPECTED_SOURCE_R_OTH],
    [EPI_SUSPECTED_SOURCE_SEX],
    [EPI_SUSPECTED_SOURCE__UNIT],
    [FIELD_SUPERVISOR_RVW_NOTE],
    [FL_FUP_NOTE],
    [IPO_CURRENT_INDUSTRY],
    [IPO_CURRENT_INDUSTRY_TXT],
    [IPO_CURRENT_OCCUPATION],
    [IPO_CURRENT_OCCUPATION_TXT],
    [IX_INV_NOTE],
    [LAB_ADDL_SPECIMEN_ID],
    [LAB_ANTI_MIC_SUSC_RSLT_DT],
    [LAB_AST_COLLECTION_SITE],
    [LAB_AST_COLLECTION_SIT_OTH],
    [LAB_AST_INTERPRETATION],
    [LAB_AST_QUANT_RSLT],
    [LAB_AST_RESULT_NUM_UNITS],
    [LAB_AST_RSLT_CODED_QUANT],
    [LAB_AST_SPECIMEN_TYPE],
    [LAB_AST_SPECIMEN_TYPE_OTH],
    [LAB_AST_SPEC_COLLECT_DT],
    [LAB_AST_TEST_METHOD],
    [LAB_AST_TEST_METHOD_OTH],
    [LAB_AST_TEST_TYPE],
    [LAB_AST_TEST_TYPE_OTH],
    [LAB_CDC_SPECIMEN_ID],
    [LAB_CODED_QUANT_TEST_RSLT],
    [LAB_GENE_IDENTIFIER],
    [LAB_GENE_IDENTIFIER_OTH],
    [LAB_INTERP_FLAG],
    [LAB_ISOLATE_IDENTIFIER],
    [LAB_ISOLTE_SENT_STATE_LAB],
    [LAB_LABORATORY_STATE],
    [LAB_LAB_TST_MODIFIER],
    [LAB_LINKING_UID],
    [LAB_MICROORG_IDENTIFIED],
    [LAB_MOLE_SUSC_AMINO_ACID],
    [LAB_MOLE_SUSC_INDEL],
    [LAB_MOLE_SUSC_NUCLIC_ACID],
    [LAB_MOLE_SUSC_REPRTD_DT],
    [LAB_MOLE_SUSC_SPC_COLC_DT],
    [LAB_MOLE_SUSC_SPEC_TY],
    [LAB_MOLE_SUSC_SPEC_TY_OTH],
    [LAB_MOLE_SUSC_TST_MTHD],
    [LAB_MOLE_SUSC_TST_MTHD_OTH],
    [LAB_MOLE_SUSC_TST_RSLT],
    [LAB_ORGANISM_NAME],
    [LAB_ORGANISM_NAME_OTH],
    [LAB_OTH_PATHOGEN_TST],
    [LAB_PARASITEMIA_LVL_PCT],
    [LAB_PERFORMING_LAB_NAME],
    [LAB_PERFORMING_LAB_TYPE],
    [LAB_PERFORMING_LAB_TYP_OTH],
    [LAB_PHONE_NUMBER],
    [LAB_QUANT_RSLT_UNITS],
    [LAB_QUANT_TEST_RESULT],
    [LAB_REF_RANGE_FROM],
    [LAB_REF_RANGE_TO],
    [LAB_RESULTED_TEST_CD],
    [LAB_RESULT_CODE],
    [LAB_RESULT_CODED_VAL],
    [LAB_RESULT_COMMENTS],
    [LAB_RESULT_DT],
    [LAB_RESULT_NUM_VAL],
    [LAB_RESULT_TXT_VALUE],
    [LAB_SAMPLE_ANALYZD_DT],
    [LAB_SPECIMEN_ANALYZED_DT],
    [LAB_SPECIMEN_COLLECTION_DT],
    [LAB_SPECIMEN_COLLECT_DT],
    [LAB_SPECIMEN_ID],
    [LAB_SPECIMEN_SENT_TO_CDC_DT],
    [LAB_SPECIMEN_SENT_TO_CDC_IND],
    [LAB_SPECIMEN_SOURCE],
    [LAB_SPECIMEN_SOURCE_OTH],
    [LAB_SPECIMEN_TEST_DATE],
    [LAB_SPECIMEN_TYPE],
    [LAB_SPECIMEN_TYPE_OTH],
    [LAB_SPEC_SENT_TO_SPHL_DT],
    [LAB_STATE_LAB_ISOLATE_ID],
    [LAB_STRAIN_TYPE],
    [LAB_STRAIN_TYPE_OTH],
    [LAB_SUSPECT_MEAT_TESTED],
    [LAB_SUSPECT_MEAT_TESTE_OTH],
    [LAB_TEST_CD],
    [LAB_TEST_METHOD],
    [LAB_TEST_METHOD_CD],
    [LAB_TEST_METHOD_OTH],
    [LAB_TEST_RESULT],
    [LAB_TEST_RESULT_COMMENTS],
    [LAB_TEST_RESULT_OTH],
    [LAB_TEST_STATUS],
    [LAB_TEST_TYPE],
    [LAB_TEST_TYPE_OTH],
    [LAB_TEXT_METHOD_TXT],
    [LAB_USER_COMMENTS_ELR],
    [LAB_VPD_LAB_MSG_PATIENT_ID],
    [LAB_VPD_LAB_MSG_REF_LAB_NM],
    [LAB_VPD_LAB_MSG_SPECIMEN_ID],
    [LAB_WGS_ID_NBR],
    [MDH_HX_CONDITION],
    [MDH_HX_CONFIRMED_IND],
    [MDH_HX_DIAGNOSIS_DT],
    [MDH_HX_TREATMENT_DT],
    [MTH_LAB_RESULT_DT_MTH],
    [MTH_LAB_TEST_RESULT_MTH],
    [MTH_LAB_TEST_TYPE_MTH],
    [MTH_LAB_TST_MOD_MTH],
    [MTH_NONTREP_RSLT_QNT_MTH],
    [OTH_PATHOGEN_TST_RSLT],
    [PAGE_CASE_UID],
    [PARENT_UID],
    [PLACE_AS_SEX_OF_PHC],
    ...
    [RSK_CONSUMED_DT],
    [RSK_COOKING_METHOD],
    [RSK_COOKING_METHOD_OTH],
    [RSK_DT_OF_BLD_TRANSFUSION],
    [RSK_LARVA_SUSPECT_MEAT],
    [RSK_MEAT_COMMENTS],
    [RSK_MEAT_PREPARATION],
    [RSK_MEAT_PREPARATION_OTH],
    [RSK_ORGANS_TRANSPLNTD_TXT],
    [RSK_SUSPECT_MEAT_TYPE],
    [RSK_SUSPECT_MEAT_TYPE_OTH],
    [RSK_TICK_BITE_DT],
    [RSK_TICK_BITE_LOCATION],
    [RSK_TRNSPLNT_ASSOC_INFCTN],
    [RSK_WHERE_MEAT_OBTAINED],
    [RSK_WHERE_MEAT_OBTAINE_OTH],
    [STD_SIGN_SX_ANATOMIC_SITE],
    [SUPERVISOR_RVW_NOTE],
    [SURV_NOTE],
    [SUS_CODED_RSLT],
    [SUS_INTERP_FLAG],
    ...
    [SUS_REF_RANGE_TO],
    [SUS_REPORT_DT],
    [SUS_RESULT_CODED_VAL],
    [SUS_RESULT_COMMENTS],
    [SUS_RESULT_NUM_UNIT],
    [SUS_RESULT_NUM_VAL],
    [SUS_RESULT_TXT_VALUE],
    [SUS_TEST_CD],
    [SUS_TEST_CD_DESC],
    [SUS_TEST_METHOD_CD],
    [SUS_TEST_STATUS],
    [SYM_SIGNSSYMPTOMS],
    [SYM_SIGNSSYMPTOMS_OTH],
    [SYM_SIGN_SX_ANATOMIC_SITE_OTH],
    [SYM_SIGN_SX_DURATION_IN_DAYS],
    [SYM_SIGN_SX_OBVTN_ONSET_DT],
    [SYM_SIGN_SX_SOURCE],
    [SYM_SIGN_SYMPTOM_IND],
    [TRT_CMPLT_TRT_PREV_DIAG],
    [TRT_DRG_USD_TRT_MDR_TB],
    [TRT_DRG_USD_TRT_MDR_TB_OTH],
    [TRT_DUR_DRG_ADMINSTRD],
    [TRT_MALARIA_INFO],
    [TRT_MALARIA_INFO_OTH],
    [TRT_MEDICATION_ADMINISTERED],
    [TRT_MEDICATION_ADMINIS_OTH],
    [TRT_MEDICATION_ADMSTRD],
    [TRT_MEDICATION_DURATION],
    [TRT_MEDICATION_START_DT],
    [TRT_MEDICATION_STOP_DATE],
    [TRT_MED_ADMST_RELTVE_TRT],
    [TRT_TREATMENT_DURATION],
    [TRT_TREATMENT_END_DT],
    [TRT_TREATMENT_LOCATION],
    [TRT_TREATMENT_RX_DT],
    [TRT_TREATMENT_START_DT],
    [TRV_ARRIVAL_TRVL_DEST_DT],
    [TRV_DEPART_TRVL_DEST_DT],
    [TRV_DESTINATION_TYPE],
    [TRV_DURATION_OUTSIDE_US],
    [TRV_DURATION_OUTSIDE__UNIT],
    [TRV_FLIGHT_NUMBER],
    [TRV_INTL_DESTINATIONS],
    [TRV_INTL_DESTINATIONS_OTH],
    [TRV_SEAT_NUMBER],
    [TRV_TRAVEL_CITY],
    [TRV_TRAVEL_COUNTY],
    [TRV_TRAVEL_INFORMATION],
    [TRV_TRAVEL_MODE],
    [TRV_TRAVEL_RETURN_DT],
    [TRV_TRAVEL_SEX_CONTACT],
    [TRV_TRAVEL_STATE],
    [TRV_VHF_TRAVEL_REASON],
    [TRV_VHF_TRAVEL_REASON_OTH],
    [VAC_VACCINATIONDATE],
    [VAC_VACCINEDOSENUM]
FROM [RDB_MODERN].[dbo].[D_INVESTIGATION_REPEAT]
WHERE [D_INVESTIGATION_REPEAT_KEY] = (SELECT D_INVESTIGATION_REPEAT_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01')) AND [BLOCK_NM] = N'BLOCK_8' AND [ANSWER_GROUP_SEQ_NBR] = 2
;

-- dbo.D_PATIENT | operations: delete, insert
-- Query: 18
-- Steps: 1, 2, 4, 5, 6, 9, 10, 11, 12
...
WHERE [PATIENT_LOCAL_ID] = N'PSN1000009000GA01'
;
...
SELECT
    ...
    [PATIENT_ZIP]
FROM [RDB_MODERN].[dbo].[D_PATIENT]
WHERE [PATIENT_LOCAL_ID] = N'PSN1000009020GA01'
;
...
WHERE [LOCAL_ID] = N'CAS1000009017GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'CAS1000009024GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'NOT1000009028GA01'
;
...
SELECT
    ...
    [STATUS_TIME]
FROM [RDB_MODERN].[dbo].[EVENT_METRIC]
WHERE [LOCAL_ID] = N'OBS1000009008GA01'
;
...
-- dbo.F_CONTACT_RECORD_CASE | operations: insert
-- Query: 30
-- Step: 7
-- Logical comparison marked this identity as not comparison-safe.
SELECT
...
WHERE [D_CONTACT_RECORD_KEY] = (SELECT D_CONTACT_RECORD_KEY FROM [RDB_MODERN].[dbo].[D_CONTACT_RECORD] WHERE [LOCAL_ID] = N'CON1000009027GA01')
;

-- dbo.F_INTERVIEW_CASE | operations: insert
-- Query: 31
-- Step: 6
-- Logical comparison marked this identity as not comparison-safe.
SELECT
...
JOIN [RDB_MODERN].[dbo].[CONDITION] ON CONDITION.CONDITION_KEY = F_STD_PAGE_CASE.CONDITION_KEY
WHERE INVESTIGATION_KEY IN (SELECT [INVESTIGATION_KEY] FROM [RDB_MODERN].[dbo].[INVESTIGATION] WHERE INV_LOCAL_ID IN (N'CAS1000009017GA01', N'CAS1000009024GA01')) ORDER BY [CLOSED_BY_KEY]
;
...
WHERE [INVESTIGATION_LOCAL_ID] = N'CAS1000009017GA01'
  AND [NOTIFICATION_LOCAL_ID] = N'NOT1000009028GA01'
  AND [PATIENT_LOCAL_ID] = N'PSN1000009000GA01'
;
...
WHERE [INV_LOCAL_ID] = N'CAS1000009017GA01'
;
...
SELECT
    ...
    [TRANSMISSION_MODE]
FROM [RDB_MODERN].[dbo].[INVESTIGATION]
WHERE [INV_LOCAL_ID] = N'CAS1000009024GA01'
;
...
WHERE [PAGE_CASE_UID] = 1000009017.0
;
...
-- dbo.L_INV_HIV | operations: insert
-- Query: 41
-- Step: 6
-- Logical comparison marked this identity as not comparison-safe.
SELECT
...
-- dbo.L_INV_MEDICAL_HISTORY | operations: insert
-- Query: 42
-- Step: 6
-- Logical comparison marked this identity as not comparison-safe.
SELECT
...
-- dbo.L_INV_RISK_FACTOR | operations: insert
-- Query: 44
-- Step: 6
-- Logical comparison marked this identity as not comparison-safe.
SELECT
...
-- dbo.L_INV_SOCIAL_HISTORY | operations: insert
-- Query: 45
-- Step: 6
-- Logical comparison marked this identity as not comparison-safe.
SELECT
...
WHERE [PERSON_LOCAL_ID] = N'PSN1000009000GA01'
;
...
WHERE [LAB_RPT_LOCAL_ID] = N'OBS1000009008GA01'
;
...
WHERE [LAB_TEST_UID] IN (1000009008, 1000009011)
ORDER BY [LAB_TEST_UID]
;

-- dbo.NOTIFICATION | operations: insert, update
-- Query: 53
-- Steps: 11, 12
SELECT
...
WHERE [NOTIFICATION_LOCAL_ID] = N'NOT1000009028GA01'
;

-- dbo.NOTIFICATION_EVENT | operations: delete, insert
-- Query: 54
-- Steps: 11, 12
-- Logical comparison marked this identity as not comparison-safe.
SELECT
...
WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01')
;

-- dbo.STD_HIV_DATAMART | operations: insert, update
-- Query: 55
-- Steps: 2, 4, 5, 6, 9, 10, 11
SELECT
    [ADI_900_STATUS],
    [ADI_900_STATUS_CD],
    [ADM_REFERRAL_BASIS_OOJ],
...
WHERE [TREATMENT_LOCAL_ID] = N'TRT1000009018GA01'
;
...
WHERE TREATMENT_KEY = (SELECT TREATMENT_KEY FROM [RDB_MODERN].[dbo].[TREATMENT] WHERE [TREATMENT_LOCAL_ID] = N'TRT1000009018GA01')
...
SELECT
    ...
    [CONFIRMATION_METHOD],
    [TREATMENT_DATE],
    [CA_PATIENT_INTV_STAT],
    [FL_FUP_NOT_PLAN_CD],
    [REFERRAL_BASIS],
    [TRANSMISSION_MODE]
FROM [RDB_MODERN].[dbo].[DM_INV_STD]
WHERE [INV_LOCAL_ID] = N'CAS1000009017GA01'
;
