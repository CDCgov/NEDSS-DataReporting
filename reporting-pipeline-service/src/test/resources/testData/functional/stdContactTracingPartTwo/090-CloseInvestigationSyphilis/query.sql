...
WHERE [D_INVESTIGATION_REPEAT_KEY] = (SELECT D_INVESTIGATION_REPEAT_KEY FROM [RDB_MODERN].[dbo].[F_STD_PAGE_CASE] WHERE [INVESTIGATION_KEY] = (SELECT INVESTIGATION_KEY FROM [RDB_MODERN].[dbo].INVESTIGATION WHERE INV_LOCAL_ID = N'CAS1000009017GA01')) AND [BLOCK_NM] = N'BLOCK_2'
;
