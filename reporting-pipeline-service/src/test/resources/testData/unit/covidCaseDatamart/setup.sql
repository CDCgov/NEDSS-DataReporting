...
-- SHARED CLEANUPS
-----------------------------------------------------------------------
EXEC('USE [NBS_ODSE]; EXEC sp_MSforeachtable ''ALTER TABLE ? NOCHECK CONSTRAINT ALL;''');
EXEC('USE [RDB_MODERN]; EXEC sp_MSforeachtable ''ALTER TABLE ? NOCHECK CONSTRAINT ALL;''');
-- Cleanup ODSE
...
DELETE FROM [dbo].[PublicHealthCaseFact];
DELETE FROM [dbo].[Act];
...
DELETE FROM RDB_MODERN.DBO.NRT_PROVIDER;
DELETE FROM RDB_MODERN.DBO.D_PROVIDER;
DELETE FROM RDB_MODERN.DBO.NRT_ORGANIZATION;
DELETE FROM RDB_MODERN.DBO.D_ORGANIZATION;
DELETE FROM RDB_MODERN.DBO.EVENT_METRIC;
DELETE FROM RDB_MODERN.DBO.EVENT_METRIC_INC;

EXEC('USE [NBS_ODSE]; EXEC sp_MSforeachtable ''ALTER TABLE ? CHECK CONSTRAINT ALL;''');
EXEC('USE [RDB_MODERN]; EXEC sp_MSforeachtable ''ALTER TABLE ? CHECK CONSTRAINT ALL;''');
