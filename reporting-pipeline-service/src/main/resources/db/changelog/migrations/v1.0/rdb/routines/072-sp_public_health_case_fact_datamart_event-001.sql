...
BEGIN
    ...
    BEGIN TRY
        ...
        IF OBJECT_ID('tempdb..#TEMP_INV_FORM_CODE_DATA') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_UPDATE_NEW_PATIENT') IS NOT NULL
        ...
        */
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCPATIENTINFO') IS NOT NULL
        ...
        */
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCINFO_INIT') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCINFO_LEGACY_HOSP') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCINFO1') IS NOT NULL
...
*/
		...
		*/
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCINFO2') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCINFO3') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCINFO') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCSUBJECT') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_SUMMARYUID') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_CASECNT') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_SAS_LATEST_NOT') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_SAS_NOTIFICATION') IS NOT NULL
    ...
    */
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCFACT') IS NOT NULL
    ...
    FROM #TEMP_SAS_NOTIFICATION
        ...
        IF OBJECT_ID('tempdb..#TEMP_SUB_CASE_NOTIF') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_CONFIRM') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_CONFIRM_CONCAT') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_SUB_CASE_CONF_NOTIF') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCREPORTER') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_CASE_ENTITY') IS NOT NULL
        ...
        IF OBJECT_ID('tempdb..#TEMP_PHCPERSONRACE') IS NOT NULL
