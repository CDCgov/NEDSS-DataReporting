IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_patient_dim_columns_update_to_datamart]')
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_patient_dim_columns_update_to_datamart]
END
GO 
CREATE PROCEDURE [dbo].[sp_patient_dim_columns_update_to_datamart] @batch_id bigint, @debug bit = 'false'
AS
BEGIN
 /*
     * [Description]
     ...
     * 1. CASE_LAB_DATAMART
     * 2. BMIRD_STREP_PNEUMO_DATAMART
     * 3. HEP100
     * 4. MORBIDITY_REPORT_DATAMART
     * 5. VAR_DATAMART
     * 6. TB_DATAMART
     * 7. TB_HIV_DATAMART
*/
    ...
    BEGIN
        ...
        RACE_CALCULATED = tmp.PATIENT_RACE_CALCULATED,
        RACE_CALCULATED_DETAILS = tmp.PATIENT_RACE_CALC_DETAILS
        from
    ...
    BEGIN
        with src as (
        select
            map.INVESTIGATION_KEY AS INVESTIGATION_KEY,
            map.PATIENT_PHONE_HOME AS PATIENT_PHONE_NUMBER_HOME,
            map.PATIENT_PHONE_EXT_HOME AS PATIENT_PHONE_EXT_HOME,
            map.PATIENT_PHONE_WORK AS PATIENT_PHONE_NUMBER_WORK,
            map.PATIENT_PHONE_EXT_WORK AS PATIENT_PHONE_EXT_WORK,
            map.PATIENT_GENERAL_COMMENTS AS PATIENT_GENERAL_COMMENTS,
            map.PATIENT_LAST_NAME AS PATIENT_LAST_NAME,
            map.PATIENT_FIRST_NAME AS PATIENT_FIRST_NAME,
            map.PATIENT_MIDDLE_NAME AS PATIENT_MIDDLE_NAME,
            map.PATIENT_NAME_SUFFIX AS PATIENT_NAME_SUFFIX,
            map.PATIENT_DOB AS PATIENT_DOB,
            map.PATIENT_AGE_REPORTED AS AGE_REPORTED,
            map.PATIENT_AGE_REPORTED_UNIT AS AGE_REPORTED_UNIT,
            map.PATIENT_BIRTH_SEX AS PATIENT_BIRTH_SEX,
            map.PATIENT_CURRENT_SEX AS PATIENT_CURRENT_SEX,
            map.PATIENT_DECEASED_INDICATOR AS PATIENT_DECEASED_INDICATOR,
            map.PATIENT_DECEASED_DATE AS PATIENT_DECEASED_DATE,
            map.PATIENT_MARITAL_STATUS AS PATIENT_MARITAL_STATUS,
            map.PATIENT_SSN AS PATIENT_SSN,
            map.PATIENT_ETHNICITY AS PATIENT_ETHNICITY,
            map.PATIENT_STREET_ADDRESS_1 AS PATIENT_STREET_ADDRESS_1,
            map.PATIENT_STREET_ADDRESS_2 AS PATIENT_STREET_ADDRESS_2,
            map.PATIENT_CITY AS PATIENT_CITY,
            map.PATIENT_STATE AS PATIENT_STATE,
            map.PATIENT_ZIP AS PATIENT_ZIP,
            map.PATIENT_COUNTY AS PATIENT_COUNTY,
            map.PATIENT_COUNTRY AS PATIENT_COUNTRY,
            map.PATIENT_WITHIN_CITY_LIMITS AS PATIENT_WITHIN_CITY_LIMITS,
            map.PATIENT_RACE_CALC_DETAILS AS RACE_CALC_DETAILS,
            map.PATIENT_RACE_CALCULATED AS RACE_CALCULATED,
            map.PATIENT_RACE_NAT_HI_1 AS RACE_NAT_HI_1,
            map.PATIENT_RACE_NAT_HI_2 AS RACE_NAT_HI_2,
            map.PATIENT_RACE_NAT_HI_3 AS RACE_NAT_HI_3,
            map.PATIENT_RACE_ASIAN_1 AS RACE_ASIAN_1,
            map.PATIENT_RACE_ASIAN_2 AS RACE_ASIAN_2,
            map.PATIENT_RACE_ASIAN_3 AS RACE_ASIAN_3,
            map.PATIENT_RACE_ASIAN_ALL AS RACE_ASIAN_ALL,
            map.PATIENT_RACE_ASIAN_GT3_IND AS RACE_ASIAN_GT3_IND,
            map.PATIENT_RACE_NAT_HI_GT3_IND AS RACE_NAT_HI_GT3_IND,
            map.PATIENT_RACE_NAT_HI_ALL AS RACE_NAT_HI_ALL,
            map.PATIENT_BIRTH_COUNTRY AS PATIENT_BIRTH_COUNTRY,
            CASE
                WHEN map.PATIENT_DOB IS NOT NULL AND dm.DATE_REPORTED IS NOT NULL
                THEN DATEDIFF(day, map.PATIENT_DOB, dm.DATE_REPORTED) / 365.25
                ELSE NULL
            END AS AGE_IN_DEC
        from
        ...
        update tb
        set
            PATIENT_PHONE_NUMBER_HOME   = map.PATIENT_PHONE_HOME
          ,PATIENT_PHONE_EXT_HOME      = map.PATIENT_PHONE_EXT_HOME
          ,PATIENT_PHONE_NUMBER_WORK   = map.PATIENT_PHONE_WORK
          ,PATIENT_PHONE_EXT_WORK      = map.PATIENT_PHONE_EXT_WORK
          ,PATIENT_LOCAL_ID            = map.PATIENT_LOCAL_ID
          ,PATIENT_GENERAL_COMMENTS    = map.PATIENT_GENERAL_COMMENTS
          ,PATIENT_LAST_NAME           = map.PATIENT_LAST_NAME
          ,PATIENT_FIRST_NAME          = map.PATIENT_FIRST_NAME
          ,PATIENT_MIDDLE_NAME         = map.PATIENT_MIDDLE_NAME
          ,PATIENT_NAME_SUFFIX         = map.PATIENT_NAME_SUFFIX
          ,PATIENT_DOB                 = map.PATIENT_DOB
          ,AGE_REPORTED                = map.PATIENT_AGE_REPORTED
          ,AGE_REPORTED_UNIT           = map.PATIENT_AGE_REPORTED_UNIT
          ,PATIENT_BIRTH_SEX           = map.PATIENT_BIRTH_SEX
          ,PATIENT_CURRENT_SEX         = map.PATIENT_CURRENT_SEX
          ,PATIENT_DECEASED_INDICATOR  = map.PATIENT_DECEASED_INDICATOR
          ,PATIENT_DECEASED_DATE       = map.PATIENT_DECEASED_DATE
          ,PATIENT_MARITAL_STATUS      = map.PATIENT_MARITAL_STATUS
          ,PATIENT_SSN                 = map.PATIENT_SSN
          ,PATIENT_ETHNICITY           = map.PATIENT_ETHNICITY
          ,PATIENT_STREET_ADDRESS_1    = map.PATIENT_STREET_ADDRESS_1
          ,PATIENT_STREET_ADDRESS_2    = map.PATIENT_STREET_ADDRESS_2
          ,PATIENT_CITY                = map.PATIENT_CITY
          ,PATIENT_STATE               = map.PATIENT_STATE
          ,PATIENT_ZIP                 = map.PATIENT_ZIP
          ,PATIENT_COUNTY              = map.PATIENT_COUNTY
          ,PATIENT_COUNTRY             = map.PATIENT_COUNTRY
          ,PATIENT_WITHIN_CITY_LIMITS  = map.PATIENT_WITHIN_CITY_LIMITS
          ,RACE_CALC_DETAILS           = map.PATIENT_RACE_CALC_DETAILS
          ,RACE_CALCULATED             = map.PATIENT_RACE_CALCULATED
          ,RACE_NAT_HI_1               = map.PATIENT_RACE_NAT_HI_1
          ,RACE_NAT_HI_2               = map.PATIENT_RACE_NAT_HI_2
          ,RACE_NAT_HI_3               = map.PATIENT_RACE_NAT_HI_3
          ,RACE_ASIAN_1                = map.PATIENT_RACE_ASIAN_1
          ,RACE_ASIAN_2                = map.PATIENT_RACE_ASIAN_2
          ,RACE_ASIAN_3                = map.PATIENT_RACE_ASIAN_3
          ,RACE_ASIAN_ALL              = map.PATIENT_RACE_ASIAN_ALL
          ,RACE_ASIAN_GT3_IND          = map.PATIENT_RACE_ASIAN_GT3_IND
          ,RACE_NAT_HI_GT3_IND         = map.PATIENT_RACE_NAT_HI_GT3_IND
          ,RACE_NAT_HI_ALL             = map.PATIENT_RACE_NAT_HI_ALL
          ,CALC_REPORTED_AGE           = tbd.CALC_REPORTED_AGE
          ,CALC_5_YEAR_AGE_GROUP       = tbd.CALC_5_YEAR_AGE_GROUP
          ,CALC_10_YEAR_AGE_GROUP      = tbd.CALC_10_YEAR_AGE_GROUP
          ,PATIENT_BIRTH_COUNTRY       = map.PATIENT_BIRTH_COUNTRY
        ...
        inner join dbo.TB_DATAMART tbd
            on tbd.INVESTIGATION_KEY = tb.INVESTIGATION_KEY
        ;
