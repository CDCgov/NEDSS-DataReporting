...
BEGIN
    BEGIN TRY
        ...
        /* Start transaction for the truncate and insert operations */
        BEGIN TRANSACTION;

        EXEC @LockResult = sys.sp_getapplock
            @Resource = 'Mutex_sp_covid_contact_datamart_postprocessing_Lock',
            @LockMode = 'Exclusive',
        ...
        TRUNCATE TABLE dbo.COVID_CONTACT_DATAMART;
