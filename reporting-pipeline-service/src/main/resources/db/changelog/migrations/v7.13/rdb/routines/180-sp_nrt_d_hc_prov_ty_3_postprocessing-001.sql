IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_nrt_d_hc_prov_ty_3_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_nrt_d_hc_prov_ty_3_postprocessing]
END
GO 

CREATE PROCEDURE [dbo].[sp_nrt_d_hc_prov_ty_3_postprocessing] 
...
--------------------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#D_HC_PROV_TY_3_PHC_LIST', 'U') IS NOT NULL
...
--------------------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#S_D_HC_PROV_TY_3_TRANSLATED', 'U') IS NOT NULL
...
---------------------------------------------------------------------------------------------------------------------        
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#S_D_HC_PROV_TY_3', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#TEMP_D_HC_PROV_TY_3_DEL', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#L_D_HC_PROV_TY_3_GROUP', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#L_D_HC_PROV_TY_3', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#TEMP_D_HC_PROV_TY_3', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
            ...
            UPDATE F
                SET F.D_HC_PROV_TY_3_GROUP_KEY = D.D_HC_PROV_TY_3_GROUP_KEY
            ...
            INNER JOIN #D_HC_PROV_TY_3_PHC_LIST S
