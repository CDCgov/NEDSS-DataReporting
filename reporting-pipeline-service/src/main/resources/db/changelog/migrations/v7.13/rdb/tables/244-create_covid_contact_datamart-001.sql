...
--REMOVE TEMPORARY STOPGAP FOR GREENFIELD DATABASE LIQUIBASE BUILD FAILURE
IF EXISTS(SELECT 1 FROM sys.columns WHERE name = N'CONTACT_UID' AND object_id = Object_ID(N'COVID_CONTACT_DATAMART'))
    BEGIN
        ALTER TABLE COVID_CONTACT_DATAMART
        DROP COLUMN CONTACT_UID;
    END;