 ...
 */
        ...
        **/
        ...
        SELECT
            INVESTIGATION_KEY,
              LEFT(STRING_AGG(CAST(CONCAT_COL AS NVARCHAR(MAX)), ', ') WITHIN GROUP (ORDER BY CONCAT_COL), 2000) AS ANTIMIC_GT_8_AGENT_AND_RESULT
        ...
        */
        ...
        SELECT
            INVESTIGATION_KEY,
                LEFT(STRING_AGG(CAST(TYPES_OF_INFECTIONS_ AS NVARCHAR(MAX)), ',') WITHIN GROUP (ORDER BY TYPES_OF_INFECTIONS_ ASC), 500)
        ...
        */
        ...
        SELECT
            INVESTIGATION_KEY,
                LEFT(STRING_AGG(CAST(STERILE_SITE_ AS NVARCHAR(MAX)), ',') WITHIN GROUP (ORDER BY STERILE_SITE_ DESC), 500)
