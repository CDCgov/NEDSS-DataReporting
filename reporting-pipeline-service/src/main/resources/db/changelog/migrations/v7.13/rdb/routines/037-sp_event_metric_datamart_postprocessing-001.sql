IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_event_metric_datamart_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_event_metric_datamart_postprocessing]
END
GO 

CREATE PROCEDURE dbo.sp_event_metric_datamart_postprocessing @phc_uids nvarchar(max),
...
@PROC_STEP_NO = @PROC_STEP_NO + 1;
        ...
        IF
OBJECT_ID('tempdb..#TMP_EVENT_METRIC', 'U') IS NOT NULL
...
@PROC_STEP_NO = @PROC_STEP_NO + 1;
                ...
                IF
OBJECT_ID('tempdb..#TMP_NOTIFICATION', 'U') IS NOT NULL
...
@PROC_STEP_NO = @PROC_STEP_NO + 1;
                ...
                IF
OBJECT_ID('tempdb..#TMP_NOT_PROG', 'U') IS NOT NULL
...
@PROC_STEP_NO = @PROC_STEP_NO + 1;
                ...
                IF
OBJECT_ID('tempdb..#TMP_NOT_PROG_JURI', 'U') IS NOT NULL
...
@PROC_STEP_NO = @PROC_STEP_NO + 1;
                ...
                IF
OBJECT_ID('tempdb..#TMP_NOT_PROG_JURI_CVG', 'U') IS NOT NULL
...
@PROC_STEP_NO = @PROC_STEP_NO + 1;
                ...
                IF
OBJECT_ID('tempdb..#TMP_EVENT_OBS', 'U') IS NOT NULL
...
*/
        ...
        IF
OBJECT_ID('tempdb..#TMP_EVENT_METRIC_FINAL', 'U') IS NOT NULL
