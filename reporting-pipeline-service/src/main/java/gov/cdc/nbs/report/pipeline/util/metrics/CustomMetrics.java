...
public class CustomMetrics {
  ...
  public Counter counter(String name, String... tags) {
    return (Counter)
        meters.computeIfAbsent(name, k -> Counter.builder(name).tags(tags).register(registry));
  }

  public Timer timer(String name, String... tags) {
    return (Timer)
        meters.computeIfAbsent(name, k -> Timer.builder(name).tags(tags).register(registry));
  }
  ...
  public <T> void gauge(
    ...
    meters.computeIfAbsent(
        name, k -> Gauge.builder(name, obj, valueFunction).tags(tags).register(registry));
  }
