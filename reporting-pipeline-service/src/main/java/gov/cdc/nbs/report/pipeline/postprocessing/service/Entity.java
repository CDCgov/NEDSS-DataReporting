...
@Getter
enum Entity {
  CONDITION(1, "Condition_code", "condition_cd", "sp_nrt_srte_condition_code_postprocessing"),
  PAGE(2, "NBS_page", "nbs_page_uid", "sp_nrt_odse_nbs_page_postprocessing"),
  ORGANIZATION(3, "organization", "organization_uid", "sp_nrt_organization_postprocessing"),
  PROVIDER(4, "provider", "provider_uid", "sp_nrt_provider_postprocessing"),
  PATIENT(5, "patient", "patient_uid", "sp_nrt_patient_postprocessing"),
  AUTH_USER(6, "auth_user", "auth_user_uid", "sp_user_profile_postprocessing"),
  D_PLACE(7, "place", "place_uid", "sp_nrt_place_postprocessing"),
  INVESTIGATION(8, "investigation", Constants.PHC_UID, "sp_nrt_investigation_postprocessing"),
  NOTIFICATION(9, "notification", "notification_uid", "sp_nrt_notification_postprocessing"),
  INTERVIEW(10, "interview", "interview_uid", "sp_d_interview_postprocessing"),
  CASE_MANAGEMENT(
      11, "case_management", Constants.PHC_UID, "sp_nrt_case_management_postprocessing"),
  STATE_DEFINED_FIELD_METADATA(
      12, "state_defined_field_metadata", "ldf_uid", "sp_nrt_ldf_postprocessing"),
  LDF_DATA(13, "ldf_data", "ldf_uid", "sp_nrt_ldf_postprocessing"),
  OBSERVATION(14, "observation", "observation_uid", null),
  CONTACT(15, "contact", "contact_uid", "sp_d_contact_record_postprocessing"),
  TREATMENT(16, "treatment", "treatment_uid", "sp_nrt_treatment_postprocessing"),
  VACCINATION(17, "vaccination", "vaccination_uid", "sp_d_vaccination_postprocessing"),
  ...
  SUMMARY_REPORT_CASE(
      0, "Summary_Report_Case", Constants.PHC_UID, "sp_summary_report_case_postprocessing"),
  SR100_DATAMART(0, "SR100_Datamart", Constants.PHC_UID, "sp_sr100_datamart_postprocessing"),
  AGGREGATE_REPORT_DATAMART(
      0,
      "Aggregate_Report_Datamart",
      Constants.PHC_UID,
      "sp_aggregate_report_datamart_postprocessing"),
  F_STD_PAGE_CASE(0, "fact std page case", Constants.PHC_UID, "sp_f_std_page_case_postprocessing"),
  HEPATITIS_DATAMART(
      0, "Hepatitis_Datamart", Constants.PHC_UID, "sp_hepatitis_datamart_postprocessing"),
  ...
  CASE_LAB_DATAMART(
      0, "Case_Lab_Datamart", Constants.PHC_UID, "sp_case_lab_datamart_postprocessing"),
  BMIRD_CASE(0, "BMIRD_Case", Constants.PHC_UID, "sp_bmird_case_datamart_postprocessing"),
  HEPATITIS_CASE(
      0, "Hepatitis_Case", Constants.PHC_UID, "sp_hepatitis_case_datamart_postprocessing"),
  PERTUSSIS_CASE(
      0, "Pertussis_Case", Constants.PHC_UID, "sp_pertussis_case_datamart_postprocessing"),
  ...
  LDF_DIMENSIONAL_DATA(
      0, "ldf_dimensional_data", Constants.PHC_UID, "sp_nrt_ldf_dimensional_data_postprocessing"),
  ...
  COVID_CASE_DATAMART(
      0, "Covid_Case_Datamart", Constants.PHC_UID, "sp_covid_case_datamart_postprocessing"),
  COVID_CONTACT_DATAMART(
      0, "Covid_Contact_Datamart", Constants.PHC_UID, "sp_covid_contact_datamart_postprocessing"),
  ...
  COVID_LAB_DATAMART(
      0, "Covid_Lab_Datamart", Constants.PHC_UID, "sp_covid_lab_datamart_postprocessing"),
  COVID_LAB_CELR_DATAMART(
      0, "Covid_Lab_Celr_Datamart", Constants.PHC_UID, "sp_covid_lab_celr_datamart_postprocessing"),
