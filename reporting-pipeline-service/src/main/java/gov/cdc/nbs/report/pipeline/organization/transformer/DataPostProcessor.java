...
import gov.cdc.nbs.report.pipeline.organization.model.dto.orgdetails.*;
import gov.cdc.nbs.report.pipeline.organization.model.dto.place.PlaceAddress;
import gov.cdc.nbs.report.pipeline.organization.model.dto.place.PlaceEntity;
import gov.cdc.nbs.report.pipeline.organization.model.dto.place.PlaceReporting;
import java.util.*;
  ...
  public <T> void processOrgEntity(String entity, T org) {
    ...
    if (!ObjectUtils.isEmpty(entity)) {
      ...
      if (org.getClass() == OrganizationElasticSearch.class) {
        // ToDo: Entity Data for Organization Elastic search gets the max Entity Id and processes
        // them.
