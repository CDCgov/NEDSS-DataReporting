...
import gov.cdc.nbs.etldatapipeline.testing.patient.birth.PatientSexAndBirth.Sex;
...
public class PatientSexAndBirthManager {
  ...
  public PatientSexAndBirthManager(
  ...
  public void set(final long patient, final PatientSexAndBirth patientSexAndBirth) {
    ...
    this.client.sql(SET_SEX_AND_BIRTH_INFO)
        ...
        .param("transgenderInfoCode",
            patientSexAndBirth.transgenderInfo() != null ? patientSexAndBirth.transgenderInfo().code() : null)

        .param("additionalGender", patientSexAndBirth.additionalGender())
        .param("birthSex", patientSexAndBirth.birthSex() != null ? patientSexAndBirth.birthSex().code() : null)
        .param("multipleBirthCode",
            patientSexAndBirth.multipleBirth() != null ? patientSexAndBirth.multipleBirth().code() : null)
    ...
    if (patientSexAndBirth.birthCity() != null ||
      ...
      this.client.sql(ADD_BIRTH_LOCATOR)
          .param("patient", patient)
          .param("asOf", patientSexAndBirth.asOf())
