package gov.cdc.nbs.etldatapipeline.testing.patient.general;
...
public class PatientGeneralInfoManager {
  ...
  public void set(final long patient, final PatientGeneralInfo generalInfo) {
    client.sql(SET_GENERAL_INFO)
        .param("asOf", generalInfo.asOf())
        .param("patient", patient)
        .param("maritalStatusCode", generalInfo.maritalStatus() != null ? generalInfo.maritalStatus().code() : null)
        ...
        .param("occupationCode", generalInfo.occupation() != null ? generalInfo.occupation().code() : null)
        .param("educationLevelCode",
            generalInfo.highestLevelOfEducation() != null ? generalInfo.highestLevelOfEducation().code() : null)
        .param("primaryLanguageCode",
            generalInfo.primaryLanguage() != null ? generalInfo.primaryLanguage().code() : null)
        .param("speaksEnglishCode", generalInfo.speaksEnglish() != null ? generalInfo.speaksEnglish().code() : null)
