...
import gov.cdc.nbs.etldatapipeline.testing.patient.mortality.PatientMortality.Deceased;
...
public class PatientMortalityManager {
  ...
  public PatientMortalityManager(
  ...
  public void set(final long patient, final PatientMortality patientMortality) {
    ...
    client.sql(SET_MORTALITY)
        .param("asOf", patientMortality.asOf())
        .param("patient", patient)
        .param("deceasedIndicator", patientMortality.deceased() != null ? patientMortality.deceased().code() : null)
    ...
    if (Deceased.YES.equals(patientMortality.deceased()) &&
      ...
      this.client.sql(ADD_MORTALITY_LOCATOR)
          .param("patient", patient)
          .param("asOf", patientMortality.asOf())
