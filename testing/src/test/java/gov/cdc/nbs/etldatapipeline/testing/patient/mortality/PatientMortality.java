package gov.cdc.nbs.etldatapipeline.testing.patient.mortality;

import java.time.LocalDateTime;

/**
 * Contains the data necessary for setting patient Mortality information.
 * The appropriate codes will need to be supplied for Death State, Death County,
 * and Death Country. Most of the Mortality information is stored within the
 * Person table. However, if death location info is specified then an entry will
