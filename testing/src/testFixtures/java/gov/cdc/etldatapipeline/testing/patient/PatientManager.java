package gov.cdc.etldatapipeline.testing.patient;
...
import gov.cdc.etldatapipeline.testing.patient.address.PatientAddressManager;
import gov.cdc.etldatapipeline.testing.patient.birth.PatientSexAndBirth;
import gov.cdc.etldatapipeline.testing.patient.birth.PatientSexAndBirthManager;
import gov.cdc.etldatapipeline.testing.patient.comment.PatientComment;
import gov.cdc.etldatapipeline.testing.patient.comment.PatientCommentManager;
import gov.cdc.etldatapipeline.testing.patient.ethnicity.PatientEthnicity;
import gov.cdc.etldatapipeline.testing.patient.ethnicity.PatientEthnicityManager;
import gov.cdc.etldatapipeline.testing.patient.general.PatientGeneralInfo;
import gov.cdc.etldatapipeline.testing.patient.general.PatientGeneralInfoManager;
import gov.cdc.etldatapipeline.testing.patient.identification.PatientIdentification;
import gov.cdc.etldatapipeline.testing.patient.identification.PatientIdentificationManager;
import gov.cdc.etldatapipeline.testing.patient.mortality.PatientMortality;
import gov.cdc.etldatapipeline.testing.patient.mortality.PatientMortalityManager;
import gov.cdc.etldatapipeline.testing.patient.name.PatientName;
import gov.cdc.etldatapipeline.testing.patient.name.PatientNameManager;
import gov.cdc.etldatapipeline.testing.patient.phone.PatientPhoneAndEmail;
import gov.cdc.etldatapipeline.testing.patient.phone.PatientPhoneAndEmailManager;
import gov.cdc.etldatapipeline.testing.patient.race.PatientRace;
import gov.cdc.etldatapipeline.testing.patient.race.PatientRaceManager;
...
public class PatientManager {
  ...
  public PatientManager(final JdbcClient client) {
    this.client = client;
