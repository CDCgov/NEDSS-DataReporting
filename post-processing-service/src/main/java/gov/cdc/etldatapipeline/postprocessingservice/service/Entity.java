...
@Getter
enum Entity {
    PAGE(1, "NBS_page", "nbs_page_uid", "sp_nrt_odse_nbs_page_postprocessing"),
    ORGANIZATION(2, "organization", "organization_uid", "sp_nrt_organization_postprocessing"),
    PROVIDER(3, "provider", "provider_uid", "sp_nrt_provider_postprocessing"),
    PATIENT(4, "patient", "patient_uid", "sp_nrt_patient_postprocessing"),
    AUTH_USER(5, "auth_user", "auth_user_uid", "sp_user_profile_postprocessing"),
    D_PLACE(6, "place", "place_uid", "sp_nrt_place_postprocessing"),
    INVESTIGATION(7, "investigation", Constants.PHC_UID, "sp_nrt_investigation_postprocessing"),
    NOTIFICATION(8, "notification", "notification_uid", "sp_nrt_notification_postprocessing"),
    TREATMENT(9, "treatment", "treatment_uid", "sp_nrt_treatment_postprocessing"),
    ...
    VACCINATION(16, "vaccination", "vaccination_uid", "sp_d_vaccination_postprocessing"),
