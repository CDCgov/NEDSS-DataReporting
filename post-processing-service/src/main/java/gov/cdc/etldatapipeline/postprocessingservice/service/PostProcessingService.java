...
public class PostProcessingService {
    ...
    private void processByInvFormCode(List<DatamartData> dmData) {
        ...
        processTopic(investigationTopic, D_DISEASE_SITE, pamUids, investigationRepository::executeStoredProcForDDiseaseSite);
        
        if(dTbHivEnable) {
            //TB
            processTopic(investigationTopic, D_TB_HIV, pamUids, investigationRepository::executeStoredProcForDTbHiv);
            processTopic(investigationTopic, D_GT_12_REAS, pamUids, investigationRepository::executeStoredProcForDGt12Reas);
            processTopic(investigationTopic, D_MOVE_CNTRY, pamUids, investigationRepository::executeStoredProcForDMoveCntry);
            processTopic(investigationTopic, D_MOVE_CNTY, pamUids, investigationRepository::executeStoredProcForDMoveCnty);
            processTopic(investigationTopic, D_MOVE_STATE, pamUids, investigationRepository::executeStoredProcForDMoveState);
            processTopic(investigationTopic, D_MOVED_WHERE, pamUids, investigationRepository::executeStoredProcForDMovedWhere);
            processTopic(investigationTopic, D_HC_PROV_TY_3, pamUids, investigationRepository::executeStoredProcForDHcProvTy3);
            processTopic(investigationTopic, D_OUT_OF_CNTRY, pamUids, investigationRepository::executeStoredProcForDOutOfCntry);
            processTopic(investigationTopic, D_SMR_EXAM_TY, pamUids, investigationRepository::executeStoredProcForDSmrExamTy);
            processTopic(investigationTopic, F_TB_PAM, pamUids, investigationRepository::executeStoredProcForFTbPam);
            processTopic(investigationTopic, TB_PAM_LDF, pamUids, investigationRepository::executeStoredProcForTbPamLdf);
            ...
            processTopic(investigationTopic, D_PCR_SOURCE, pamUids, investigationRepository::executeStoredProcForDPcrSource);
            processTopic(investigationTopic, F_VAR_PAM, pamUids, investigationRepository::executeStoredProcForFVarPam);
            processTopic(investigationTopic, VAR_PAM_LDF, pamUids, investigationRepository::executeStoredProcForVarPamLdf);
        }   
