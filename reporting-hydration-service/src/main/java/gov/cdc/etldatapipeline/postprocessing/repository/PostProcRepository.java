...
public interface PostProcRepository extends JpaRepository<DatamartData, Long> {
  ...
  List<DatamartData> executeStoredProcForOrganizationIds(
  ...
  List<DatamartData> executeStoredProcForMorbReport(
  ...
  List<DatamartData> executeStoredProcForFInterviewCase(
      @Param("interviewUids") String interviewUids);
  ...
  List<DatamartData> executeStoredProcForUserProfile(
      @Param("userProfileUids") String userProfileUids);
  ...
  List<DatamartData> executeStoredProcForFContactRecordCase(
      @Param("contactUids") String contactUids);
  ...
  List<DatamartData> executeStoredProcForDVaccination(
      @Param("vaccinationUids") String vaccinationUids);
  ...
  List<DatamartData> executeStoredProcForFVaccination(
      @Param("vaccinationUids") String vaccinationUids);
