...
import gov.cdc.etldatapipeline.testing.UnitTest;
...
import gov.cdc.etldatapipeline.testing.patient.address.PatientAddress;
import gov.cdc.etldatapipeline.testing.patient.birth.PatientSexAndBirth;
import gov.cdc.etldatapipeline.testing.patient.birth.PatientSexAndBirth.MultipleBirth;
import gov.cdc.etldatapipeline.testing.patient.birth.PatientSexAndBirth.Sex;
import gov.cdc.etldatapipeline.testing.patient.ethnicity.PatientEthnicity;
import gov.cdc.etldatapipeline.testing.patient.ethnicity.PatientEthnicity.Ethnicity;
import gov.cdc.etldatapipeline.testing.patient.general.PatientGeneralInfo;
import gov.cdc.etldatapipeline.testing.patient.general.PatientGeneralInfo.Education;
import gov.cdc.etldatapipeline.testing.patient.general.PatientGeneralInfo.Language;
import gov.cdc.etldatapipeline.testing.patient.general.PatientGeneralInfo.MaritalStatus;
import gov.cdc.etldatapipeline.testing.patient.general.PatientGeneralInfo.Occupation;
import gov.cdc.etldatapipeline.testing.patient.general.PatientGeneralInfo.SpeaksEnglish;
import gov.cdc.etldatapipeline.testing.patient.identification.PatientIdentification;
import gov.cdc.etldatapipeline.testing.patient.name.PatientName;
import gov.cdc.etldatapipeline.testing.patient.name.PatientName.Degree;
import gov.cdc.etldatapipeline.testing.patient.name.PatientName.Prefix;
import gov.cdc.etldatapipeline.testing.patient.name.PatientName.Suffix;
import gov.cdc.etldatapipeline.testing.patient.phone.PatientPhoneAndEmail;
import gov.cdc.etldatapipeline.testing.patient.race.PatientRace;
...
class PatientEventTest extends UnitTest {
  ...
  void validatePatientEvent() throws JsonProcessingException {
    ...
    // TODO: Stored procedure does not return prefix -- intentional??
    // assertThat(nameValue.getNmPrefix()).isEqualTo(patientName.prefix().code());
    // assertThat(nameValue.getNamePrefix()).isEqualTo("MR");
    ...
    // TODO does not return comments, should it?
    // assertThat(phone.getPhoneComments()).isEqualTo(patientPhone.comments());
