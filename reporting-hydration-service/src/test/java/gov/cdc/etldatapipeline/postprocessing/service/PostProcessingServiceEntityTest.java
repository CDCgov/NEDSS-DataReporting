...
import static gov.cdc.etldatapipeline.postprocessing.service.PostProcessingService.LAB_REPORT;
import static gov.cdc.etldatapipeline.postprocessing.service.PostProcessingService.MORB_REPORT;
...
class PostProcessingServiceEntityTest {
  ...
  @InjectMocks @Spy private PostProcessingService postProcessingServiceMock;
  ...
  void testPostProcessOrganizationMessage() {
    ...
    verify(postProcRepositoryMock)
        .executeStoredProcForOrganizationIds(expectedOrganizationIdsIdsString);
  ...
  void testPostProcessInvestigationMessage() {
    ...
    verify(investigationRepositoryMock)
        .executeStoredProcForPublicHealthCaseIds(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForFPageCase(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForCaseCount(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock, never())
        .executeStoredProcForPageBuilder(anyString(), anyString());
    verify(investigationRepositoryMock, never())
        .executeStoredProcForSummaryReportCase(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock, never())
        .executeStoredProcForSR100Datamart(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock, never())
        .executeStoredProcForAggregateReport(expectedPublicHealthCaseIdsString);
  ...
  void testPostProcessInvestigationTBMessage() {
    ...
    when(investigationRepositoryMock.executeStoredProcForPublicHealthCaseIds("12"))
    ...
    verify(investigationRepositoryMock)
        .executeStoredProcForDTbPam(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDTbHiv(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDDiseaseSite(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDAddlRisk(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDGt12Reas(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDMoveCntry(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDMoveCnty(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDMoveState(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDMovedWhere(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDHcProvTy3(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDOutOfCntry(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDSmrExamTy(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForFTbPam(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForTbPamLdf(expectedPublicHealthCaseIdsString);
  ...
  void testPostProcessInvestigationVARMessage() {
    ...
    verify(investigationRepositoryMock)
        .executeStoredProcForDVarPam(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDRashLocGen(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForDPcrSource(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForVarPamLdf(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForFVarPam(expectedPublicHealthCaseIdsString);
  ...
  void testPostProcessNotificationMessage() {
    ...
    verify(investigationRepositoryMock)
        .executeStoredProcForNotificationIds(expectedNotificationIdsString);
  ...
  void testPostProcessSummaryNotificationMessage() {
    String topic = "dummy_notification";
    String key =
        "{\"payload\":{\"public_health_case_uid\":122,\"notification_uid\":123,\"act_type_cd\":\"SummaryNotification\"}}";
  ...
  void testPostProcessCaseManagementMessage() {
    ...
    String expectedPublicHealthCaseIdsString = "123";
    verify(investigationRepositoryMock)
        .executeStoredProcForCaseManagement(expectedPublicHealthCaseIdsString);
    verify(investigationRepositoryMock)
        .executeStoredProcForFStdPageCase(expectedPublicHealthCaseIdsString);
  ...
  void testPostProcessPageBuilder() {
    ...
    String msg1 =
        "{\"payload\":{\"public_health_case_uid\":123, \"rdb_table_name_list\":\"D_INV_CLINICAL,D_INV_ADMINISTRATIVE\"}}";
    String msg2 =
        "{\"payload\":{\"public_health_case_uid\":124, \"rdb_table_name_list\":\"D_INV_ADMINISTRATIVE\"}}";
    ...
    assertTrue(
        postProcessingServiceMock
            .pbCache
            .get(expectedRdbTableName)
            .contains(expectedPublicHealthCaseId));
    ...
    verify(investigationRepositoryMock)
        .executeStoredProcForPageBuilder("123,124", "D_INV_ADMINISTRATIVE");
  ...
  void testPostStateDefinedFieldMetaData() {
    ...
    assertTrue(
        logs.get(2)
            .getFormattedMessage()
            .contains(STATE_DEFINED_FIELD_METADATA.getStoredProcedure()));
    assertTrue(logs.get(3).getMessage().contains(PostProcessingService.SP_EXECUTION_COMPLETED));
  }
  ...
  void testPostProcessObservationMorb() {
    ...
    String msg =
        "{\"payload\":{\"observation_uid\":123, \"obs_domain_cd_st_1\": \"Order\",\"ctrl_cd_display_form\": \"MorbReport\"}}";
  ...
  void testPostProcessMultipleMessages() {
    ...
    postProcessingServiceMock.processNrtMessage(
        conditionCodeTopic, conditionCodeKey1, conditionCodeKey1);
    postProcessingServiceMock.processNrtMessage(
        conditionCodeTopic, conditionCodeKey2, conditionCodeKey2);
  ...
  void testPostProcessCacheIdsPriority() {
    ...
    String caseManagementKey =
        "{\"payload\":{\"public_health_case_uid\":128,\"case_management_uid\":1001}}";
    ...
    String observationMsg =
        "{\"payload\":{\"observation_uid\":130, \"obs_domain_cd_st_1\": \"Order\",\"ctrl_cd_display_form\": \"MorbReport\"}}";
    ...
    List<String> topicLogList =
        logs.stream()
            .map(ILoggingEvent::getFormattedMessage)
            .filter(m -> m.matches("Processing .+ for topic: .*"))
            .toList();
  ...
  void testPostProcessEventMetricNoIds() {
    ...
    verify(postProcRepositoryMock, never())
        .executeStoredProcForEventMetric(any(), any(), any(), any(), any());
  }
  ...
  void testPostProcessEventMetric() {
    ...
    verify(postProcRepositoryMock)
        .executeStoredProcForEventMetric("126,235", "130", "127", "123", "999");
  }
  ...
  void testProcessNrtMessageException() {
    ...
    assertThrows(
        RuntimeException.class,
        () -> postProcessingServiceMock.processNrtMessage(invalidTopic, invalidKey, invalidKey));
  }
  ...
  void testPostProcessNoUidException() {
    ...
    RuntimeException ex =
        assertThrows(
            RuntimeException.class,
            () -> postProcessingServiceMock.processNrtMessage(topic, orgKey, orgKey));
    assertEquals(NoSuchElementException.class, ex.getCause().getClass());
  }

  @ParameterizedTest
  @CsvSource({"{\"payload\":{\"unknown_uid\":123}}", "{\"payload\":{\"unknown_uid\":\"123\"}}"})
