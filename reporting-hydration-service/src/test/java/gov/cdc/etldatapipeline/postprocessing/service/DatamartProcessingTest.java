...
import gov.cdc.etldatapipeline.postprocessing.repository.model.dto.DatamartKey;
...
class DatamartProcessingTest {
  ...
  private static final String FILE_PREFIX = "rawDataFiles/postprocessing/";
  ...
  void testDatamartProcess(String conditionCd, Entity dmEntity, String dmJson) throws Exception {
    ...
    DatamartData datamartData =
        getDatamartData(conditionCd, dmEntity.getEntityName(), dmEntity.getStoredProcedure());
  ...
  void testExcludeCaseLabDatamart() throws Exception {
    String topic = "dummy_investigation";
    DatamartData datamartDataHep =
        getDatamartData(
            "10110", HEPATITIS_DATAMART.getEntityName(), HEPATITIS_DATAMART.getStoredProcedure());
    DatamartData datamartDataCaseLab =
        getDatamartData(
            null, CASE_LAB_DATAMART.getEntityName(), CASE_LAB_DATAMART.getStoredProcedure());
  ...
  private DatamartData getDatamartData(
      String conditionCd, String entityName, String storedProcedure) {
