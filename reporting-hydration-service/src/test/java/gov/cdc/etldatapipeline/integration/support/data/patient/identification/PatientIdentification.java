package gov.cdc.etldatapipeline.integration.support.data.patient.identification;

import java.time.LocalDateTime;

public record PatientIdentification(
    LocalDateTime asOf, Type type, AssigningAuthority assigningAuthority, String value) {
