IF
NOT EXISTS (SELECT 1 FROM sysobjects WHERE name = 'nrt_srte_Codeset' and xtype = 'U')
BEGIN
...
CREATE
NONCLUSTERED INDEX RDB_PERF_03312021_1 ON dbo.nrt_srte_Codeset (  code_set_group_id ASC  )
