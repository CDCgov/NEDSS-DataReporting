...
(
    ...
    investigator_assigned_datetime    datetime                                        NULL,
    ca_supervisor_of_phc_uid          bigint                                          NULL,
    closure_investgr_of_phc_uid       bigint                                          NULL,
    dispo_fld_fupinvestgr_of_phc_uid  bigint                                          NULL,
    fld_fup_investgr_of_phc_uid       bigint                                          NULL,
    fld_fup_prov_of_phc_uid           bigint                                          NULL,
    fld_fup_supervisor_of_phc_uid     bigint                                          NULL,
    init_fld_fup_investgr_of_phc_uid  bigint                                          NULL,
    init_fup_investgr_of_phc_uid      bigint                                          NULL,
    init_interviewer_of_phc_uid       bigint                                          NULL,
    interviewer_of_phc_uid            bigint                                          NULL,
    surv_investgr_of_phc_uid          bigint                                          NULL,
    fld_fup_facility_of_phc_uid       bigint                                          NULL,
    org_as_hospital_of_delivery_uid   bigint                                          NULL,
    per_as_provider_of_delivery_uid   bigint                                          NULL,
    per_as_provider_of_obgyn_uid      bigint                                          NULL,
