...
---------------------------------------------------------------------------------------------------------------------
        ...
        -- ensure entry D_MOVE_CNTRY_GROUP_KEY = 1 exists
        INSERT INTO  DBO.D_MOVE_CNTRY_GROUP (D_MOVE_CNTRY_GROUP_KEY)
        SELECT 1
        WHERE NOT EXISTS (
            SELECT 1 FROM  DBO.D_MOVE_CNTRY_GROUP
            WHERE D_MOVE_CNTRY_GROUP_KEY = 1
        );
