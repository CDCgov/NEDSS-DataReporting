...
--------------------------------------------------------------------------------------------------------
        ...
        FROM dbo.nrt_condition_key k
          INNER JOIN #CONDITION_INIT d
            ON K.CONDITION_KEY = d.CONDITION_KEY;
        ...
        SET
            @PROC_STEP_NO = @PROC_STEP_NO + 1;
        SET
            @PROC_STEP_NAME = 'UPDATE dbo.CONDITION';

        UPDATE tgt
            SET
                tgt.condition_cd = src.condition_cd,
                tgt.condition_desc = src.condition_desc,
                tgt.condition_short_nm = src.condition_short_nm,
                tgt.condition_cd_eff_dt = src.condition_cd_eff_dt,
                tgt.condition_cd_end_dt = src.condition_cd_end_dt,
                tgt.nnd_ind = src.nnd_ind,
                tgt.condition_key = src.condition_key,
                tgt.disease_grp_cd = src.disease_grp_cd,
                tgt.disease_grp_desc = src.disease_grp_desc,
                tgt.program_area_cd = src.program_area_cd,
                tgt.program_area_desc = src.program_area_desc,
                tgt.condition_cd_sys_cd_nm = src.condition_cd_sys_cd_nm,
                tgt.assigning_authority_cd = src.assigning_authority_cd,
                tgt.assigning_authority_desc = src.assigning_authority_desc,
                tgt.condition_cd_sys_cd = src.condition_cd_sys_cd
        FROM dbo.CONDITION tgt
            INNER JOIN #CONDITION_INIT src
...
--------------------------------------------------------------------------------------------------------
        ...
        SET
            @PROC_STEP_NO = @PROC_STEP_NO + 1;
        SET
            @PROC_STEP_NAME = 'INSERT into dbo.nrt_condition_key';
        ...
        SET
            @PROC_STEP_NO = @PROC_STEP_NO + 1;
        SET
            @PROC_STEP_NAME = 'INSERT INTO dbo.CONDITION';
        ...
        SELECT
            src.condition_cd,
            src.condition_desc, 
            src.condition_short_nm, 
            src.condition_cd_eff_dt, 
            src.condition_cd_end_dt, 
            src.nnd_ind, 
            k.condition_key,
            src.disease_grp_cd, 
            src.disease_grp_desc,
            src.program_area_cd, 
            src.program_area_desc,
            src.condition_cd_sys_cd_nm, 
            src.assigning_authority_cd, 
            src.assigning_authority_desc,
            src.condition_cd_sys_cd
