CREATE OR ALTER PROCEDURE dbo.sp_nrt_d_move_state_postprocessing 
...
BEGIN
    BEGIN TRY
        /* Logging */
            ...
            declare @package_name varchar(200) = 'RDB_MODERN.sp_nrt_move_state_postprocessing';
...
-------------------------------------------------------------------------------------------
        ...
        WHERE MOVE_STATE.TB_PAM_UID IN (SELECT value FROM #S_PHC_LIST) AND
...
---------------------------------------------------------------------------------------------------------------------
        ...
        WHERE DBO.D_MOVE_STATE_GROUP_KEY is null;
