IF NOT EXISTS (SELECT 1 FROM sysobjects WHERE name = 'nrt_srte_State_county_code_value' and xtype = 'U')
BEGIN
...
(
    ...
    CONSTRAINT PK_State_county_code_value_1 PRIMARY KEY (code)
);
END;
