    ...
    BEGIN TRY
        ...
        */
        ...
        from  dbo.State_Defined_Field_MetaData m
                  join dbo.State_Defined_Field_Data d with (nolock) on m.ldf_uid = d.ldf_uid  and d.business_object_nm = 'LAB'
            ...
            and d.ldf_uid in (SELECT value FROM STRING_SPLIT(@ldf_uid_list, ','))
                  ...
                  join dbo.Observation o with (nolock) on d.business_object_uid=o.observation_uid
