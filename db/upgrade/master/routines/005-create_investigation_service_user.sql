...
IF EXISTS (SELECT * FROM sys.database_principals WHERE name = @InvUserName)
    BEGIN
        PRINT 'Re-granting permissions for [' + @InvUserName + '] in NBS_ODSE...';
        ...
        END TRY
        BEGIN CATCH
            PRINT 'WARNING: Could not grant EXECUTE permission on [dbo].[sp_investigation_event] - procedure may not exist yet';
        END CATCH
        ...
        END TRY
        BEGIN CATCH
            PRINT 'WARNING: Could not grant EXECUTE permission on [dbo].[sp_contact_record_event] - procedure may not exist yet';
        END CATCH
        ...
        END TRY
        BEGIN CATCH
            PRINT 'WARNING: Could not grant EXECUTE permission on [dbo].[sp_interview_event] - procedure may not exist yet';
        END CATCH
        ...
        END TRY
        BEGIN CATCH
            PRINT 'WARNING: Could not grant EXECUTE permission on [dbo].[sp_notification_event] - procedure may not exist yet';
        END CATCH
        ...
        END TRY
        BEGIN CATCH
            PRINT 'WARNING: Could not grant EXECUTE permission on [dbo].[sp_treatment_event] - procedure may not exist yet';
        END CATCH
        ...
        END TRY
        BEGIN CATCH
            PRINT 'WARNING: Could not grant EXECUTE permission on [dbo].[sp_vaccination_event] - procedure may not exist yet';
        END CATCH
        ...
        END TRY
        BEGIN CATCH
            PRINT 'WARNING: Could not grant EXECUTE permission on [dbo].[sp_public_health_case_fact_datamart_event] - procedure may not exist yet';
        END CATCH
...
IF EXISTS (SELECT * FROM sys.database_principals WHERE name = @InvUserName)
    BEGIN
        PRINT 'Re-granting permissions for [' + @InvUserName + '] in NBS_SRTE...';
...
IF EXISTS (SELECT * FROM sys.database_principals WHERE name = @InvUserName)
    BEGIN
        PRINT 'Re-granting permissions for [' + @InvUserName + '] in rdb_modern...';
...
PRINT 'Investigation service user permissions completed.';