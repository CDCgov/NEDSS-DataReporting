...
Generated: 2026-06-03 08:24:39 UTC
...
- Empty (table exists, 0 rows): 20
- Missing (table not present in live RDB_MODERN): 1

- Total columns across in-scope tables: 4652
- Columns with ≥1 populated row: 3124
- Overall column coverage: 67.2%
...
| dbo.case_count | 20 | 15 | **15/15** |
| dbo.case_lab_datamart | 20 | 35 | **35/35** |
| dbo.condition | 269 | 15 | 14/15 |
| dbo.confirmation_method | 4 | 3 | **3/3** |
| dbo.confirmation_method_group | 22 | 3 | **3/3** |
| dbo.covid_case_datamart | 1 | 383 | 318/383 |
| dbo.covid_contact_datamart | 1 | 94 | 42/94 |
...
| dbo.event_metric | 27 | 28 | **28/28** |
| dbo.event_metric_inc | 27 | 28 | **28/28** |
...
| dbo.investigation | 22 | 71 | 61/71 |
| dbo.job_batch_rebuild_log | MISSING | - | - |
| dbo.job_flow_log | 29044 | 15 | 14/15 |
| dbo.l_inv_place_repeat | 1 | 2 | 1/2 |
| dbo.l_investigation_repeat | 12 | 2 | **2/2** |
| dbo.l_investigation_repeat_inc | 11 | 2 | **2/2** |
...
| dbo.lab_test | 30 | 66 | 55/66 |
| dbo.lab_test_result | 26 | 20 | 19/20 |
...
| dbo.lookup_table_n_rept | 9 | 2 | **2/2** |
