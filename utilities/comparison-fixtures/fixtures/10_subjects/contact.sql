...
INSERT INTO [dbo].[nrt_contact]
    ( [CONTACT_UID]                                                       -- 01
    , [ADD_TIME], [ADD_USER_ID]                                           -- 02-03
    , [CONTACT_ENTITY_EPI_LINK_ID]                                        -- 04
    , [CONTACT_ENTITY_PHC_UID], [CONTACT_ENTITY_UID]                      -- 05-06
    , [CTT_REFERRAL_BASIS], [CTT_STATUS]                                  -- 07-08
    , [CTT_DISPO_DT], [CTT_DISPOSITION]                                   -- 09-10
    , [CTT_EVAL_COMPLETED], [CTT_EVAL_DT], [CTT_EVAL_NOTES]               -- 11-13
    , [CTT_GROUP_LOT_ID], [CTT_HEALTH_STATUS]                             -- 14-15
    , [CTT_INV_ASSIGNED_DT], [CTT_JURISDICTION_NM]                        -- 16-17
    , [CTT_NAMED_ON_DT], [CTT_NOTES]                                      -- 18-19
    , [CTT_PRIORITY], [CTT_PROCESSING_DECISION]                           -- 20-21
    , [CTT_PROGRAM_AREA], [CTT_RELATIONSHIP]                              -- 22-23
    , [CTT_RISK_IND], [CTT_RISK_NOTES]                                    -- 24-25
    , [CTT_SHARED_IND], [CTT_SYMP_IND], [CTT_SYMP_NOTES]                  -- 26-28
    , [THIRD_PARTY_ENTITY_PHC_UID], [THIRD_PARTY_ENTITY_UID]              -- 29-30
    , [CTT_SYMP_ONSET_DT]                                                 -- 31
    , [CTT_TRT_COMPLETE_IND], [CTT_TRT_END_DT]                            -- 32-33
    , [CTT_TRT_INITIATED_IND]                                             -- 34
    , [CTT_TRT_NOT_COMPLETE_RSN], [CTT_TRT_NOT_START_RSN]                 -- 35-36
    , [CTT_TRT_NOTES], [CTT_TRT_START_DT]                                 -- 37-38
    , [LAST_CHG_TIME], [LAST_CHG_USER_ID]                                 -- 39-40
    , [LOCAL_ID], [NAMED_DURING_INTERVIEW_UID]                            -- 41-42
    , [PROGRAM_JURISDICTION_OID]                                          -- 43
    , [RECORD_STATUS_CD], [RECORD_STATUS_TIME]                            -- 44-45
    , [SUBJECT_ENTITY_EPI_LINK_ID]                                        -- 46
    , [SUBJECT_ENTITY_PHC_UID], [SUBJECT_ENTITY_UID]                      -- 47-48
    , [PROG_AREA_CD], [JURISDICTION_CD]                                   -- 49-50
    , [VERSION_CTRL_NBR]                                                  -- 51
    , [CONTACT_EXPOSURE_SITE_UID]                                         -- 52
    , [PROVIDER_CONTACT_INVESTIGATOR_UID], [DISPOSITIONED_BY_UID]         -- 53-54
    )
VALUES
    -- ---------------------------------------------------------------
    -- Row 1. Foundation Contact (UID 20000170) — sparse / null path.
    --   Local_id mirrors foundation 'CON20000170GA01'. EPI link IDs,
    --   subject/contact/PHC UIDs match foundation ct_contact row.
    --   All CTT_* description / date columns NULL — drives the
    --   null/blank-path on every D_CONTACT_RECORD column.
    --   contact_exposure_site_uid / provider_contact_investigator_uid /
    --   dispositioned_by_uid all NULL → all 5 F_CONTACT_RECORD_CASE
    --   surrogate keys for these soft refs resolve to sentinel 1.
    -- ---------------------------------------------------------------
    ( @foundation_act_contact_uid                                         -- 01
    , '2026-04-01T00:00:00', @superuser_id                                -- 02-03
    , NULL                                                                -- 04 contact_entity_epi_link_id
    , @foundation_investigation_uid, @foundation_patient_uid              -- 05-06 contact_entity_phc_uid + contact_entity_uid: foundation has these as NULL on phc, patient on uid; we keep the SP-side reference to populate F joins consistently
    , NULL, NULL                                                          -- 07-08 referral_basis, status
    , NULL, NULL                                                          -- 09-10 dispo_dt, disposition
    , NULL, NULL, NULL                                                    -- 11-13 eval_completed/dt/notes
    , NULL, NULL                                                          -- 14-15 group_lot_id, health_status
    , NULL, NULL                                                          -- 16-17 inv_assigned_dt, jurisdiction_nm
    , NULL, NULL                                                          -- 18-19 named_on_dt, notes
    , NULL, NULL                                                          -- 20-21 priority, processing_decision
    , NULL, NULL                                                          -- 22-23 program_area, relationship
    , NULL, NULL                                                          -- 24-25 risk_ind, risk_notes
    , NULL, NULL, NULL                                                    -- 26-28 shared_ind, symp_ind, symp_notes
    , NULL, NULL                                                          -- 29-30 third_party_entity_phc_uid, third_party_entity_uid
    , NULL                                                                -- 31 symp_onset_dt
    , NULL, NULL                                                          -- 32-33 trt_complete_ind, trt_end_dt
    , NULL                                                                -- 34 trt_initiated_ind
    , NULL, NULL                                                          -- 35-36 trt_not_complete_rsn, trt_not_start_rsn
    , NULL, NULL                                                          -- 37-38 trt_notes, trt_start_dt
    , '2026-04-01T00:00:00', @superuser_id                                -- 39-40 last_chg_time, last_chg_user_id
    , N'CON20000170GA01', NULL                                            -- 41-42 local_id, named_during_interview_uid
    , NULL                                                                -- 43 program_jurisdiction_oid
    , N'ACTIVE', '2026-04-01T00:00:00'                                    -- 44-45 record_status_cd/time
    , NULL                                                                -- 46 subject_entity_epi_link_id
    , @foundation_investigation_uid, @foundation_patient_uid              -- 47-48 subject_entity_phc_uid, subject_entity_uid
    , NULL, NULL                                                          -- 49-50 prog_area_cd, jurisdiction_cd
    , 1                                                                   -- 51 version_ctrl_nbr
    , NULL                                                                -- 52 contact_exposure_site_uid
    , NULL, NULL                                                          -- 53-54 provider_contact_investigator_uid, dispositioned_by_uid
    ),
    -- ---------------------------------------------------------------
    -- Row 2. v2 Contact (UID 20120010) — fully populated.
    --   CTT_* columns mirror SRTE-resolved descriptions of the v2
    --   ct_contact row's *_CD values. The d_postprocessing SP propagates
    --   these directly to D_CONTACT_RECORD without further joins.
    --   NAMED_DURING_INTERVIEW_UID = foundation Interview (drives
    --   F_CONTACT_RECORD_CASE.CONTACT_INTERVIEW_KEY join — resolves to 1
    --   since NRT_INTERVIEW_KEY is empty in Tier 1 isolation).
    --   CONTACT_EXPOSURE_SITE_UID = foundation Org (drives
    --   CONTACT_EXPOSURE_SITE_KEY — sentinel 1 since D_ORGANIZATION is
    --   empty for foundation Org at Tier 1 isolation).
    --   PROVIDER_CONTACT_INVESTIGATOR_UID + DISPOSITIONED_BY_UID = foundation
    --   Provider (drives CONTACT_INVESTIGATOR_KEY + DISPOSITIONED_BY_KEY —
    --   sentinel 1 since D_PROVIDER is empty for foundation Provider at
    --   Tier 1 isolation).
    -- ---------------------------------------------------------------
    ( @dbo_Act_contact_v2_uid                                             -- 01
    , '2026-04-15T10:00:00', @superuser_id                                -- 02-03
    , N'EPI20120010'                                                      -- 04 contact_entity_epi_link_id
    , @foundation_investigation_uid, @foundation_patient_uid              -- 05-06
    , N'P1 - Partner, Sex', N'Active'                                     -- 07-08 referral_basis (REFERRAL_BASIS desc), status (free-text since CONTACT_STATUS uses INV109 + fn we side-step)
    , '2026-04-20T08:00:00', N'Confirmed Case'                            -- 09-10 dispo_dt, disposition (NBS_DISPO 'CONF')
    , N'Yes', '2026-04-13T08:00:00', N'Evaluation completed at PHC.'      -- 11-13 eval_completed (YNU 'Y'), eval_dt, eval_notes
    , N'GRP_HEPA', N'Acute Illness'                                       -- 14-15 group_lot_id (raw; SRTE_GAP), health_status (NBS_HEALTH_STATUS 'AILL')
    , '2026-04-10T08:00:00', N'Fulton County'                             -- 16-17 inv_assigned_dt, jurisdiction_nm (JURISDICTION_CODE)
    , '2026-04-09T08:00:00', N'Contact identified during partner-services interview.'  -- 18-19 named_on_dt, notes
    , N'High', N'Field Follow-up'                                         -- 20-21 priority (NBS_PRIORITY 'HIGH'), processing_decision (STD_CONTACT_RCD_PROCESSING_DECISION 'FF')
    , N'HEP', N'Partner'                                                  -- 22-23 program_area (PROGRAM_AREA_CODE 'HEP'), relationship (NBS_RELATIONSHIP 'PARTNER')
    , N'Yes', N'Sexual partner identified by index case during interview.'  -- 24-25 risk_ind (YNU 'Y'), risk_notes
    , N'Yes', N'Yes', N'Mild GI symptoms, fever.'                         -- 26-28 shared_ind (YN 'Y'), symp_ind (YNU 'Y'), symp_notes
    , @foundation_investigation_uid, @foundation_patient_uid              -- 29-30 third_party_entity_phc_uid, third_party_entity_uid
    , '2026-04-12T08:00:00'                                               -- 31 symp_onset_dt
    , N'No', '2026-04-25T08:00:00'                                        -- 32-33 trt_complete_ind (YNU 'N'), trt_end_dt
    , N'Yes'                                                              -- 34 trt_initiated_ind (YNU 'Y')
    , N'Provider Decision', N'Refused Treatment'                          -- 35-36 trt_not_complete_rsn (NBS_NO_TRTMNT_REAS 'PROVDEC'), trt_not_start_rsn (NBS_NO_TRTMNT_REAS 'REFUSETX')
    , N'Treatment plan: 14-day course Acyclovir 400mg TID.', '2026-04-14T08:00:00'  -- 37-38 trt_notes, trt_start_dt
    , '2026-04-15T10:00:00', @superuser_id                                -- 39-40 last_chg_time, last_chg_user_id
    , N'CON20120010GA01', @foundation_interview_uid                       -- 41-42 local_id, named_during_interview_uid
    , 9999999                                                             -- 43 program_jurisdiction_oid
    , N'ACTIVE', '2026-04-15T10:00:00'                                    -- 44-45 record_status_cd/time
    , N'EPI20000000'                                                      -- 46 subject_entity_epi_link_id
    , @foundation_investigation_uid, @foundation_patient_uid              -- 47-48 subject_entity_phc_uid, subject_entity_uid
    , N'HEP', N'130001'                                                   -- 49-50 prog_area_cd, jurisdiction_cd
    , 1                                                                   -- 51 version_ctrl_nbr
    , @foundation_org_uid                                                 -- 52 contact_exposure_site_uid → F_CRC.CONTACT_EXPOSURE_SITE_KEY (sentinel 1)
    , @foundation_provider_uid, @foundation_provider_uid                  -- 53-54 contact_investigator_uid, dispositioned_by_uid
    );
