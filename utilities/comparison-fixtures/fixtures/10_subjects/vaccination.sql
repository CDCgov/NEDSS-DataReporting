...
INSERT INTO [dbo].[nrt_vaccination]
    ...
    , [age_at_vaccination], [age_at_vaccination_unit]                   -- 04-05
    , [last_chg_time], [last_chg_user_id]                               -- 06-07
    , [local_id], [record_status_cd], [record_status_time]              -- 08-10
    , [vaccine_administered_date], [vaccine_dose_nbr]                   -- 11-12
    , [vaccination_administered_nm], [vaccination_anatomical_site]      -- 13-14
    , [vaccine_expiration_dt], [vaccine_info_source]                    -- 15-16
    , [vaccine_lot_number_txt], [vaccine_manufacturer_nm]               -- 17-18
    , [version_ctrl_nbr], [electronic_ind]                              -- 19-20
    , [provider_uid], [organization_uid], [phc_uid], [patient_uid]      -- 21-24
    , [status_time]                                                     -- 25
    , [prog_area_cd], [jurisdiction_cd], [program_jurisdiction_oid]     -- 26-28
    , [material_cd]                                                     -- 29
    )
VALUES
    -- ---------------------------------------------------------------
    -- Row 1. Foundation Vaccination (UID 20000160) — sparse / null +
    -- blank propagation.
    --   The d_vaccination postprocessing SP applies NULLIF(<col>, '')
    --   to AGE_AT_VACCINATION_UNIT, VACCINATION_ADMINISTERED_NM,
    --   VACCINATION_ANATOMICAL_SITE, VACCINE_INFO_SOURCE,
    --   VACCINE_MANUFACTURER_NM (lines 246, 254, 255, 258, 260 of UPDATE
    --   pass; lines 353, 361, 362, 365, 367 of INSERT pass). Passing
    --   N'' on these 5 columns exercises the blank-to-NULL transform
    --   path; the others just drop NULL through.
    --   Soft refs (patient_uid/provider_uid/organization_uid/phc_uid)
    --   NULL exercises the f_vaccination postprocessing SP's
    --   COALESCE-to-sentinel-1 path on every cross-subject FK.
    -- ---------------------------------------------------------------
    ( @foundation_act_vaccination_uid                                   -- 01
    , '2026-04-01T00:00:00', @superuser_id                              -- 02-03
    , NULL, N''                                                         -- 04-05  blank exercises NULLIF
    , '2026-04-01T00:00:00', @superuser_id                              -- 06-07
    , N'VAC20000160GA01', N'ACTIVE', '2026-04-01T00:00:00'              -- 08-10
    , NULL, NULL                                                        -- 11-12
    , N'', N''                                                          -- 13-14  blank exercises NULLIF
    , NULL, N''                                                         -- 15-16  blank exercises NULLIF
    , NULL, N''                                                         -- 17-18  blank exercises NULLIF on mfgr
    , 1, N'N'                                                           -- 19-20
    , NULL, NULL, NULL, NULL                                            -- 21-24  no soft refs
    , '2026-04-01T00:00:00'                                             -- 25
    , N'IMM', N'1', NULL                                                -- 26-28
    , N'207'                                                            -- 29  matches foundation intervention.material_cd
    ),
    -- ---------------------------------------------------------------
    -- Row 2. v2 Vaccination (UID 20110010) — fully populated.
    --   Cross-subject soft refs point at foundation Patient / Provider
    --   / Organization / Investigation. The f_vaccination
    --   postprocessing SP COALESCEs each of these to sentinel 1 (lines
    --   74, 77, 80, 85) since D_PATIENT / D_PROVIDER / D_ORGANIZATION /
    --   INVESTIGATION are empty for these UIDs at Tier 1 isolation.
    --   In merged-fixture sequence, after upstream chains run, the
    --   COALESCEs resolve to real keys.
    --   Every text column populated to drive the populated path on
    --   D_VACCINATION columns the SP reads from nrt_vaccination.
    -- ---------------------------------------------------------------
    ( @dbo_Act_vaccination_v2_uid                                       -- 01
    , '2026-04-15T10:00:00', @superuser_id                              -- 02-03
    , 42, N'Years'                                                      -- 04-05
    , '2026-04-15T10:00:00', @superuser_id                              -- 06-07
    , N'VAC20110010GA01', N'ACTIVE', '2026-04-15T10:00:00'              -- 08-10
    , '2026-04-15T10:00:00', 2                                          -- 11-12
    , N'Hep A, adult', N'Left Deltoid'                                  -- 13-14
    , '2027-12-31T00:00:00', N'New immunization record'                 -- 15-16
    , N'LOT-HEPA-2026-A', N'Merck & Co., Inc.'                          -- 17-18
    , 1, N'Y'                                                           -- 19-20
    , @foundation_provider_uid, @foundation_org_uid                     -- 21-22
    , @foundation_investigation_uid, @foundation_patient_uid            -- 23-24
    , '2026-04-15T10:00:00'                                             -- 25
    , N'IMM', N'130001', 20110010                                       -- 26-28
    , N'52'                                                             -- 29
    );
