...
-- handles NULL).
-- =====================================================================
INSERT INTO [dbo].[nrt_interview]
    ( [interview_uid]                                                       -- 01
    , [interview_status_cd], [interview_date]                               -- 02-03
    , [interviewee_role_cd], [interview_type_cd], [interview_loc_cd]        -- 04-06
    , [local_id], [record_status_cd], [record_status_time]                  -- 07-09
    , [add_time], [add_user_id], [last_chg_time], [last_chg_user_id]        -- 10-13
    , [version_ctrl_nbr]                                                    -- 14
    , [ix_status], [ix_interviewee_role], [ix_type], [ix_location]          -- 15-18
    , [investigation_uid], [provider_uid], [organization_uid], [patient_uid] -- 19-22
    )
VALUES
    -- ---------------------------------------------------------------
    -- Row 1. Foundation Interview (UID 20000140) — sparse / null path.
    -- ---------------------------------------------------------------
    ( @foundation_act_interview_uid                                         -- 01
    , N'C', '2026-04-01T00:00:00'                                           -- 02-03  status_cd 'C' not in NBS_INTVW_STATUS
    , NULL, N'INITIAL', N'HOSP'                                             -- 04-06  interviewee_role NULL (SUBJECT/ELSE path)
    , N'INT20000140GA01', N'ACTIVE', '2026-04-01T00:00:00'                  -- 07-09
    , '2026-04-01T00:00:00', @superuser_id                                  -- 10-11
    , '2026-04-01T00:00:00', @superuser_id                                  -- 12-13
    , 1                                                                     -- 14
    , NULL, NULL, NULL, NULL                                                -- 15-18  no SRTE descriptions
    , NULL, NULL, NULL, NULL                                                -- 19-22  no soft refs
    ),
    -- ---------------------------------------------------------------
    -- Row 2. v2 Interview (UID 20090010) — fully populated.
    --   interviewee_role_cd='PHYS' drives PHYSICIAN_KEY CASE branch.
    --   ix_status / ix_type / ix_location / ix_interviewee_role are
    --   the upstream-projected description columns that the post-
    --   processing SP propagates straight to D_INTERVIEW.
    -- ---------------------------------------------------------------
    ( @dbo_Act_interview_v2_uid                                             -- 01
    , N'COMPLETE', '2026-04-15T10:00:00'                                    -- 02-03
    , N'PHYS', N'REINTVW', N'PHCLINIC'                                      -- 04-06
    , N'INT20090010GA01', N'ACTIVE', '2026-04-15T10:00:00'                  -- 07-09
    , '2026-04-15T10:00:00', @superuser_id                                  -- 10-11
    , '2026-04-15T10:00:00', @superuser_id                                  -- 12-13
    , 1                                                                     -- 14
    , N'Closed/Completed', N'Reporting/Treating Physician'                  -- 15-16
    , N'Re-Interview', N'Public Health Clinic'                              -- 17-18
    , @foundation_investigation_uid, @foundation_provider_uid               -- 19-20
    , @foundation_org_uid, @foundation_patient_uid                          -- 21-22
    );
...
-- =====================================================================
INSERT INTO [dbo].[nrt_interview_note]
    ( [interview_uid], [nbs_answer_uid]
    , [user_first_name], [user_last_name]
    , [user_comment], [comment_date]
    , [record_status_cd]
    )
VALUES
    ( @dbo_Act_interview_v2_uid, 20090020
    , N'Alice', N'Investigator'
    , N'Subject completed re-interview at PHC. Confirmed exposure timeline.', '2026-04-15T10:30:00'
    , N'ACTIVE'
    ),
    ( @dbo_Act_interview_v2_uid, 20090021
    , N'Bob', N'Supervisor'
    , N'Reviewed and approved interview record.', '2026-04-15T11:00:00'
    , N'ACTIVE'
    );
