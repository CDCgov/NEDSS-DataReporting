...
INSERT INTO [dbo].[nrt_place]
    ([place_uid], [cd], [place_type_description], [place_local_id], [place_name],
     [place_general_comments], [place_add_time], [place_add_user_id],
     [place_last_change_time], [place_last_chg_user_id],
     [place_record_status], [place_record_status_time],
     [place_status_cd], [place_status_time],
     [place_quick_code], [assigning_authority_cd],
     [place_postal_uid], [place_zip], [place_city], [place_country],
     [place_street_address_1], [place_street_address_2],
     [place_county_code], [place_state_code], [place_address_comments],
     [place_elp_cd], [place_state_desc], [place_county_desc], [place_country_desc])
VALUES
-- Foundation Place (UID 20000030): minimal but valid row. Mirrors the
-- foundation ODSE place row enriched above. cd / place_type_description
-- left NULL so D_PLACE.PLACE_TYPE_DESCRIPTION exhibits the null path.
-- Several other optional columns NULL on purpose to exercise the SP's
-- blank/null-handling branches.
    (20000030, NULL, NULL,                                    -- cd, place_type_description NULL (deliberate; foundation place.cd is NULL)
     N'PLC20000030GA01', N'Foundation Place',
     NULL,                                                    -- place_general_comments NULL (deliberate)
     '2026-04-01T00:00:00', 10009282,
     '2026-04-01T00:00:00', 10009282,
     N'ACTIVE', '2026-04-01T00:00:00',
     N'A', '2026-04-01T00:00:00',
     NULL, NULL,                                              -- place_quick_code, assigning_authority_cd NULL (deliberate; foundation has no entity_id row)
     20040000, N'30303', N'Atlanta', N'840',                  -- place_postal_uid mirrors the (PST,WP,PLC) ELP edge above (20040000), not the foundation (PST,H,H) row at 20000031
     N'400 Place Avenue', NULL,                               -- street_address_2 NULL (deliberate)
     N'13121', N'13', N'Foundation Place address',
     N'PLC', N'Georgia', N'Fulton County', N'United States'),
-- v2 Place (UID 20040010): every column populated to maximize D_PLACE
-- coverage. place_add_user_id 10003000 maps to USER_PROFILE
-- (Nelson, Jay) so PLACE_ADDED_BY / PLACE_LAST_UPDATED_BY resolve.
    (20040010, N'M', N'Motel/Hotel',
     N'PLC20040010GA01', N'Variant Motel',
     N'Tier 1 variant place — exercises every D_PLACE column.',
     '2026-04-01T00:00:00', 10003000,
     '2026-04-01T00:00:00', 10003000,
     N'ACTIVE', '2026-04-01T00:00:00',
     N'A', '2026-04-01T00:00:00',
     N'PLC-V2-QEC', N'NBS',
     20040011, N'30303', N'Atlanta', N'840',
     N'4010 Variant Motel Drive', N'Suite 200',
     N'13121', N'13', N'v2 Place work-place address',
     N'PLC', N'Georgia', N'Fulton County', N'United States');
...
INSERT INTO [dbo].[nrt_place_tele]
    ([place_uid], [place_tele_locator_uid], [place_phone_ext], [place_phone],
     [place_email], [place_phone_comments],
     [tele_use_cd], [tele_cd],
     [place_tele_type], [place_tele_use])
VALUES
-- Foundation Place tele row: phone populated, email + extension NULL.
    (20000030, 20040001, NULL, N'404-555-0400',               -- place_phone_ext NULL (deliberate)
     NULL,                                                    -- place_email NULL (deliberate; no email locator on foundation Place)
     N'Foundation Place work phone',
     N'WP', N'PH',
     N'Phone', N'Work Place'),
-- v2 Place tele row: phone + extension + email all populated.
    (20040010, 20040012, N'5678', N'404-555-4010',
     N'variant.place@nbs.test',
     N'v2 Place work phone',
     N'WP', N'PH',
     N'Phone', N'Work Place');
