...
INSERT INTO [dbo].[nrt_provider]
    ([provider_uid], [local_id], [record_status],
     [name_prefix], [first_name], [middle_name], [last_name], [name_suffix], [name_degree],
     [general_comments], [quick_code],
     [provider_registration_num], [provider_registration_num_auth], [provider_npi],
     [street_address_1], [street_address_2], [city], [state], [state_code], [zip],
     [county], [county_code], [country], [country_code], [address_comments],
     [phone_work], [phone_ext_work], [email_work], [phone_comments], [phone_cell],
     [entry_method], [add_user_id], [add_user_name], [add_time],
     [last_chg_user_id], [last_chg_user_name], [last_chg_time])
VALUES
-- Foundation Provider (UID 20000010): minimal but valid row. Mirrors the foundation
-- ODSE row enriched above. NULLs left on a few optional cols so the diff between
-- "minimal" and "fully attributed" is visible.
    (20000010, N'PSN20000010GA01', N'ACTIVE',
     NULL, N'Foundation', NULL, N'Provider', N'MD', NULL,
     NULL, NULL,
     NULL, NULL, N'1234567890',
     N'200 Provider Plaza', NULL, N'Atlanta', N'Georgia', N'13', N'30303',
     N'Fulton County', N'13121', N'United States', N'840', N'Provider work address',
     N'404-555-0210', N'1234', N'foundation.provider@nbs.test', N'Provider work phone/email', NULL,
     N'ELECTRONIC', 10009282, N'Kent, Ariella', '2026-04-01T00:00:00',
     10009282, N'Kent, Ariella', '2026-04-01T00:00:00'),
-- v2 Provider (UID 20010010): every column populated to maximize D_PROVIDER coverage.
    (20010010, N'PSN20010010GA01', N'ACTIVE',
     N'DR', N'Variant', N'Q', N'Provider', N'JR', N'PhD',
     N'Tier 1 variant provider — exercises every D_PROVIDER column.', N'V2QUICK',
     N'REG-12345', N'State Medical Board', N'9876543210',
     N'2010 Variant Provider Way', N'Suite 200', N'Atlanta', N'Georgia', N'13', N'30303',
     N'Fulton County', N'13121', N'United States', N'840', N'v2 Provider work address',
     N'404-555-1010', N'5678', N'variant.provider@nbs.test', N'v2 Provider work phone', N'404-555-1011',
     N'ELECTRONIC', 10009282, N'Kent, Ariella', '2026-04-01T00:00:00',
     10009282, N'Kent, Ariella', '2026-04-01T00:00:00');
