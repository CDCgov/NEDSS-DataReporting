...
BEGIN
    SET IDENTITY_INSERT dbo.D_PROVIDER ON;
    ...
    SET IDENTITY_INSERT dbo.D_PROVIDER OFF;
END;
...
BEGIN
    SET IDENTITY_INSERT dbo.D_ORGANIZATION ON;
    ...
    VALUES (22023003, 22023003,
        ...
        '2026-04-01T00:00:00', '2026-04-01T00:00:00');
    SET IDENTITY_INSERT dbo.D_ORGANIZATION OFF;
END;
...
BEGIN
    SET IDENTITY_INSERT dbo.D_INV_RISK_FACTOR ON;
    ...
    VALUES (22023100,
        ...
        N'N', N'arm', N'none',
        N'N', N'N', N'N');
    SET IDENTITY_INSERT dbo.D_INV_RISK_FACTOR OFF;
END;
...
BEGIN
    SET IDENTITY_INSERT dbo.D_INVESTIGATION_REPEAT ON;
    ...
    SET IDENTITY_INSERT dbo.D_INVESTIGATION_REPEAT OFF;
END;
