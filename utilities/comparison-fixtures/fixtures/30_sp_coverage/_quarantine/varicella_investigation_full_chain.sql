...
INSERT INTO [dbo].[nrt_investigation]
    ([public_health_case_uid], [patient_id], [program_jurisdiction_oid],
     ...
     [outbreak_ind])
VALUES
    (22002000,                              -- public_health_case_uid
     20000000,                              -- patient_id (foundation Patient)
     22002000,                              -- program_jurisdiction_oid
     N'CAS22002000GA01',                    -- local_id
     N'T',                                  -- shared_ind
     N'I',                                  -- case_type_cd
     N'130001',                             -- jurisdiction_cd (Fulton)
     N'ACTIVE',                             -- record_status_cd
     N'EVN', N'CASE',                       -- mood_cd, class_cd
     N'C', N'10030', N'Varicella (Chickenpox)', N'GCD', -- case_class_cd, cd, cd_desc, prog
     N'INV_FORM_VAR',                       -- investigation_form_cd
     22002001,                              -- case_management_uid
     N'O', N'Open',
     N'Confirmed',
...
VALUES
    -- VAR101 VARICELLA_VACCINE -> 'Y' -> D_VAR_PAM.VARICELLA_VACCINE
    (22002000, 22002100, 2, 1442, N'VAR_PAM', N'VARICELLA_VACCINE',
     N'Y', N'1', N'INV_FORM_VAR', N'VAR101',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'VARICELLA_VACCINE', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR103 RASH_LOCATION
    (22002000, 22002101, 2, 1363, N'VAR_PAM', N'RASH_LOCATION',
     N'OTH', N'1', N'INV_FORM_VAR', N'VAR103',
     N'NBS_Case_Answer.answer_txt', 2780,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'RASH_LOCATION', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR105 RASH_LOCATION_GENERAL (Trunk) — feeds D_RASH_LOC_GEN via 225 SP
    (22002000, 22002102, 2, 1356, N'VAR_PAM', N'RASH_LOCATION_GENERAL',
     N'22943007', N'1', N'INV_FORM_VAR', N'VAR105',
     N'NBS_Case_Answer.answer_txt', 2790,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'RASH_LOCATION_GENERAL', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR111 VESICLES -> 'Y'
    (22002000, 22002103, 2, 1141, N'VAR_PAM', N'VESICLES',
     N'Y', N'1', N'INV_FORM_VAR', N'VAR111',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'VESICLES', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR113 MACULAR_PAPULAR -> 'N'
    (22002000, 22002104, 2, 1432, N'VAR_PAM', N'MACULAR_PAPULAR',
     N'N', N'1', N'INV_FORM_VAR', N'VAR113',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'MACULAR_PAPULAR', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR122 FEVER -> 'Y'
    (22002000, 22002105, 2, 1036, N'VAR_PAM', N'FEVER',
     N'Y', N'1', N'INV_FORM_VAR', N'VAR122',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'FEVER', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR123 FEVER_ONSET_DATE (date)
    (22002000, 22002106, 2, 1017, N'VAR_PAM', N'FEVER_ONSET_DATE',
     N'2026-03-25', N'1', N'INV_FORM_VAR', N'VAR123',
     N'NBS_Case_Answer.answer_txt', NULL,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'FEVER_ONSET_DATE', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR126 IMMUNOCOMPROMISED -> 'N'
    (22002000, 22002107, 2, 1190, N'VAR_PAM', N'IMMUNOCOMPROMISED',
     N'N', N'1', N'INV_FORM_VAR', N'VAR126',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'IMMUNOCOMPROMISED', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR128 PATIENT_VISIT_HC_PROVIDER -> 'Y'
    (22002000, 22002108, 2, 1187, N'VAR_PAM', N'PATIENT_VISIT_HC_PROVIDER',
     N'Y', N'1', N'INV_FORM_VAR', N'VAR128',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'PATIENT_VISIT_HC_PROVIDER', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR129 COMPLICATIONS -> 'N'
    (22002000, 22002109, 2, 1126, N'VAR_PAM', N'COMPLICATIONS',
     N'N', N'1', N'INV_FORM_VAR', N'VAR129',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'COMPLICATIONS', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR135 COMPLICATIONS_PNEUMONIA -> 'N'
    (22002000, 22002110, 2, 1172, N'VAR_PAM', N'COMPLICATIONS_PNEUMONIA',
     N'N', N'1', N'INV_FORM_VAR', N'VAR135',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'COMPLICATIONS_PNEUMONIA', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR139 TREATED -> 'N'
    (22002000, 22002111, 2, 1333, N'VAR_PAM', N'TREATED',
     N'N', N'1', N'INV_FORM_VAR', N'VAR139',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'TREATED', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR143 DEATH_AUTOPSY -> 'N'
    (22002000, 22002112, 2, 1277, N'VAR_PAM', N'DEATH_AUTOPSY',
     N'N', N'1', N'INV_FORM_VAR', N'VAR143',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'DEATH_AUTOPSY', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR150 PREVIOUS_DIAGNOSIS -> 'N'
    (22002000, 22002113, 2, 1347, N'VAR_PAM', N'PREVIOUS_DIAGNOSIS',
     N'N', N'1', N'INV_FORM_VAR', N'VAR150',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'PREVIOUS_DIAGNOSIS', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR154 EPI_LINKED -> 'N'
    (22002000, 22002114, 2, 1446, N'VAR_PAM', N'EPI_LINKED',
     N'N', N'1', N'INV_FORM_VAR', N'VAR154',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'EPI_LINKED', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR156 TRANSMISSION_SETTING -> Community
    (22002000, 22002115, 2, 1170, N'VAR_PAM', N'TRANSMISSION_SETTING',
     N'133928008', N'1', N'INV_FORM_VAR', N'VAR156',
     N'NBS_Case_Answer.answer_txt', 2660,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'TRANSMISSION_SETTING', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR158 HEALTHCARE_WORKER -> 'N'
    (22002000, 22002116, 2, 1184, N'VAR_PAM', N'HEALTHCARE_WORKER',
     N'N', N'1', N'INV_FORM_VAR', N'VAR158',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'HEALTHCARE_WORKER', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR170 LAB_TESTING -> 'Y'
    (22002000, 22002117, 2, 1210, N'VAR_PAM', N'LAB_TESTING',
     N'Y', N'1', N'INV_FORM_VAR', N'VAR170',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'LAB_TESTING', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR171 DFA_TEST -> 'N'
    (22002000, 22002118, 2, 1084, N'VAR_PAM', N'DFA_TEST',
     N'N', N'1', N'INV_FORM_VAR', N'VAR171',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'DFA_TEST', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR174 PCR_TEST -> 'Y'
    (22002000, 22002119, 2, 1241, N'VAR_PAM', N'PCR_TEST',
     N'Y', N'1', N'INV_FORM_VAR', N'VAR174',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'PCR_TEST', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR176 PCR_TEST_SOURCE (Scab) — feeds D_PCR_SOURCE via 230 SP
    (22002000, 22002120, 2, 1329, N'VAR_PAM', N'PCR_TEST_SOURCE',
     N'69640009', N'1', N'INV_FORM_VAR', N'VAR176',
     N'NBS_Case_Answer.answer_txt', 2770,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'PCR_TEST_SOURCE', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR178 PCR_TEST_RESULT -> Positive
    (22002000, 22002121, 2, 1016, N'VAR_PAM', N'PCR_TEST_RESULT',
     N'10828004', N'1', N'INV_FORM_VAR', N'VAR178',
     N'NBS_Case_Answer.answer_txt', 4200,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'PCR_TEST_RESULT', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR180 CULTURE_TEST -> 'N'
    (22002000, 22002122, 2, 1343, N'VAR_PAM', N'CULTURE_TEST',
     N'N', N'1', N'INV_FORM_VAR', N'VAR180',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'CULTURE_TEST', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR188 SEROLOGY_TEST -> 'N'
    (22002000, 22002123, 2, 1020, N'VAR_PAM', N'SEROLOGY_TEST',
     N'N', N'1', N'INV_FORM_VAR', N'VAR188',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'SEROLOGY_TEST', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active'),
    -- VAR195 IGG_TEST -> 'N'
    (22002000, 22002124, 2, 1024, N'VAR_PAM', N'IGG_TEST',
     N'N', N'1', N'INV_FORM_VAR', N'VAR195',
     N'NBS_Case_Answer.answer_txt', 4150,
     '2026-04-01T00:00:00', N'ACTIVE',
     N'IGG_TEST', NULL, 1, NULL,
     2, '2026-04-01T00:00:00', N'Active');
