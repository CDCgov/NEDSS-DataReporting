...
-- NOTE: 22003000 (COVID full-chain) and 22004000 (STD Syphilis full-chain)
-- are INTENTIONALLY OMITTED here. Round 5 item C authors dedicated,
-- richly-attributed patients and links them as those PHCs' SubjOfPHC so the
-- covid_case_datamart / std_hiv_datamart PATIENT_* columns populate:
...
WHERE phc.public_health_case_uid IN
        (22001000, 22002000, 22005000, 22006000, 22007000, 22008500)
