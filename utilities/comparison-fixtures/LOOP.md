...
T+3h 16m | iter 6 (attempt 2) | zz_enrich_phase2_investigations.sql (renamed to sort last) | 39.9% (Δ +2.9pp, +132 cols) | SUCCESS | covid_case_datamart 53→87 (+34), tb_datamart 61→95 (+34), var_datamart 61→91 (+30). bmird, std_hiv, hep_datamart unchanged (different read paths).
