...
INSERT INTO DSM_algorithm (
    ...
    'Investigate_HIV_positive_test',                              -- algorithm_nm
    '11648804',                                -- event_type
    '900',                            -- condition_list
    '10351-5',                             -- resulted_test_list
    '1',                                 -- frequency
    '1',                                  -- apply_to
  ...
  <AlgorithmName>Investigate_HIV_positive_test</AlgorithmName>
  <Event>
    <Code>11648804</Code>
  ...
  <InvestigationType>PG_HIV_Investigation</InvestigationType>
  <ApplyToConditions>
    <Condition>
      <Code>900</Code>
      <CodeDescTxt>HIV</CodeDescTxt>
      <CodeSystemCode>L</CodeSystemCode>
    </Condition>
  </ApplyToConditions>
  <Comment/>
