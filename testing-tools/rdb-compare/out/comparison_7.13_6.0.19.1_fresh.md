...
- Generated at: 2026-06-10T18:33:42+00:00

## Summary

| Metric | Count |
| --- | ---: |
| Tables discovered | 178 |
| Tables compared | 178 |
| Tables skipped | 0 |
| Tables needing attention | 10 |
| Column diffs: NEW | 205 |
| Column diffs: KNOWN_BUG | 6 |
| Column diffs: EXPECTED | 0 |
| Column diffs: IGNORED | 29 |
...
| ORGANIZATION_KEY | 15 | 6 | 40.0% | IGNORED | IGN-key_offset-ALL | `7` → `8`; `8` → `9`; `9` → `11`; (+3 more) |
...
| PROVIDER_KEY | 24 | 14 | 58.3% | IGNORED | IGN-key_offset-ALL | `12` → `17`; `13` → `12`; `14` → `18`; (+11 more) |
...
| Column | Compared | Mismatches | Rate | Verdict | Rule | Sample (rdb → modern) |
| --- | ---: | ---: | ---: | --- | --- | --- |
| REFRESH_DATETIME | 1 | 1 | 100.0% | NEW | - | `Jun 10 2026  6:31PM` → `Jun 10 2026  6:09PM` |
...
| INVESTIGATION_KEY | 32 | 30 | 93.8% | IGNORED | IGN-key_offset-ALL | `4` → `8`; `5` → `9`; `6` → `10`; (+17 more) |
...
| Column | Compared | Mismatches | Rate | Verdict | Rule | Sample (rdb → modern) |
| --- | ---: | ---: | ---: | --- | --- | --- |
| LAB_RESULT_TXT_VAL | 40 | 4 | 10.0% | NEW | - | `NULL` → `Tier 1 Morbidity v2 — comments narrativ…`; `NULL` → `Tier 1 Morbidity v2 — other-specify fre…`; `NULL` → `Morb-datamart enrichment comments narra…`; (+1 more) |
| RDB_LAST_REFRESH_TIME | 40 | 40 | 100.0% | IGNORED | IGN-env_timestamp-LAST_REFRESH_TIME | `Jun 10 2026  6:31PM` → `Jun 10 2026  6:07PM`; `Jun 10 2026  6:31PM` → `Jun 10 2026  6:07PM`; `Jun 10 2026  6:31PM` → `Jun 10 2026  6:07PM`; (+17 more) |
| TEST_RESULT_GRP_KEY | 40 | 34 | 85.0% | IGNORED | IGN-key_offset-ALL | `37` → `2`; `2` → `3`; `3` → `4`; (+17 more) |
| TEST_RESULT_VAL_KEY | 40 | 34 | 85.0% | IGNORED | IGN-key_offset-ALL | `37` → `2`; `2` → `3`; `3` → `4`; (+17 more) |
...
| LAB_TEST_KEY | 45 | 45 | 100.0% | KNOWN_BUG | BUG-LAB_TEST-LAB_TEST_KEY_OFFSET | `362` → `16`; `363` → `2`; `364` → `3`; (+17 more) |
...
| RDB_LAST_REFRESH_TIME | 45 | 45 | 100.0% | IGNORED | IGN-env_timestamp-LAST_REFRESH_TIME | `Jun 10 2026  6:31PM` → `Jun 10 2026  6:07PM`; `Jun 10 2026  6:31PM` → `Jun 10 2026  6:07PM`; `Jun 10 2026  6:31PM` → `Jun 10 2026  6:07PM`; (+17 more) |
...
| RDB_LAST_REFRESH_TIME | 5 | 5 | 100.0% | KNOWN_BUG | BUG-LAB_RESULT_COMMENT-modern_only | `Jun 10 2026  6:31PM` → `Jun 10 2026  6:08PM`; `Jun 10 2026  6:31PM` → `Jun 10 2026  6:08PM`; `Jun 10 2026  6:31PM` → `Jun 10 2026  6:08PM`; (+2 more) |
