...
EVENT_METRIC for var_datamart); the orchestrator's PHC_UIDS must be
extended to include 22002000 (see
...
| (reuses 22065000) | R6t2 summary-debug: wire/trigger sp_summary_report_case_postprocessing + sp_sr100_datamart_postprocessing (currently not firing); covers merge_and_verify.sh Step-9 + zz_summary_report_case.sql. |
