...
BEGIN
    ...
    (22004000, GETDATE(), 10009282, N'20040010^20040011^20040012', 10001284, 1, GETDATE(), 10009282, N'ACTIVE', GETDATE(), 1, 1), -- PlaceAsHangoutOfPHC g1
    (22004000, GETDATE(), 10009282, N'20040010^20040011^20040012', 10001286, 1, GETDATE(), 10009282, N'ACTIVE', GETDATE(), 1, 1), -- PlaceAsSexOfPHC     g1

    -- ---- group 2: both part types -> foundation locator ----
    (22004000, GETDATE(), 10009282, N'20000030^20040000^20040001', 10001284, 1, GETDATE(), 10009282, N'ACTIVE', GETDATE(), 2, 2), -- PlaceAsHangoutOfPHC g2
    (22004000, GETDATE(), 10009282, N'20000030^20040000^20040001', 10001286, 1, GETDATE(), 10009282, N'ACTIVE', GETDATE(), 2, 2), -- PlaceAsSexOfPHC     g2

    -- ---- group 3: hangout=variant / sex=foundation (mixed) ----
    (22004000, GETDATE(), 10009282, N'20040010^20040011^20040012', 10001284, 1, GETDATE(), 10009282, N'ACTIVE', GETDATE(), 3, 3), -- PlaceAsHangoutOfPHC g3
    (22004000, GETDATE(), 10009282, N'20000030^20040000^20040001', 10001286, 1, GETDATE(), 10009282, N'ACTIVE', GETDATE(), 3, 3); -- PlaceAsSexOfPHC     g3
END
GO
