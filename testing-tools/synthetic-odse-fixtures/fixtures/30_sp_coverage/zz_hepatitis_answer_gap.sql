...
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001074 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001074,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_ChildCareCase -> CHILDCARE_CASE_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001068 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001068,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_ContactBabysitter -> CT_BABYSITTER_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001067 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001067,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_ContactChildcare -> CT_CHILDCARE_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001069 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001069,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_ContactPlaymate -> CT_PLAYMATE_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001073 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001073,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_DaycareContact -> DNP_HOUSEHOLD_CT_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001072 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001072,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_InDayCare -> DNP_EMPLOYEE_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=1113 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,1113,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_EpiLinked -> HEP_A_EPLINK_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001091 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001091,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_FoodHandler -> FOODHNDLR_PRIOR_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001085 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001085,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_OutbreakAssoc -> COM_SRC_OUTBREAK_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001086 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001086,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_OutbreakFoodHndlr -> OBRK_FOODHNDLR_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001087 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001087,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_outbreakNonFoodHndlr -> OBRK_NOFOODHNDLR_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001090 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001090,1,'N',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_OutbreakUnidentified -> OBRK_UNIDENTIFIED_IND (CSG 4150)
...
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001088 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001088,1,'Shellfish',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- EPI_OutbreakFoodItem -> FOOD_OBRK_FOOD_ITEM (free text)
GO
...
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001080 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001080,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- TRV_PatientTravel -> TRAVEL_OUT_USACAN_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001081 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001081,1,'124',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- TRV_PtTravelCountries -> TRAVEL_OUT_USACAN_LOC (CSG 102960 '124'=CANADA)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001082 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001082,1,'5',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- TRV_VHF_TRAVEL_REASON -> TRAVEL_REASON (CSG 104320 '5'=tourism)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001083 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001083,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- TRV_HouseholdTravel -> HOUSEHOLD_TRAVEL_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001084 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001084,1,'124',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- TRV_TravelCountryHouse -> HOUSEHOLD_TRAVEL_LOC (CSG 102960 '124'=CANADA)
GO
...
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001095 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001095,1,'Y',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- VAC_ImmuneGlobulin -> IMM_GLOB_RECVD_IND (CSG 4150)
IF NOT EXISTS (SELECT 1 FROM dbo.nbs_case_answer WHERE act_uid=@phc_uid AND nbs_question_uid=10001096 AND answer_group_seq_nbr IS NULL)
    INSERT INTO dbo.nbs_case_answer (act_uid,nbs_question_uid,nbs_question_version_ctrl_nbr,answer_txt,seq_nbr,answer_group_seq_nbr,add_time,add_user_id,last_chg_time,last_chg_user_id,record_status_cd,record_status_time) VALUES (@phc_uid,10001096,1,'2025-09-01',1,NULL,GETDATE(),@su,CAST(GETDATE() AS DATE),@su,'ACTIVE',GETDATE()); -- VAC_LastIGDose -> GLOB_LAST_RECVD_YR (DATE)
GO
