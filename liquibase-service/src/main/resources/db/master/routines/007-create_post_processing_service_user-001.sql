...
IF NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = @UserName)
    BEGIN
        ...
        EXEC sp_executesql @AddRoleMemberRDBModernReaderSQL, N'@UserName NVARCHAR(150)', @UserName;
        ...
        DECLARE @GrantExecSQL NVARCHAR(MAX) =
            'DECLARE @sql NVARCHAR(MAX) = '''';
             ...
             EXEC sp_executesql @sql, N''@UserName NVARCHAR(150)'', @UserName;';

        EXEC sp_executesql @GrantExecSQL, N'@UserName NVARCHAR(150)', @UserName;
