...
IF NOT EXISTS(SELECT 1 FROM sys.objects WHERE type = 'PK' AND parent_object_id = OBJECT_ID('dbo.nrt_move_cnty_key'))
    BEGIN
        ALTER TABLE dbo.nrt_move_cnty_key
        ADD CONSTRAINT pk_nrt_move_cnty_key PRIMARY KEY (D_MOVE_CNTY_KEY);
    END;