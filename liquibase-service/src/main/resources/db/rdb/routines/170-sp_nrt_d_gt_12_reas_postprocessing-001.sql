IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_nrt_d_gt_12_reas_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_nrt_d_gt_12_reas_postprocessing]
END
GO 

CREATE PROCEDURE [dbo].[sp_nrt_d_gt_12_reas_postprocessing]
...
--------------------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#D_GT_12_REAS_PHC_LIST', 'U') IS NOT NULL
...
--------------------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#S_D_GT_12_REAS_TRANSLATED', 'U') IS NOT NULL
...
---------------------------------------------------------------------------------------------------------------------        
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#S_D_GT_12_REAS', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#TEMP_D_GT_12_REAS_DEL', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#L_D_GT_12_REAS_GROUP', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#L_D_GT_12_REAS', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        BEGIN TRANSACTION
            ...
            IF OBJECT_ID('tempdb..#TEMP_D_GT_12_REAS', 'U') IS NOT NULL
