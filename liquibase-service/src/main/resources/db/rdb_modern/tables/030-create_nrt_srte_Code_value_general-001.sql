IF
NOT EXISTS (SELECT 1 FROM sysobjects WHERE name = 'nrt_srte_Code_value_general' and xtype = 'U')
BEGIN
...
CREATE
NONCLUSTERED INDEX INDEX_CODE_VALUE_GENERAL_IND01 ON dbo.nrt_srte_Code_value_general (  code ASC  )
