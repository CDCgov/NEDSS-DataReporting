...
(
    ...
    init_fup_closed_dt            datetime2(7)                                    NULL,
    ...
    initiating_agncy              varchar(200)                                    NULL,
    internet_foll_up              varchar(3)                                      NULL,
    ooj_agency                    varchar(200)                                    NULL,
    ooj_due_date                  datetime2(7)                                    NULL,
    ooj_initg_agncy_outc_due_date datetime2(7)                                    NULL,
    ooj_initg_agncy_outc_snt_date datetime2(7)                                    NULL,
    ooj_initg_agncy_recd_date     datetime2(7)                                    NULL,
    ooj_number                    varchar(20)                                     NULL,
    pat_intv_status_cd            varchar(20)                                     NULL,
    status_900                    varchar(44)                                     NULL,
    surv_closed_dt                datetime2(7)                                    NULL,
    surv_investigator_assgn_dt    datetime2(7)                                    NULL,
    ...
    surv_provider_exam_reason     varchar(20)                                     NULL,
