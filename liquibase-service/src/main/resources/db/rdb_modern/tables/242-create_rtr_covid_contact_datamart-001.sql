IF NOT EXISTS (SELECT 1 FROM sysobjects WHERE name = 'RTR_COVID_CONTACT_DATAMART' and xtype = 'U')
CREATE TABLE dbo.RTR_COVID_CONTACT_DATAMART
(
    ...
    CONSTRAINT PK_RTR_COVID_CONTACT_DATAMART PRIMARY KEY CLUSTERED (CONTACT_UID)
);