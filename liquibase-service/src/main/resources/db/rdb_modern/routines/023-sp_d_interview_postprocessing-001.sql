...
BEGIN
    ...
    WHERE TABLE_NAME = 'D_INTERVIEW' AND TABLE_SCHEMA = 'dbo');
        ...
        SELECT @ColumnAdd_sql = STRING_AGG('ALTER TABLE dbo.D_INTERVIEW ADD ' + QUOTENAME(RDB_COLUMN_NM) + ' VARCHAR(50);', CHAR(13) + CHAR(10))
        FROM #NEW_COLUMNS;
        ...
        + CASE WHEN @Col_number > 0 THEN ' LEFT JOIN (
    ...
    + ' WHERE
        ...
        INSERT INTO dbo.D_INTERVIEW_NOTE (
            D_INTERVIEW_KEY,
            D_INTERVIEW_NOTE_KEY,
            NBS_ANSWER_UID,
            USER_FIRST_NAME,
        ...
        UPDATE din
        SET 
            din.USER_FIRST_NAME = ixn.USER_FIRST_NAME,
