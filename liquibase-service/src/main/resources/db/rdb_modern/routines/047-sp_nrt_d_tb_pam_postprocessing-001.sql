...
BEGIN TRY
	...
	BEGIN TRANSACTION
		...
		GROUP BY 
			ACT_UID, CODE_SET_GROUP_ID, DATAMART_COLUMN_NM, ANSWER_TXT, RECORD_STATUS_CD, LAST_CHG_TIME
	...
	BEGIN TRANSACTION
		...
		SELECT * FROM #S_TB_PAM_SET_CVG_FINAL
	...
	BEGIN TRANSACTION
		...
		SELECT 
			TB_PAM_UID,
			-- Character columns with length 200 (VARCHAR(200))
			CAST([CALC_DISEASE_SITE] AS VARCHAR(200)) AS CALC_DISEASE_SITE,
			CAST([INIT_SUSCEPT_STREPTOMYCIN] AS VARCHAR(200)) AS INIT_SUSCEPT_STREPTOMYCIN,
			CAST([INIT_SUSCEPT_OTHER_2_IND] AS VARCHAR(200)) AS INIT_SUSCEPT_OTHER_2_IND,
			CAST([INIT_SUSCEPT_RIFAMPIN] AS VARCHAR(200)) AS INIT_SUSCEPT_RIFAMPIN,
			CAST([FINAL_SUSCEPT_OTHER_QUINOLONES] AS VARCHAR(200)) AS FINAL_SUSCEPT_OTHER_QUINOLONES,
			CAST([TST_RESULT] AS VARCHAR(200)) AS TST_RESULT,
			CAST([NONINJECT_DRUG_USE_PAST_YEAR] AS VARCHAR(200)) AS NONINJECT_DRUG_USE_PAST_YEAR,
			CAST([INIT_SUSCEPT_ISONIAZID] AS VARCHAR(200)) AS INIT_SUSCEPT_ISONIAZID,
			CAST([INIT_SUSCEPT_RIFABUTIN] AS VARCHAR(200)) AS INIT_SUSCEPT_RIFABUTIN,
			CAST([INIT_SUSCEPT_MOXIFLOXACIN] AS VARCHAR(200)) AS INIT_SUSCEPT_MOXIFLOXACIN,
			CAST([HIV_STATUS] AS VARCHAR(200)) AS HIV_STATUS,
			CAST([COUNT_STATUS] AS VARCHAR(200)) AS COUNT_STATUS,
			CAST([INIT_REGIMEN_CAPREOMYCIN] AS VARCHAR(200)) AS INIT_REGIMEN_CAPREOMYCIN,
			CAST([FINAL_SUSCEPT_ETHAMBUTOL] AS VARCHAR(200)) AS FINAL_SUSCEPT_ETHAMBUTOL,
			CAST([PRIMARY_GUARD_1_BIRTH_COUNTRY] AS VARCHAR(200)) AS PRIMARY_GUARD_1_BIRTH_COUNTRY,
			CAST([FINAL_SUSCEPT_ETHIONAMIDE] AS VARCHAR(200)) AS FINAL_SUSCEPT_ETHIONAMIDE,
			CAST([FINAL_SUSCEPT_OTHER_2_IND] AS VARCHAR(200)) AS FINAL_SUSCEPT_OTHER_2_IND,
			CAST([INIT_REGIMEN_MOXIFLOXACIN] AS VARCHAR(200)) AS INIT_REGIMEN_MOXIFLOXACIN,
			CAST([STATUS_AT_DIAGNOSIS] AS VARCHAR(200)) AS STATUS_AT_DIAGNOSIS,
			CAST([IGRA_RESULT] AS VARCHAR(200)) AS IGRA_RESULT,
			CAST([CT_SCAN_MILIARY_EVIDENCE] AS VARCHAR(200)) AS CT_SCAN_MILIARY_EVIDENCE,
			CAST([INIT_REGIMEN_RIFAPENTINE] AS VARCHAR(200)) AS INIT_REGIMEN_RIFAPENTINE,
			CAST([CHEST_XRAY_MILIARY_EVIDENCE] AS VARCHAR(200)) AS CHEST_XRAY_MILIARY_EVIDENCE,
			CAST([PRIMARY_REASON_EVALUATED] AS VARCHAR(200)) AS PRIMARY_REASON_EVALUATED,
			CAST([CULT_TISSUE_SITE] AS VARCHAR(200)) AS CULT_TISSUE_SITE,
			CAST([SMR_PATH_CYTO_RESULT] AS VARCHAR(200)) AS SMR_PATH_CYTO_RESULT,
			CAST([LINK_REASON_2] AS VARCHAR(200)) AS LINK_REASON_2,
			CAST([MOVED_IND] AS VARCHAR(200)) AS MOVED_IND,
			CAST([CHEST_XRAY_CAVITY_EVIDENCE] AS VARCHAR(200)) AS CHEST_XRAY_CAVITY_EVIDENCE,
			CAST([LONGTERM_CARE_FACIL_TY] AS VARCHAR(200)) AS LONGTERM_CARE_FACIL_TY,
			CAST([NO_CONV_DOC_REASON] AS VARCHAR(200)) AS NO_CONV_DOC_REASON,
			CAST([FINAL_SUSCEPT_TESTING] AS VARCHAR(200)) AS FINAL_SUSCEPT_TESTING,
			CAST([PREVIOUS_DIAGNOSIS_IND] AS VARCHAR(200)) AS PREVIOUS_DIAGNOSIS_IND,
			CAST([INIT_SUSCEPT_OFLOXACIN] AS VARCHAR(200)) AS INIT_SUSCEPT_OFLOXACIN,
			CAST([FINAL_SUSCEPT_AMIKACIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_AMIKACIN,
			CAST([TB_CAUSE_OF_DEATH] AS VARCHAR(200)) AS TB_CAUSE_OF_DEATH,
			CAST([FINAL_ISOLATE_IS_SPUTUM_IND] AS VARCHAR(200)) AS FINAL_ISOLATE_IS_SPUTUM_IND,
			CAST([SMR_PATH_CYTO_SITE] AS VARCHAR(200)) AS SMR_PATH_CYTO_SITE,
			CAST([THERAPY_STOP_CAUSE_OF_DEATH] AS VARCHAR(200)) AS THERAPY_STOP_CAUSE_OF_DEATH,
			CAST([INIT_REGIMEN_ETHAMBUTOL] AS VARCHAR(200)) AS INIT_REGIMEN_ETHAMBUTOL,
			CAST([FINAL_SUSCEPT_OFLOXACIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_OFLOXACIN,
			CAST([INIT_REGIMEN_CYCLOSERINE] AS VARCHAR(200)) AS INIT_REGIMEN_CYCLOSERINE,
			CAST([THERAPY_STOP_REASON] AS VARCHAR(200)) AS THERAPY_STOP_REASON,
			CAST([INIT_SUSCEPT_TESTING_DONE] AS VARCHAR(200)) AS INIT_SUSCEPT_TESTING_DONE,
			CAST([NAA_RESULT] AS VARCHAR(200)) AS NAA_RESULT,
			CAST([HOMELESS_IND] AS VARCHAR(200)) AS HOMELESS_IND,
			CAST([INIT_SUSCEPT_CIPROFLOXACIN] AS VARCHAR(200)) AS INIT_SUSCEPT_CIPROFLOXACIN,
			CAST([INIT_REGIMEN_STREPTOMYCIN] AS VARCHAR(200)) AS INIT_REGIMEN_STREPTOMYCIN,
			CAST([FINAL_SUSCEPT_OTHER_IND] AS VARCHAR(200)) AS FINAL_SUSCEPT_OTHER_IND,
			CAST([LONGTERM_CARE_FACIL_RESIDENT] AS VARCHAR(200)) AS LONGTERM_CARE_FACIL_RESIDENT,
			CAST([SPUTUM_CULTURE_CONV_DOCUMENTED] AS VARCHAR(200)) AS SPUTUM_CULTURE_CONV_DOCUMENTED,
			CAST([NAA_SPEC_NOT_SPUTUM] AS VARCHAR(200)) AS NAA_SPEC_NOT_SPUTUM,
			CAST([INIT_SUSCEPT_ETHIONAMIDE] AS VARCHAR(200)) AS INIT_SUSCEPT_ETHIONAMIDE,
			CAST([INIT_REGIMEN_OFLOXACIN] AS VARCHAR(200)) AS INIT_REGIMEN_OFLOXACIN,
			CAST([IMMIGRATION_STATUS_AT_US_ENTRY] AS VARCHAR(200)) AS IMMIGRATION_STATUS_AT_US_ENTRY,
			CAST([ISOLATE_SUBMITTED_IND] AS VARCHAR(200)) AS ISOLATE_SUBMITTED_IND,
			CAST([FINAL_SUSCEPT_PYRAZINAMIDE] AS VARCHAR(200)) AS FINAL_SUSCEPT_PYRAZINAMIDE,
			CAST([INIT_SUSCEPT_PYRAZINAMIDE] AS VARCHAR(200)) AS INIT_SUSCEPT_PYRAZINAMIDE,
			CAST([INIT_REGIMEN_ETHIONAMIDE] AS VARCHAR(200)) AS INIT_REGIMEN_ETHIONAMIDE,
			CAST([INIT_SUSCEPT_CYCLOSERINE] AS VARCHAR(200)) AS INIT_SUSCEPT_CYCLOSERINE,
			CAST([FINAL_SUSCEPT_PA_SALICYLIC_ACI] AS VARCHAR(200)) AS FINAL_SUSCEPT_PA_SALICYLIC_ACI,
			CAST([PRIMARY_GUARD_2_BIRTH_COUNTRY] AS VARCHAR(200)) AS PRIMARY_GUARD_2_BIRTH_COUNTRY,
			CAST([CT_SCAN_RESULT] AS VARCHAR(200)) AS CT_SCAN_RESULT,
			CAST([NAA_SPEC_IS_SPUTUM_IND] AS VARCHAR(200)) AS NAA_SPEC_IS_SPUTUM_IND,
			CAST([FINAL_SUSCEPT_KANAMYCIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_KANAMYCIN,
			CAST([US_BORN_IND] AS VARCHAR(200)) AS US_BORN_IND,
			CAST([FINAL_SUSCEPT_ISONIAZID] AS VARCHAR(200)) AS FINAL_SUSCEPT_ISONIAZID,
			CAST([INIT_REGIMEN_PYRAZINAMIDE] AS VARCHAR(200)) AS INIT_REGIMEN_PYRAZINAMIDE,
			CAST([SPUTUM_CULTURE_RESULT] AS VARCHAR(200)) AS SPUTUM_CULTURE_RESULT,
			CAST([PATIENT_OUTSIDE_US_GT_2_MONTHS] AS VARCHAR(200)) AS PATIENT_OUTSIDE_US_GT_2_MONTHS,
			CAST([FIRST_ISOLATE_IS_SPUTUM_IND] AS VARCHAR(200)) AS FIRST_ISOLATE_IS_SPUTUM_IND,
			CAST([CULT_TISSUE_RESULT_RPT_LAB_TY] AS VARCHAR(200)) AS CULT_TISSUE_RESULT_RPT_LAB_TY,
			CAST([INIT_REGIMEN_CIPROFLOXACIN] AS VARCHAR(200)) AS INIT_REGIMEN_CIPROFLOXACIN,
			CAST([INIT_REGIMEN_AMIKACIN] AS VARCHAR(200)) AS INIT_REGIMEN_AMIKACIN,
			CAST([INIT_SUSCEPT_OTHER_1_IND] AS VARCHAR(200)) AS INIT_SUSCEPT_OTHER_1_IND,
			CAST([INIT_SUSCEPT_OTHER_QUNINOLONES] AS VARCHAR(200)) AS INIT_SUSCEPT_OTHER_QUNINOLONES,
			CAST([FINAL_SUSCEPT_CIPROFLOXACIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_CIPROFLOXACIN,
			CAST([INIT_SUSCEPT_CAPREOMYCIN] AS VARCHAR(200)) AS INIT_SUSCEPT_CAPREOMYCIN,
			CAST([INIT_SUSCEPT_LEVOFLOXACIN] AS VARCHAR(200)) AS INIT_SUSCEPT_LEVOFLOXACIN,
			CAST([TRANSNATIONAL_REFERRAL_IND] AS VARCHAR(200)) AS TRANSNATIONAL_REFERRAL_IND,
			CAST([INJECT_DRUG_USE_PAST_YEAR] AS VARCHAR(200)) AS INJECT_DRUG_USE_PAST_YEAR,
			CAST([CASE_VERIFICATION] AS VARCHAR(200)) AS CASE_VERIFICATION,
			CAST([INIT_REGIMEN_KANAMYCIN] AS VARCHAR(200)) AS INIT_REGIMEN_KANAMYCIN,
			CAST([FINAL_SUSCEPT_RIFAPENTINE] AS VARCHAR(200)) AS FINAL_SUSCEPT_RIFAPENTINE,
			CAST([FINAL_ISOLATE_NOT_SPUTUM] AS VARCHAR(200)) AS FINAL_ISOLATE_NOT_SPUTUM,
			CAST([CORRECTIONAL_FACIL_CUSTODY_IND] AS VARCHAR(200)) AS CORRECTIONAL_FACIL_CUSTODY_IND,
			CAST([MOVE_CITY] AS VARCHAR(200)) AS MOVE_CITY,
			CAST([CORRECTIONAL_FACIL_TY] AS VARCHAR(200)) AS CORRECTIONAL_FACIL_TY,
			CAST([INIT_REGIMEN_RIFAMPIN] AS VARCHAR(200)) AS INIT_REGIMEN_RIFAMPIN,
			CAST([INIT_REGIMEN_PA_SALICYLIC_ACID] AS VARCHAR(200)) AS INIT_REGIMEN_PA_SALICYLIC_ACID,
			CAST([OCCUPATION_RISK] AS VARCHAR(200)) AS OCCUPATION_RISK,
			CAST([CULT_TISSUE_RESULT] AS VARCHAR(200)) AS CULT_TISSUE_RESULT,
			CAST([INIT_SUSCEPT_PA_SALICYLIC_ACID] AS VARCHAR(200)) AS INIT_SUSCEPT_PA_SALICYLIC_ACID,
			CAST([CHEST_XRAY_RESULT] AS VARCHAR(200)) AS CHEST_XRAY_RESULT,
			CAST([FIRST_ISOLATE_NOT_SPUTUM] AS VARCHAR(200)) AS FIRST_ISOLATE_NOT_SPUTUM,
			CAST([FINAL_SUSCEPT_CYCLOSERINE] AS VARCHAR(200)) AS FINAL_SUSCEPT_CYCLOSERINE,
			CAST([SPUTUM_CULT_RPT_LAB_TY] AS VARCHAR(200)) AS SPUTUM_CULT_RPT_LAB_TY,
			CAST([FINAL_SUSCEPT_LEVOFLOXACIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_LEVOFLOXACIN,
			CAST([NAA_RPT_LAB_TY] AS VARCHAR(200)) AS NAA_RPT_LAB_TY,
			CAST([COUNTRY_OF_VERIFIED_CASE] AS VARCHAR(200)) AS COUNTRY_OF_VERIFIED_CASE,
			CAST([LINK_REASON_1] AS VARCHAR(200)) AS LINK_REASON_1,
			CAST([CT_SCAN_CAVITY_EVIDENCE] AS VARCHAR(200)) AS CT_SCAN_CAVITY_EVIDENCE,
			CAST([INIT_REGIMEN_RIFABUTIN] AS VARCHAR(200)) AS INIT_REGIMEN_RIFABUTIN,
			CAST([INIT_SUSCEPT_RIFAPENTINE] AS VARCHAR(200)) AS INIT_SUSCEPT_RIFAPENTINE,
			CAST([INIT_REGIMEN_LEVOFLOXACIN] AS VARCHAR(200)) AS INIT_REGIMEN_LEVOFLOXACIN,
			CAST([PATIENT_BIRTH_COUNTRY] AS VARCHAR(200)) AS PATIENT_BIRTH_COUNTRY,
			CAST([EXCESS_ALCOHOL_USE_PAST_YEAR] AS VARCHAR(200)) AS EXCESS_ALCOHOL_USE_PAST_YEAR,
			CAST([INIT_REGIMEN_OTHER_2_IND] AS VARCHAR(200)) AS INIT_REGIMEN_OTHER_2_IND,
			CAST([FINAL_SUSCEPT_CAPREOMYCIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_CAPREOMYCIN,
			CAST([FINAL_SUSCEPT_RIFABUTIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_RIFABUTIN,
			CAST([INIT_SUSCEPT_AMIKACIN] AS VARCHAR(200)) AS INIT_SUSCEPT_AMIKACIN,
			CAST([FINAL_SUSCEPT_RIFAMPIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_RIFAMPIN,
			CAST([INIT_REGIMEN_OTHER_1_IND] AS VARCHAR(200)) AS INIT_REGIMEN_OTHER_1_IND,
			CAST([FINAL_SUSCEPT_STREPTOMYCIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_STREPTOMYCIN,
			CAST([INIT_SUSCEPT_KANAMYCIN] AS VARCHAR(200)) AS INIT_SUSCEPT_KANAMYCIN,
			CAST([INIT_SUSCEPT_ETHAMBUTOL] AS VARCHAR(200)) AS INIT_SUSCEPT_ETHAMBUTOL,
			CAST([INIT_REGIMEN_ISONIAZID] AS VARCHAR(200)) AS INIT_REGIMEN_ISONIAZID,
			CAST([SPUTUM_SMEAR_RESULT] AS VARCHAR(200)) AS SPUTUM_SMEAR_RESULT,
			CAST([DOT] AS VARCHAR(200)) AS DOT,
			CAST([CORRECTIONAL_FACIL_RESIDENT] AS VARCHAR(200)) AS CORRECTIONAL_FACIL_RESIDENT,
			CAST([FINAL_SUSCEPT_MOXIFLOXACIN] AS VARCHAR(200)) AS FINAL_SUSCEPT_MOXIFLOXACIN,
			CAST([THERAPY_EXTEND_GT_12_OTHER] AS VARCHAR(200)) AS THERAPY_EXTEND_GT_12_OTHER,
			CAST([LINK_STATE_CASE_NUM_2] AS VARCHAR(200)) AS LINK_STATE_CASE_NUM_2,
			CAST([ISOLATE_ACCESSION_NUM] AS VARCHAR(200)) AS ISOLATE_ACCESSION_NUM,
			CAST([INIT_SUSCEPT_OTHER_1] AS VARCHAR(200)) AS INIT_SUSCEPT_OTHER_1,
			CAST([INIT_REGIMEN_OTHER_2] AS VARCHAR(200)) AS INIT_REGIMEN_OTHER_2,
			CAST([INIT_REGIMEN_OTHER_1] AS VARCHAR(200)) AS INIT_REGIMEN_OTHER_1,
			CAST([OTHER_TB_RISK_FACTORS] AS VARCHAR(200)) AS OTHER_TB_RISK_FACTORS,
			CAST([LINK_STATE_CASE_NUM_1] AS VARCHAR(200)) AS LINK_STATE_CASE_NUM_1,
			CAST([NO_CONV_DOC_OTHER_REASON] AS VARCHAR(200)) AS NO_CONV_DOC_OTHER_REASON,
			CAST([FINAL_SUSCEPT_OTHER_2] AS VARCHAR(200)) AS FINAL_SUSCEPT_OTHER_2,
			CAST([FINAL_SUSCEPT_OTHER] AS VARCHAR(200)) AS FINAL_SUSCEPT_OTHER,
			CAST([MOVE_CITY_2] AS VARCHAR(200)) AS MOVE_CITY_2,
			CAST([HIV_CITY_CNTY_PATIENT_NUM] AS VARCHAR(200)) AS HIV_CITY_CNTY_PATIENT_NUM,
			CAST([IGRA_TEST_TY] AS VARCHAR(200)) AS IGRA_TEST_TY,
			CAST([HIV_STATE_PATIENT_NUM] AS VARCHAR(200)) AS HIV_STATE_PATIENT_NUM,
			CAST([INIT_SUSCEPT_OTHER_2] AS VARCHAR(200)) AS INIT_SUSCEPT_OTHER_2,
			CAST([DISEASE_SITE] AS VARCHAR(200)) AS DISEASE_SITE,
			CAST([TB_VERCRIT_CALC_IND] AS VARCHAR(200)) AS TB_VERCRIT_CALC_IND,
			-- Character columns with length 2000 (VARCHAR(2000))
			CAST([COMMENTS_FOLLOW_UP_1] AS VARCHAR(2000)) AS COMMENTS_FOLLOW_UP_1,
			CAST([COMMENTS_FOLLOW_UP_2] AS VARCHAR(2000)) AS COMMENTS_FOLLOW_UP_2,
			CAST([PROVIDER_OVERRIDE_COMMENTS] AS VARCHAR(2000)) AS PROVIDER_OVERRIDE_COMMENTS,
	...
	BEGIN TRANSACTION
		...
		FROM  [dbo].D_TB_PAM D 
		INNER JOIN #L_TB_PAM_E L on L.D_TB_PAM_KEY = D.D_TB_PAM_KEY
		INNER JOIN #S_TB_PAM S ON S.TB_PAM_UID = L.TB_PAM_UID;
