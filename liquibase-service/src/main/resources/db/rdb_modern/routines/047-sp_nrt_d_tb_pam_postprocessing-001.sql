...
BEGIN TRY
	...
	BEGIN TRANSACTION
		...
		UPDATE [dbo].D_TB_PAM
		SET 
			CALC_DISEASE_SITE = S.CALC_DISEASE_SITE,
			LINK_STATE_CASE_NUM_1 = S.LINK_STATE_CASE_NUM_1,
			LINK_REASON_1 = S.LINK_REASON_1,
			LINK_STATE_CASE_NUM_2 = S.LINK_STATE_CASE_NUM_2,
			LINK_REASON_2 = S.LINK_REASON_2,
			COUNT_STATUS = S.COUNT_STATUS,
			COUNTRY_OF_VERIFIED_CASE = S.COUNTRY_OF_VERIFIED_CASE,
			COUNT_DATE = S.COUNT_DATE,
			PREVIOUS_DIAGNOSIS_IND = S.PREVIOUS_DIAGNOSIS_IND,
			PREVIOUS_DIAGNOSIS_YEAR = S.PREVIOUS_DIAGNOSIS_YEAR,
			PATIENT_OUTSIDE_US_GT_2_MONTHS = S.PATIENT_OUTSIDE_US_GT_2_MONTHS,
			PRIMARY_GUARD_1_BIRTH_COUNTRY = S.PRIMARY_GUARD_1_BIRTH_COUNTRY,
			PRIMARY_GUARD_2_BIRTH_COUNTRY = S.PRIMARY_GUARD_2_BIRTH_COUNTRY,
			STATUS_AT_DIAGNOSIS = S.STATUS_AT_DIAGNOSIS,
			DISEASE_SITE = S.DISEASE_SITE,
			SPUTUM_SMEAR_RESULT = S.SPUTUM_SMEAR_RESULT,
			SPUTUM_SMEAR_COLLECT_DATE = S.SPUTUM_SMEAR_COLLECT_DATE,
			SPUTUM_CULTURE_RESULT = S.SPUTUM_CULTURE_RESULT,
			SPUTUM_CULT_COLLECT_DATE = S.SPUTUM_CULT_COLLECT_DATE,
			SPUTUM_CULT_RESULT_RPT_DATE = S.SPUTUM_CULT_RESULT_RPT_DATE,
			SPUTUM_CULT_RPT_LAB_TY = S.SPUTUM_CULT_RPT_LAB_TY,
			SMR_PATH_CYTO_RESULT = S.SMR_PATH_CYTO_RESULT,
			SMR_PATH_CYTO_COLLECT_DATE = S.SMR_PATH_CYTO_COLLECT_DATE,
			SMR_PATH_CYTO_SITE = S.SMR_PATH_CYTO_SITE,
			CULT_TISSUE_RESULT = S.CULT_TISSUE_RESULT,
			CULT_TISSUE_COLLECT_DATE = S.CULT_TISSUE_COLLECT_DATE,
			CULT_TISSUE_SITE = S.CULT_TISSUE_SITE,
			CULT_TISSUE_RESULT_RPT_DATE = S.CULT_TISSUE_RESULT_RPT_DATE,
			CULT_TISSUE_RESULT_RPT_LAB_TY = S.CULT_TISSUE_RESULT_RPT_LAB_TY,
			NAA_RESULT = S.NAA_RESULT,
			NAA_COLLECT_DATE = S.NAA_COLLECT_DATE,
			NAA_SPEC_IS_SPUTUM_IND = S.NAA_SPEC_IS_SPUTUM_IND,
			NAA_SPEC_NOT_SPUTUM = S.NAA_SPEC_NOT_SPUTUM,
			NAA_RESULT_RPT_DATE = S.NAA_RESULT_RPT_DATE,
			NAA_RPT_LAB_TY = S.NAA_RPT_LAB_TY,
			CHEST_XRAY_RESULT = S.CHEST_XRAY_RESULT,
			CHEST_XRAY_CAVITY_EVIDENCE = S.CHEST_XRAY_CAVITY_EVIDENCE,
			CHEST_XRAY_MILIARY_EVIDENCE = S.CHEST_XRAY_MILIARY_EVIDENCE,
			CT_SCAN_RESULT = S.CT_SCAN_RESULT,
			CT_SCAN_CAVITY_EVIDENCE = S.CT_SCAN_CAVITY_EVIDENCE,
			CT_SCAN_MILIARY_EVIDENCE = S.CT_SCAN_MILIARY_EVIDENCE,
			TST_RESULT = S.TST_RESULT,
			TST_PLACED_DATE = S.TST_PLACED_DATE,
			TST_MM_INDURATION = S.TST_MM_INDURATION,
			IGRA_RESULT = S.IGRA_RESULT,
			IGRA_COLLECT_DATE = S.IGRA_COLLECT_DATE,
			IGRA_TEST_TY = S.IGRA_TEST_TY,
			PRIMARY_REASON_EVALUATED = S.PRIMARY_REASON_EVALUATED,
			...
			HOMELESS_IND = S.HOMELESS_IND,
			CORRECTIONAL_FACIL_RESIDENT = S.CORRECTIONAL_FACIL_RESIDENT,
			CORRECTIONAL_FACIL_TY = S.CORRECTIONAL_FACIL_TY,
			CORRECTIONAL_FACIL_CUSTODY_IND = S.CORRECTIONAL_FACIL_CUSTODY_IND,
			LONGTERM_CARE_FACIL_RESIDENT = S.LONGTERM_CARE_FACIL_RESIDENT,
			LONGTERM_CARE_FACIL_TY = S.LONGTERM_CARE_FACIL_TY,
			OCCUPATION_RISK = S.OCCUPATION_RISK,
			INJECT_DRUG_USE_PAST_YEAR = S.INJECT_DRUG_USE_PAST_YEAR,
			NONINJECT_DRUG_USE_PAST_YEAR = S.NONINJECT_DRUG_USE_PAST_YEAR,
			EXCESS_ALCOHOL_USE_PAST_YEAR = S.EXCESS_ALCOHOL_USE_PAST_YEAR,
			OTHER_TB_RISK_FACTORS = S.OTHER_TB_RISK_FACTORS,
			IMMIGRATION_STATUS_AT_US_ENTRY = S.IMMIGRATION_STATUS_AT_US_ENTRY,
			INIT_REGIMEN_START_DATE = S.INIT_REGIMEN_START_DATE,
			INIT_REGIMEN_ISONIAZID = S.INIT_REGIMEN_ISONIAZID,
			INIT_REGIMEN_RIFAMPIN = S.INIT_REGIMEN_RIFAMPIN,
			INIT_REGIMEN_PYRAZINAMIDE = S.INIT_REGIMEN_PYRAZINAMIDE,
			INIT_REGIMEN_ETHAMBUTOL = S.INIT_REGIMEN_ETHAMBUTOL,
			INIT_REGIMEN_STREPTOMYCIN = S.INIT_REGIMEN_STREPTOMYCIN,
			INIT_REGIMEN_ETHIONAMIDE = S.INIT_REGIMEN_ETHIONAMIDE,
			INIT_REGIMEN_KANAMYCIN = S.INIT_REGIMEN_KANAMYCIN,
			INIT_REGIMEN_CYCLOSERINE = S.INIT_REGIMEN_CYCLOSERINE,
			INIT_REGIMEN_CAPREOMYCIN = S.INIT_REGIMEN_CAPREOMYCIN,
			INIT_REGIMEN_PA_SALICYLIC_ACID = S.INIT_REGIMEN_PA_SALICYLIC_ACID,
			INIT_REGIMEN_AMIKACIN = S.INIT_REGIMEN_AMIKACIN,
			INIT_REGIMEN_RIFABUTIN = S.INIT_REGIMEN_RIFABUTIN,
			INIT_REGIMEN_CIPROFLOXACIN = S.INIT_REGIMEN_CIPROFLOXACIN,
			INIT_REGIMEN_OFLOXACIN = S.INIT_REGIMEN_OFLOXACIN,
			INIT_REGIMEN_RIFAPENTINE = S.INIT_REGIMEN_RIFAPENTINE,
			INIT_REGIMEN_LEVOFLOXACIN = S.INIT_REGIMEN_LEVOFLOXACIN,
			INIT_REGIMEN_MOXIFLOXACIN = S.INIT_REGIMEN_MOXIFLOXACIN,
			INIT_REGIMEN_OTHER_1_IND = S.INIT_REGIMEN_OTHER_1_IND,
			INIT_REGIMEN_OTHER_1 = S.INIT_REGIMEN_OTHER_1,
			INIT_REGIMEN_OTHER_2_IND = S.INIT_REGIMEN_OTHER_2_IND,
			INIT_REGIMEN_OTHER_2 = S.INIT_REGIMEN_OTHER_2,
			ISOLATE_SUBMITTED_IND = S.ISOLATE_SUBMITTED_IND,
			ISOLATE_ACCESSION_NUM = S.ISOLATE_ACCESSION_NUM,
			INIT_SUSCEPT_TESTING_DONE = S.INIT_SUSCEPT_TESTING_DONE,
			FIRST_ISOLATE_COLLECT_DATE = S.FIRST_ISOLATE_COLLECT_DATE,
			FIRST_ISOLATE_IS_SPUTUM_IND = S.FIRST_ISOLATE_IS_SPUTUM_IND,
			FIRST_ISOLATE_NOT_SPUTUM = S.FIRST_ISOLATE_NOT_SPUTUM,
			INIT_SUSCEPT_ISONIAZID = S.INIT_SUSCEPT_ISONIAZID,
			INIT_SUSCEPT_RIFAMPIN = S.INIT_SUSCEPT_RIFAMPIN,
			INIT_SUSCEPT_PYRAZINAMIDE = S.INIT_SUSCEPT_PYRAZINAMIDE,
			INIT_SUSCEPT_ETHAMBUTOL = S.INIT_SUSCEPT_ETHAMBUTOL,
			INIT_SUSCEPT_STREPTOMYCIN = S.INIT_SUSCEPT_STREPTOMYCIN,
			INIT_SUSCEPT_ETHIONAMIDE = S.INIT_SUSCEPT_ETHIONAMIDE,
			INIT_SUSCEPT_KANAMYCIN = S.INIT_SUSCEPT_KANAMYCIN,
			INIT_SUSCEPT_CYCLOSERINE = S.INIT_SUSCEPT_CYCLOSERINE,
			INIT_SUSCEPT_CAPREOMYCIN = S.INIT_SUSCEPT_CAPREOMYCIN,
			INIT_SUSCEPT_PA_SALICYLIC_ACID = S.INIT_SUSCEPT_PA_SALICYLIC_ACID,
			INIT_SUSCEPT_AMIKACIN = S.INIT_SUSCEPT_AMIKACIN,
			INIT_SUSCEPT_RIFABUTIN = S.INIT_SUSCEPT_RIFABUTIN,
			INIT_SUSCEPT_CIPROFLOXACIN = S.INIT_SUSCEPT_CIPROFLOXACIN,
			INIT_SUSCEPT_OFLOXACIN = S.INIT_SUSCEPT_OFLOXACIN,
			INIT_SUSCEPT_RIFAPENTINE = S.INIT_SUSCEPT_RIFAPENTINE,
			INIT_SUSCEPT_LEVOFLOXACIN = S.INIT_SUSCEPT_LEVOFLOXACIN,
			INIT_SUSCEPT_MOXIFLOXACIN = S.INIT_SUSCEPT_MOXIFLOXACIN,
			INIT_SUSCEPT_OTHER_QUNINOLONES = S.INIT_SUSCEPT_OTHER_QUNINOLONES,
			INIT_SUSCEPT_OTHER_1_IND = S.INIT_SUSCEPT_OTHER_1_IND,
			INIT_SUSCEPT_OTHER_1 = S.INIT_SUSCEPT_OTHER_1,
			INIT_SUSCEPT_OTHER_2_IND = S.INIT_SUSCEPT_OTHER_2_IND,
			INIT_SUSCEPT_OTHER_2 = S.INIT_SUSCEPT_OTHER_2,
			SPUTUM_CULTURE_CONV_DOCUMENTED = S.SPUTUM_CULTURE_CONV_DOCUMENTED,
			TB_SPUTUM_CULTURE_NEGATIVE_DAT = S.TB_SPUTUM_CULTURE_NEGATIVE_DAT,
			NO_CONV_DOC_REASON = S.NO_CONV_DOC_REASON,
			NO_CONV_DOC_OTHER_REASON = S.NO_CONV_DOC_OTHER_REASON,
			MOVED_IND = S.MOVED_IND,
			TRANSNATIONAL_REFERRAL_IND = S.TRANSNATIONAL_REFERRAL_IND,
			MOVE_CITY = S.MOVE_CITY,
			THERAPY_STOP_DATE = S.THERAPY_STOP_DATE,
			THERAPY_STOP_REASON = S.THERAPY_STOP_REASON,
			THERAPY_STOP_CAUSE_OF_DEATH = S.THERAPY_STOP_CAUSE_OF_DEATH,
			THERAPY_EXTEND_GT_12_OTHER = S.THERAPY_EXTEND_GT_12_OTHER,
			DOT = S.DOT,
			DOT_NUMBER_WEEKS = S.DOT_NUMBER_WEEKS,
			FINAL_SUSCEPT_TESTING = S.FINAL_SUSCEPT_TESTING,
			FINAL_ISOLATE_COLLECT_DATE = S.FINAL_ISOLATE_COLLECT_DATE,	
			FINAL_ISOLATE_IS_SPUTUM_IND = S.FINAL_ISOLATE_IS_SPUTUM_IND,
			FINAL_ISOLATE_NOT_SPUTUM = S.FINAL_ISOLATE_NOT_SPUTUM,
			FINAL_SUSCEPT_ISONIAZID = S.FINAL_SUSCEPT_ISONIAZID,
			FINAL_SUSCEPT_RIFAMPIN = S.FINAL_SUSCEPT_RIFAMPIN,
			FINAL_SUSCEPT_PYRAZINAMIDE = S.FINAL_SUSCEPT_PYRAZINAMIDE,
			FINAL_SUSCEPT_ETHAMBUTOL = S.FINAL_SUSCEPT_ETHAMBUTOL,
			FINAL_SUSCEPT_STREPTOMYCIN = S.FINAL_SUSCEPT_STREPTOMYCIN,
			FINAL_SUSCEPT_ETHIONAMIDE = S.FINAL_SUSCEPT_ETHIONAMIDE,
			FINAL_SUSCEPT_KANAMYCIN = S.FINAL_SUSCEPT_KANAMYCIN,
			FINAL_SUSCEPT_CYCLOSERINE = S.FINAL_SUSCEPT_CYCLOSERINE,
			FINAL_SUSCEPT_CAPREOMYCIN = S.FINAL_SUSCEPT_CAPREOMYCIN,
			FINAL_SUSCEPT_PA_SALICYLIC_ACI = S.FINAL_SUSCEPT_PA_SALICYLIC_ACI,
			FINAL_SUSCEPT_AMIKACIN = S.FINAL_SUSCEPT_AMIKACIN,
			FINAL_SUSCEPT_RIFABUTIN = S.FINAL_SUSCEPT_RIFABUTIN,
			FINAL_SUSCEPT_CIPROFLOXACIN = S.FINAL_SUSCEPT_CIPROFLOXACIN,
			FINAL_SUSCEPT_OFLOXACIN = S.FINAL_SUSCEPT_OFLOXACIN,
			FINAL_SUSCEPT_RIFAPENTINE = S.FINAL_SUSCEPT_RIFAPENTINE,
			FINAL_SUSCEPT_LEVOFLOXACIN = S.FINAL_SUSCEPT_LEVOFLOXACIN,
			FINAL_SUSCEPT_MOXIFLOXACIN = S.FINAL_SUSCEPT_MOXIFLOXACIN,
			FINAL_SUSCEPT_OTHER_QUINOLONES = S.FINAL_SUSCEPT_OTHER_QUINOLONES,
			FINAL_SUSCEPT_OTHER_IND = S.FINAL_SUSCEPT_OTHER_IND,
			FINAL_SUSCEPT_OTHER = S.FINAL_SUSCEPT_OTHER,
			FINAL_SUSCEPT_OTHER_2_IND = S.FINAL_SUSCEPT_OTHER_2_IND,
			FINAL_SUSCEPT_OTHER_2 = S.FINAL_SUSCEPT_OTHER_2,
			CASE_VERIFICATION = S.CASE_VERIFICATION,
			COMMENTS_FOLLOW_UP_1 = S.COMMENTS_FOLLOW_UP_1,
			COMMENTS_FOLLOW_UP_2 = S.COMMENTS_FOLLOW_UP_2,
			MOVE_CITY_2 = S.MOVE_CITY_2,
			DATE_ARRIVED_IN_US = S.DATE_ARRIVED_IN_US,
			DATE_SUBMITTED = S.DATE_SUBMITTED,
			PATIENT_BIRTH_COUNTRY = S.PATIENT_BIRTH_COUNTRY,
			US_BORN_IND = S.US_BORN_IND,
			TB_VERCRIT_CALC_IND = S.TB_VERCRIT_CALC_IND,
			PROVIDER_OVERRIDE_COMMENTS = S.PROVIDER_OVERRIDE_COMMENTS,
			INIT_DRUG_REG_CALC = S.INIT_DRUG_REG_CALC,
