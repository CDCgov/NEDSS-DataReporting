IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_dyn_dm_case_management_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_dyn_dm_case_management_postprocessing]
END
GO 

CREATE PROCEDURE dbo.sp_dyn_dm_case_management_postprocessing
    @batch_id BIGINT,
