...
BEGIN
    ...
    DECLARE @update_dttm DATETIME2 = GETDATE()
    ...
    BEGIN TRY
        ...
        BEGIN TRANSACTION 
            ...
            SET @PROC_STEP_NO = @PROC_STEP_NO + 1;
            SET @PROC_STEP_NAME = 'UPDATING updated_dttm in [dbo].nrt_lab_test_key table';

            UPDATE ltk 
            SET 
                ltk.[LAB_TEST_UID] = ltk2.LAB_TEST_UID
            FROM [dbo].nrt_lab_test_key ltk
            INNER JOIN [dbo].nrt_lab_test_key ltk2 
                ON ltk2.LAB_TEST_KEY = ltk.LAB_TEST_KEY AND ltk2.LAB_TEST_UID = ltk.LAB_TEST_UID
            INNER JOIN #lab_test_E lte 
                ON lte.LAB_TEST_UID = ltk2.LAB_TEST_UID;
