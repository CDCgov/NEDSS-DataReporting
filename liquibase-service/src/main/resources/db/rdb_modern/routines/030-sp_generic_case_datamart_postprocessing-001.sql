IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_generic_case_datamart_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_generic_case_datamart_postprocessing]
END
GO 

CREATE PROCEDURE [dbo].[sp_generic_case_datamart_postprocessing]
...
BEGIN TRY
    ...
    BEGIN CATCH
        ...
        VALUES( @Batch_id, @datamart_nm, @datamart_nm, 'ERROR', @Proc_Step_no, @Proc_Step_name, @FullErrorMessage , 0 );
        RETURN -1;
