         ...
         (
             ...
             FROM
                 dbo.nrt_investigation_observation tnio
                     inner join dbo.nrt_observation_coded ovc ON ovc.observation_uid = tnio.branch_id
...
FROM InvFormQObservations obs
         LEFT JOIN dbo.nrt_observation o ON o.observation_uid = obs.branch_id
         LEFT JOIN dbo.codeset cs on cs.cd = o.cd
         LEFT JOIN nbs_srte.dbo.code_value_general cvg on
