...
BEGIN
    BEGIN TRY
        ...
        SELECT DISTINCT
            ...
            cvg3.CODE_VAL                                           AS 'SRC_PATIENT_COUNTRY',
        ...
        FROM dbo.nrt_contact con WITH (NOLOCK)
            ...
            LEFT JOIN dbo.v_code_value_general cvg3 WITH (NOLOCK)
                ON pat.PATIENT_COUNTRY = cvg3.CODE_DESC AND cvg3.cd='DEM126'               --Location.PSL_CNTRY
