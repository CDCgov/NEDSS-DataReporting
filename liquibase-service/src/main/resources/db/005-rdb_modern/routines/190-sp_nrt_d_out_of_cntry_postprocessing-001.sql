IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_nrt_d_out_of_cntry_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_nrt_d_out_of_cntry_postprocessing]
END
GO 

CREATE PROCEDURE [dbo].[sp_nrt_d_out_of_cntry_postprocessing] 
...
BEGIN
	...
	DECLARE @Dataflow_Name VARCHAR(200) = 'D_OUT_OF_CNTRY POST-Processing';
...
-------------------------------------------------------------------------------------------
 ...
 -------------------------------------------------------------------------------------------
            ...
            UPDATE F
                SET F.D_OUT_OF_CNTRY_GROUP_KEY = D.D_OUT_OF_CNTRY_GROUP_KEY
            ...
            INNER JOIN #D_OUT_OF_CNTRY_PHC_LIST S
