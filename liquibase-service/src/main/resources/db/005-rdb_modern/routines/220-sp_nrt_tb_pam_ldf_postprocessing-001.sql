IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_nrt_tb_pam_ldf_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_nrt_tb_pam_ldf_postprocessing]
END
GO 

CREATE PROCEDURE [dbo].[sp_nrt_tb_pam_ldf_postprocessing] 
