...
BEGIN
	...
	BEGIN TRY
		...
		IF OBJECT_ID('tempdb..#LDF_META_DATA', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_META_DATA_N', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_META_DATA_E', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_METADATA', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_METADATA_N', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_METADATA_E', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_DATA_DEL', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_DATA', 'U') IS NOT NULL  
			DROP TABLE #LDF_DATA;
		...
		IF OBJECT_ID('tempdb..#LDF_DATA_TRANSLATED_ROWS', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_BASE_COUNTRY_TRANSLATED_FINAL', 'U') IS NOT NULL  
		...
		------------------------------------------------------------------------------------------------------------------------------------------
			...
			IF OBJECT_ID('tempdb..#LDF_TRANSLATED_DATA', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_DIMENSIONAL_DATA', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_DIMENSIONAL_DATA_N', 'U') IS NOT NULL  
		...
		IF OBJECT_ID('tempdb..#LDF_DIMENSIONAL_DATA_E', 'U') IS NOT NULL  
