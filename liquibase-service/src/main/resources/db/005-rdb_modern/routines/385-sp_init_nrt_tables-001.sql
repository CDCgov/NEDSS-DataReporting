IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_init_nrt_tables]')
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_init_nrt_tables]
END
GO

CREATE PROCEDURE dbo.sp_init_nrt_tables
AS
BEGIN
    SET NOCOUNT ON;

    PRINT 'Initializing NRT Tables...';
    ...
    PRINT 'NRT Table Initialization Completed Successfully.';
END
GO
