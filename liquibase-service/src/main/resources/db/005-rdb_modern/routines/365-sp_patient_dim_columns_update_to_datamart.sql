...
*/
    ...
    BEGIN
        ...
        set
        PATIENT_PHONE_NUMBER_HOME = tmp.PATIENT_PHONE_NUMBER_HOME
        ,PATIENT_PHONE_EXT_HOME = tmp.PATIENT_PHONE_EXT_HOME
        ,PATIENT_PHONE_NUMBER_WORK = tmp.PATIENT_PHONE_WORK
        ,PATIENT_PHONE_EXT_WORK = tmp.PATIENT_PHONE_EXT_WORK
        ,PATIENT_GENERAL_COMMENTS = tmp.PATIENT_GENERAL_COMMENTS
    ...
    BEGIN
        ...
        update tb
        set
            PATIENT_PHONE_NUMBER_HOME   = map.PATIENT_PHONE_NUMBER_HOME
            ,PATIENT_PHONE_EXT_HOME      = map.PATIENT_PHONE_EXT_HOME
            ,PATIENT_PHONE_NUMBER_WORK   = map.PATIENT_PHONE_NUMBER_WORK
            ...
            ,AGE_REPORTED                = map.AGE_REPORTED
            ,AGE_REPORTED_UNIT           = map.AGE_REPORTED_UNIT
            ...
            ,RACE_CALC_DETAILS           = map.RACE_CALC_DETAILS
            ,RACE_CALCULATED             = map.RACE_CALCULATED
            ,RACE_NAT_HI_1               = map.RACE_NAT_HI_1
            ,RACE_NAT_HI_2               = map.RACE_NAT_HI_2
            ,RACE_NAT_HI_3               = map.RACE_NAT_HI_3
            ,RACE_ASIAN_1                = map.RACE_ASIAN_1
            ,RACE_ASIAN_2                = map.RACE_ASIAN_2
            ,RACE_ASIAN_3                = map.RACE_ASIAN_3
            ,RACE_ASIAN_ALL              = map.RACE_ASIAN_ALL
            ,RACE_ASIAN_GT3_IND          = map.RACE_ASIAN_GT3_IND
            ,RACE_NAT_HI_GT3_IND         = map.RACE_NAT_HI_GT3_IND
            ,RACE_NAT_HI_ALL             = map.RACE_NAT_HI_ALL
            ,CALC_REPORTED_AGE           = map.CALC_REPORTED_AGE
            ,CALC_5_YEAR_AGE_GROUP       = map.CALC_5_YEAR_AGE_GROUP
            ,CALC_10_YEAR_AGE_GROUP      = map.CALC_10_YEAR_AGE_GROUP
