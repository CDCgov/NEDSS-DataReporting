IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_nrt_d_addl_risk_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_nrt_d_addl_risk_postprocessing]
END
GO 

CREATE PROCEDURE dbo.sp_nrt_d_addl_risk_postprocessing 
...
BEGIN
    BEGIN TRY
        /* Logging */
            ...
            declare @package_name varchar(200) = 'sp_nrt_d_addl_risk_postprocessing';
...
--------------------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#S_ADDL_RISK_CD_TRANSLATED', 'U') IS NOT NULL
...
---------------------------------------------------------------------------------------------------------------------  
        ...
        IF OBJECT_ID('tempdb..#S_ADDL_RISK', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#TEMP_D_ADDL_RISK_DEL', 'U') IS NOT NULL
        ...
        WHERE ADDL_RISK.TB_PAM_UID IN (SELECT value FROM #S_PHC_LIST);
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#L_ADDL_RISK_GROUP', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#L_ADDL_RISK', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#TEMP_D_ADDL_RISK', 'U') IS NOT NULL
