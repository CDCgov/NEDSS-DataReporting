IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_nrt_d_moved_where_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_nrt_d_moved_where_postprocessing]
END
GO 

CREATE PROCEDURE dbo.sp_nrt_d_moved_where_postprocessing 
...
BEGIN
    BEGIN TRY
        /* Logging */
            ...
            declare @package_name varchar(200) = 'sp_nrt_d_moved_where_postprocessing';
...
--------------------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#S_MOVED_WHERE_TRANSLATED', 'U') IS NOT NULL
...
---------------------------------------------------------------------------------------------------------------------  
        ...
        IF OBJECT_ID('tempdb..#S_MOVED_WHERE', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#TEMP_D_MOVED_WHERE_DEL', 'U') IS NOT NULL
        ...
        WHERE MOVED_WHERE.TB_PAM_UID IN (SELECT value FROM #S_PHC_LIST);
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#L_MOVED_WHERE_GROUP', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#L_MOVED_WHERE', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#TEMP_D_MOVED_WHERE', 'U') IS NOT NULL
