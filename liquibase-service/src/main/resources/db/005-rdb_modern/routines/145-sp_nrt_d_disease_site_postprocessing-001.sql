IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_nrt_d_disease_site_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_nrt_d_disease_site_postprocessing]
END
GO 

CREATE PROCEDURE dbo.sp_nrt_d_disease_site_postprocessing 
...
--------------------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#S_DISEASE_PHC_LIST', 'U') IS NOT NULL
...
--------------------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#S_DISEASE_SITE_CD_TRANSLATED', 'U') IS NOT NULL
...
---------------------------------------------------------------------------------------------------------------------  
        ...
        IF OBJECT_ID('tempdb..#S_DISEASE_SITE', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#TEMP_D_DISEASE_SITE_DEL', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#L_DISEASE_SITE_GROUP', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#L_DISEASE_SITE', 'U') IS NOT NULL
...
-------------------------------------------------------------------------------------------
        ...
        IF OBJECT_ID('tempdb..#TEMP_D_DISEASE_SITE', 'U') IS NOT NULL
