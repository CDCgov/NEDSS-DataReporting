...
IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_ldf_vaccine_prevent_diseases_datamart_postprocessing]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_ldf_vaccine_prevent_diseases_datamart_postprocessing]
END
GO 

CREATE PROCEDURE [dbo].[sp_ldf_vaccine_prevent_diseases_datamart_postprocessing]  
	...
	BEGIN TRY
        ...
        */
        ...
        BEGIN
            ...
            IF OBJECT_ID('tempdb..#BASE_VACCINE_PREVENT_DISEASES', 'U') IS NOT NULL
            ...
            IF OBJECT_ID('tempdb..#LINKED_LINKED_VAC_PREVENT_MEASLES', 'U') IS NOT NULL
            ...
            IF OBJECT_ID('tempdb..#LINKED_LINKED_VAC_PREVENT_PERTUSSIS', 'U') IS NOT NULL
            ...
            IF OBJECT_ID('tempdb..#LINKED_LINKED_VAC_PREVENT_RUBELLA', 'U') IS NOT NULL
            ...
            IF OBJECT_ID('tempdb..#LINKED_LINKED_VAC_PREVENT_CRS', 'U') IS NOT NULL
            ...
            IF OBJECT_ID('tempdb..#ALL_VACCINE_PREVENT_MERGED', 'U') IS NOT NULL
            ...
            IF OBJECT_ID('tempdb..#ALL_VACCINE_PREVENT_DISEASES', 'U') IS NOT NULL
            ...
            IF OBJECT_ID('tempdb..#ALL_VACCINE_PREVENT_DISEASES_SHORT_COL', 'U') IS NOT NULL
            ...
            IF OBJECT_ID('tempdb..#ALL_VACCINE_PREVENT_DISEASES_TA', 'U') IS NOT NULL
        ...
        SET @PROC_STEP_NO = @PROC_STEP_NO + 1; 
        SET @PROC_STEP_NAME = 'UPDATE LDF_VACCINE_PREVENT_DISEASES when there is no record in the LDF_DIMENSIONAL_DATA';  
        ...
        FROM  INFORMATION_SCHEMA.COLUMNS WHERE table_name = 'LDF_VACCINE_PREVENT_DISEASES'
        ...
        SET  @dynamiccolumnUpdate=substring(@dynamiccolumnUpdate,1,len(@dynamiccolumnUpdate)-1) 
            ...
            dbo.LDF_VACCINE_PREVENT_DISEASES TBL inner join  
