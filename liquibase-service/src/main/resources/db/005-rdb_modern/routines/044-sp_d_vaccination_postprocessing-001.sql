...
BEGIN
	...
	BEGIN TRY
        ...
        SELECT
            ...
            ix.MATERIAL_CD AS VACCINATION_ADMINISTERED_CD,
        ...
        */
        ...
        SET
            ...
            dl.VACCINATION_ADMINISTERED_CD = NULLIF(ix.VACCINATION_ADMINISTERED_CD, ''''),
        ...
        */
        ...
        INSERT INTO dbo.D_VACCINATION (
            ...
            ' SELECT
                ...
                NULLIF(ix.VACCINATION_ADMINISTERED_CD, ''''),
