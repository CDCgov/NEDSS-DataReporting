    ...
    BEGIN TRY
        ...
        */
            ...
            SELECT
                ...
                CASE
                    WHEN LEN(COALESCE(TRIM(P.PATIENT_STREET_ADDRESS_1),TRIM(P.PATIENT_STREET_ADDRESS_2),TRIM(P.PATIENT_CITY),TRIM(P.PATIENT_COUNTY),TRIM(P.PATIENT_ZIP),TRIM(P.PATIENT_STATE), '')) > 0 THEN 'Home'
                    ELSE NULL
                    END AS ADDR_USE_CD_DESC,
                CASE
                    WHEN LEN(COALESCE(TRIM(P.PATIENT_STREET_ADDRESS_1),TRIM(P.PATIENT_STREET_ADDRESS_2),TRIM(P.PATIENT_CITY),TRIM(P.PATIENT_COUNTY),TRIM(P.PATIENT_ZIP),TRIM(P.PATIENT_STATE), '')) > 0 THEN 'House'
                    ELSE NULL
                    END AS ADDR_CD_DESC,
