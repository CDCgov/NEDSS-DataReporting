IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[dbo].[sp_ldf_phc_event]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
BEGIN
    DROP PROCEDURE [dbo].[sp_ldf_phc_event]
END
GO 

CREATE PROCEDURE dbo.sp_ldf_phc_event  @ldf_uid_list nvarchar(max), @bus_obj_uid_list nvarchar(max)
AS
Begin
    ...
    BEGIN TRY
       ...
       */
        ...
        select distinct m.ldf_uid,
                        ...
                        p.record_status_time as record_status_time,
